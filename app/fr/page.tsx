...
export default function HomePageFr() {
  ...
  const slides = [
    {
      ...
      title: 'Mode Modeste Turque',
      description: 'Découvrez notre collection exclusive d\'Abayas, Robes et Tenues Modestes',
      cta: { text: 'Acheter', link: '/fr/catalog' }
    },
    {
      image: '/images/hero-slider-2.webp',
      title: 'Prix de Gros',
      description: 'Meilleurs prix pour les détaillants et magasins du monde entier',
      cta: { text: 'Voir Catalogue', link: '/fr/catalog' }
    },
    {
      image: '/images/hero-slider-3.webp',
      title: 'Livraison Rapide Mondiale',
      description: 'Livraison dans plus de 50 pays avec des transporteurs fiables',
      cta: { text: 'Acheter', link: '/fr/catalog' }
    }
  ]
  ...
  const getProductUrl = useCallback((product: any) => {
    if (product.slug_en) return `/fr/product/${product.slug_en}`
    else if (product.slug_ar) return `/fr/product/${product.slug_ar}`
  ...
  return (
    <>
      <Head>
        <title>Hijab Fashion Mall | Grossiste Hijab Turc - Mode Modeste de Turquie</title>
        <meta name="description" content="Grossiste hijab turc premium depuis 2019. 5000+ produits: Abayas, Robes Modestes, Sets, Sportswear. Pas de commande minimum, livraison mondiale, support 24/7." />
        <meta name="keywords" content="grossiste hijab turc, mode modeste grossiste, hijab grossiste" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://hijabfashionmall.com/fr" />
      </Head>
      ...
      <main id="main-content">
        ...
        <section className="hero-slider" style={{ position: 'relative', width: '100%', overflow: 'hidden', height: 'auto', maxHeight: '600px' }}>
          <div style={{ position: 'relative', width: '100%' }}>
            ...
            <div className="hero-dots" style={{ position: 'absolute', bottom: '25px', left: '50%', transform: 'translateX(-50%)', display: 'flex', gap: '12px', zIndex: 3 }}>
              {slides.map((_, index) => (
                <button key={index} onClick={() => setCurrentSlide(index)} style={{ width: '12px', height: '12px', borderRadius: '50%', background: currentSlide === index ? '#ff5a00' : 'rgba(255,255,255,0.6)', border: 'none', cursor: 'pointer', padding: 0, transition: 'all 0.3s' }} aria-label={`Aller à la diapositive ${index + 1}`} />
              ))}
            </div>
          </div>
        </section>
        ...
        <section className="ranked-section">
          <div className="container">
            <span className="badge">🏆 Leader Mondial</span>
            <h3>Nous sommes classés #1 sur Google pour :</h3>
            <div className="ranked-horizontal">
              <div className="ranked-h-item"><span className="simple-icon" style={{ color: '#ff5a00' }}>👗</span><span><strong>Grossiste Tenue Modeste</strong> #1</span></div>
              <div className="ranked-h-item"><span className="simple-icon" style={{ color: '#4facfe' }}>🧕</span><span><strong>Grossiste Hijab Mode</strong> #1</span></div>
              <div className="ranked-h-item"><span className="simple-icon" style={{ color: '#f093fb' }}>👚</span><span><strong>Grossiste Sets Modestes</strong> #1</span></div>
            </div>
            <Link href="/fr/why-were-number-one" className="ranked-btn">Voir pourquoi nous sommes #1 →</Link>
          </div>
        </section>

        <section className="channels-section">
          <div className="container">
            <h2 className="section-title">Rejoignez Nos Canaux</h2>
            <p className="section-subtitle">Suivez-nous sur WhatsApp et Telegram pour les dernières actualités et offres exclusives</p>
            <div className="channels-grid">
              <div className="channel-card whatsapp-card">
                <div className="channel-icon"><FaWhatsapp size={40} /></div>
                <h3>Canal WhatsApp</h3>
                <p>Rejoignez notre canal WhatsApp pour les nouvelles arrivées quotidiennes, réductions spéciales et accès anticipé aux collections.</p>
                <div className="channel-stats"><span><FaUsers size={14} /> 1 500+ membres</span><span><FaImage size={14} /> Mises à jour quotidiennes</span></div>
                <a href="https://whatsapp.com/channel/0029VatIrfWId7nGgsYAFQ1G" className="channel-btn whatsapp-btn" target="_blank" rel="noopener noreferrer"><FaWhatsapp size={18} /> Rejoindre WhatsApp</a>
              </div>
              <div className="channel-card telegram-card">
                <div className="channel-icon"><FaTelegramPlane size={40} /></div>
                <h3>Canal Telegram</h3>
                <p>Rejoignez notre canal Telegram pour du contenu exclusif, des conseils de style et des offres spéciales.</p>
                <div className="channel-stats"><span><FaUsers size={14} /> 11 000+ membres</span><span><FaVideo size={14} /> Tutoriels vidéo</span></div>
                <a href="https://t.me/hijabfashionmall" className="channel-btn telegram-btn" target="_blank" rel="noopener noreferrer"><FaTelegramPlane size={18} /> Rejoindre Telegram</a>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="features-section">
          <div className="container">
            ...
            <p className="section-subtitle">Votre satisfaction est notre priorité</p>
            <div className="features-grid">
              <div className="feature-card"><div className="feature-icon"><Image src="/images/mix-icon.webp" alt="Mélanger différents produits" width={100} height={100} loading="lazy" /></div><h3>Mix & Match</h3><p>Toutes vos collections en une seule commande. Commandez la quantité que vous souhaitez au bon prix.</p></div>
              <div className="feature-card"><div className="feature-icon"><Image src="/images/no-minimum-icon.webp" alt="Pas de commande minimum" width={100} height={100} loading="lazy" /></div><h3>Pas de Minimum</h3><p>Pas de quantité minimum de commande grâce à notre service de consolidation. Commandez ce dont vous avez besoin.</p></div>
              <div className="feature-card"><div className="feature-icon"><Image src="/images/original-icon.webp" alt="100% original turc" width={100} height={100} loading="lazy" /></div><h3>100% Original Turc</h3><p>Nous ne vendons pas d'imitations. Seulement la qualité turque authentique.</p></div>
              <div className="feature-card"><div className="feature-icon"><Image src="/images/service-icon.webp" alt="Support 24/7" width={100} height={100} loading="lazy" /></div><h3>Support 24/7</h3><p>Service client à votre disposition pour vous aider avec les commandes et fournir une assistance personnalisée.</p></div>
            </div>
          </div>
        </section>
        ...
        <section className="privatelabel-section">
          <div className="container">
            <div className="privatelabel-wrapper">
              <div className="privatelabel-image"><Image src="/images/private-label.webp" alt="Service de marque privée - emballage personnalisé" width={800} height={800} loading="lazy" /></div>
              <div className="privatelabel-content">
                <span className="privatelabel-badge">Service Premium</span>
                <h2 className="privatelabel-title">Votre Marque,<br />Votre Identité</h2>
                <p className="privatelabel-description">Offrez à vos clients des designs exclusifs avec notre <strong>service de marque privée</strong>. Nous personnalisons les produits avec votre logo, votre emballage et vos spécifications pour les commandes régulières.</p>
                <ul className="privatelabel-features"><li><FaCheckCircle /> Emballage personnalisé avec votre logo</li><li><FaCheckCircle /> Designs exclusifs pour votre marque</li><li><FaCheckCircle /> Minimum flexible pour les commandes régulières</li><li><FaCheckCircle /> Contrôle qualité et expédition rapide</li></ul>
                <div style={{ display: 'flex', gap: '15px', flexWrap: 'wrap' }}>
                  <Link href="/fr/private-label-service" className="privatelabel-btn" style={{ background: 'transparent', color: 'var(--primary)', border: '2px solid var(--primary)', boxShadow: 'none' }}><FaNewspaper /> Lire le Guide</Link>
                  <a href="https://wa.me/905519522448?text=Bonjour%2C%20je%20suis%20int%C3%A9ress%C3%A9%20par%20votre%20service%20de%20marque%20priv%C3%A9e" className="privatelabel-btn" target="_blank" rel="noopener noreferrer"><FaWhatsapp /> Demander</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="categories-section">
          <div className="container">
            ...
            <p className="section-subtitle">Trouvez le style parfait pour chaque occasion</p>
            <div className="categories-grid">
              <Link href="/fr/category/abayas" className="category-card"><Image src="/images/category-abayas.webp" alt="Abayas turques" width={600} height={800} loading="lazy" /><div className="category-info"><h3>Abayas</h3><p>Soie de Médine, crêpe et plus</p></div></Link>
              <Link href="/fr/category/modest-dresses" className="category-card"><Image src="/images/category-dresses.webp" alt="Robes modestes" width={600} height={800} loading="lazy" /><div className="category-info"><h3>Robes Modestes</h3><p>Décontracté & formel</p></div></Link>
              <Link href="/fr/category/modest-skirt-sets" className="category-card"><Image src="/images/category-skirt-sets.webp" alt="Ensembles jupe" width={600} height={800} loading="lazy" /><div className="category-info"><h3>Ensembles Jupe</h3><p>Ensembles 2 pièces avec jupe</p></div></Link>
              <Link href="/fr/category/modest-evening-dresses" className="category-card"><Image src="/images/category-evening-dresses.webp" alt="Robes de soirée" width={600} height={800} loading="lazy" /><div className="category-info"><h3>Robes de Soirée</h3><p>Pour occasions spéciales</p></div></Link>
              <Link href="/fr/category/modest-pants-sets" className="category-card"><Image src="/images/178.webp" alt="Ensembles pantalon" width={600} height={800} loading="lazy" /><div className="category-info"><h3>Ensembles Pantalon</h3><p>Ensembles 2 pièces avec pantalon</p></div></Link>
              <Link href="/fr/category/hijabs" className="category-card"><Image src="/images/category-hijabs.webp" alt="Hijabs turques" width={600} height={800} loading="lazy" /><div className="category-info"><h3>Hijabs</h3><p>Soie, chiffon, coton</p></div></Link>
              <Link href="/fr/category/prayer-clothes" className="category-card"><Image src="/images/53.webp" alt="Tenues de prière" width={600} height={800} loading="lazy" /><div className="category-info"><h3>Tenues de Prière</h3><p>Ensembles et robes pour la prière</p></div></Link>
              <Link href="/fr/category/modest-sportswear" className="category-card"><Image src="/images/category-sportswear.webp" alt="Tenues de sport" width={600} height={800} loading="lazy" /><div className="category-info"><h3>Sport</h3><p>Pour activités et sports</p></div></Link>
              <Link href="/fr/category/burkini" className="category-card"><Image src="/images/category-swimwear.webp" alt="Burkini" width={600} height={800} loading="lazy" /><div className="category-info"><h3>Burkini</h3><p>Maillots de bain modestes</p></div></Link>
            </div>
          </div>
        </section>
        ...
        <section className="products-section">
          <div className="container">
            ...
            <p className="section-subtitle">Parcourez nos dernières arrivées</p>
            {loading ? (<div style={{ textAlign: 'center', padding: '60px', fontSize: '18px', color: '#555' }}>Chargement des produits...</div>) : products.length === 0 ? (<div style={{ textAlign: 'center', padding: '60px', fontSize: '18px', color: '#555' }}>Aucun produit trouvé</div>) : (
              <>
                <div className="products-grid">
                  {products.slice(0, 8).map((product: any) => {
                    const productName = product.name_en || product.name_ar || 'Produit';
                    ...
                    return (
                      <Link href={productUrl} key={product._id} className="product-card" style={{ textDecoration: 'none', color: 'inherit' }}>
                        ...
                        <div className="product-info"><h3>{productName}</h3><div className="product-price">{formatPrice(productPrice)}</div><button className="add-to-cart" onClick={(e) => addToCart(product, e)}><FaShoppingCart /> Ajouter</button></div>
                      </Link>
                    );
                  })}
                </div>
                <div className="view-all-container"><Link href="/fr/catalog" className="btn-view-all">Voir Tous</Link></div>
              </>
            )}
          </div>
        </section>
        ...
        <section className="faq-section">
          <div className="container">
            ...
            <p className="section-subtitle">Trouvez des réponses aux questions courantes</p>
            <div className="faq-grid-cards">
              <div className="faq-card"><div className="faq-card-icon"><FaStore size={36} /></div><h3>Qui sommes-nous ?</h3><p>Hijab Fashion Mall est le principal marché turc connectant grossistes et détaillants de mode modeste.</p></div>
              <div className="faq-card"><div className="faq-card-icon"><FaShoppingCart size={36} /></div><h3>Comment commander ?</h3><p>Parcourez le catalogue, sélectionnez les produits, ajoutez au panier et envoyez via WhatsApp. Notre équipe confirmera sous 24h.</p></div>
              <div className="faq-card"><div className="faq-card-icon"><FaGlobe size={36} /></div><h3>Livrez-vous mondialement ?</h3><p>Oui ! Nous livrons dans plus de 50 pays avec des transporteurs fiables. Livraison rapide avec suivi.</p></div>
              <div className="faq-card"><div className="faq-card-icon"><FaCreditCard size={36} /></div><h3>Moyens de paiement ?</h3><p>Nous acceptons virement bancaire, Western Union et cartes de crédit principales.</p></div>
              <div className="faq-card"><div className="faq-card-icon"><FaBoxes size={36} /></div><h3>Commande minimum ?</h3><p>Pas de quantité minimum ! Commandez ce dont vous avez besoin.</p></div>
              <div className="faq-card"><div className="faq-card-icon"><FaTruck size={36} /></div><h3>Suivi de commande ?</h3><p>Une fois expédiée, vous recevrez un numéro de suivi pour suivre votre colis.</p></div>
            </div>
          </div>
        </section>
        ...
        <section className="blogs-section">
          <div className="container">
            <h2 className="section-title">Blogs Utiles</h2>
            <p className="section-subtitle">Guides pratiques pour vous aider à prendre des décisions éclairées.</p>
            <div className="blogs-grid">
              <div className="blog-card"><div className="blog-image"><Image src="/images/blog-1.webp" alt="Guide boutique en ligne" width={400} height={225} loading="lazy" /></div><div className="blog-content"><span className="blog-category">Guide d'Achat</span><h3>Boutique en Ligne</h3><p>Comment créer une boutique en ligne réussie pour vendre de la mode modeste.</p><Link href="/fr/online-store-guide" className="blog-link">Lire la suite →</Link></div></div>
              <div className="blog-card"><div className="blog-image"><Image src="/images/blog-2.webp" alt="Guide boutique physique" width={400} height={225} loading="lazy" /></div><div className="blog-content"><span className="blog-category">Guide d'Achat</span><h3>Boutique Physique</h3><p>Comment démarrer une boutique de mode modeste en 2026 : Importer de Turquie.</p><Link href="/fr/physical-store-guide" className="blog-link">Lire la suite →</Link></div></div>
              <div className="blog-card"><div className="blog-image"><Image src="/images/blog-3.webp" alt="Tendances mode modeste" width={400} height={225} loading="lazy" /></div><div className="blog-content"><span className="blog-category">Guide de Marché</span><h3>Tendances</h3><p>Adopter les styles hijab en Europe : Tendances et opportunités.</p><Link href="/fr/modest-fashion-trends" className="blog-link">Lire la suite →</Link></div></div>
            </div>
          </div>
        </section>

        <a href="https://wa.me/905519522448?text=Bonjour%2C%20j%27ai%20une%20question" className="whatsapp-float" target="_blank" rel="noopener noreferrer" style={{ position: 'fixed', bottom: '30px', left: '30px', background: '#25d366', color: 'white', width: '50px', height: '50px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '30px', boxShadow: '0 4px 20px rgba(37,211,102,0.3)', zIndex: 999, transition: 'all 0.3s', textDecoration: 'none' }} onMouseEnter={(e) => { e.currentTarget.style.background = '#128C7E'; e.currentTarget.style.transform = 'scale(1.05)' }} onMouseLeave={(e) => { e.currentTarget.style.background = '#25d366'; e.currentTarget.style.transform = 'scale(1)' }}><FaWhatsapp size={28} /></a>

        <button onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} style={{ position: 'fixed', bottom: '30px', right: '30px', width: '50px', height: '50px', borderRadius: '50%', background: '#ff5a00', color: 'white', border: 'none', cursor: 'pointer', display: showBackToTop ? 'flex' : 'none', alignItems: 'center', justifyContent: 'center', fontSize: '24px', boxShadow: '0 4px 15px rgba(255,90,0,0.3)', zIndex: 999, transition: 'all 0.3s' }} onMouseEnter={(e) => { e.currentTarget.style.background = '#e04e00'; e.currentTarget.style.transform = 'translateY(-2px)' }} onMouseLeave={(e) => { e.currentTarget.style.background = '#ff5a00'; e.currentTarget.style.transform = 'translateY(0)' }} aria-label="Retour en haut"><FaArrowUp /></button>
      </main>
    </>
  )
}
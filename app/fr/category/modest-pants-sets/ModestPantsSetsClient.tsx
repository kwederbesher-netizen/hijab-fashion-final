// app/fr/category/modest-pants-sets/ModestPantsSetsClient.tsx
'use client'
...
export default function ModestPantsSetsClient({ searchParams }: { searchParams?: { search?: string; page?: string; sort?: string } }) {
  ...
  const getColorCode = useCallback((color: string) => {
    const colors: any = {
      ...
      'Blue': '#1e40af', 'Beige': '#d4b896', 'Olive': '#5a6b3a',
      'Brown': '#7b4a2e', 'Taupe': '#8b7355', 'Charcoal': '#36454F',
      'Dusty Rose': '#c9a0a8', 'Cream': '#fdf6e3'
    }
  ...
  if (loading && products.length === 0) return (
    <div style={{ 
      ...
      `}</style>
      <p style={{ marginTop: '20px', color: '#5a4a3a', fontSize: '16px' }}>Chargement des ensembles pantalon...</p>
    </div>
  )
      ...
      {showSizeChart && (
        <div style={{
          ...
          <div style={{
            ...
            <h2 style={{ fontSize: '28px', color: '#2c2418', marginBottom: '20px', textAlign: 'center', fontFamily: 'Playfair Display, serif' }}>Guide des Tailles - Ensembles Pantalon Turcs</h2>
            ...
            <div style={{ overflowX: 'auto' }}>
              <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                ...
                <tbody>
                  {[['S','84-88','66-70','90-94','75'],['M','88-92','70-74','94-98','77'],['L','92-96','74-78','98-102','79'],['XL','96-100','78-82','102-106','81'],['2XL','100-104','82-86','106-110','83'],['3XL','104-108','86-90','110-114','85'],['4XL','108-112','90-94','114-118','87']].map((row,i)=>(
      ...
      <section style={{
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px', position: 'relative', zIndex: 1 }}>
          ...
          <h1 style={{ 
            ...
            Ensembles <span style={{ color: '#ff5a00' }}>Pantalon</span>
          </h1>
          <p style={{ fontSize: '18px', color: '#5a4a3a', maxWidth: '800px', margin: '0 auto', lineHeight: '1.6' }}>
            Découvrez nos ensembles pantalon turcs en gros. Sets coordonnés 2 pièces (pantalon large + tunique), 
            alliant confort et élégance pour un look quotidien raffiné.
          </p>
                      ...
                      return (
                        <Link href={getProductUrl(p)} key={p._id} style={{ background: 'white', borderRadius: '16px', overflow: 'hidden', boxShadow: '0 5px 20px rgba(0,0,0,0.05)', transition: 'all 0.3s', textDecoration: 'none', color: 'inherit', border: '1px solid #f0e6dc', display: 'block' }} onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-8px)'; e.currentTarget.style.borderColor = '#ff5a00' }} onMouseLeave={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.borderColor = '#f0e6dc' }}>
                          <div style={{ position: 'relative', height: '280px', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, #fef9f2 0%, #faf5ed 100%)' }}>
                            <img src={getProductImage(p.mainImage, p.imageUrl, { width: 400 }, p.images)} alt={p.name_fr || p.name_en || 'Ensemble pantalon turc'} style={{ maxWidth: '90%', maxHeight: '90%', objectFit: 'contain' }} loading="lazy" onError={(e) => { (e.target as HTMLImageElement).src = '/images/default.webp' }} />

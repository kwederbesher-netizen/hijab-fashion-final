// app/fr/category/prayer-clothes/PrayerClothesClient.tsx
'use client'
...
export default function PrayerClothesClient({ searchParams }: { searchParams?: { search?: string; page?: string; sort?: string } }) {
  ...
  const getColorCode = useCallback((color: string) => {
    const colors: any = {
      ...
      'Gray': '#6b6b6b', 'Beige': '#d4b896', 'Cream': '#fdf6e3',
      'Dusty Rose': '#c9a0a8', 'Mint Green': '#6fbf8f', 'Lavender': '#b8a9c9',
      'Light Blue': '#7bc5e8', 'Sage Green': '#9cae8c'
    }
  ...
  if (loading && products.length === 0) return (
    <div style={{ 
      ...
      `}</style>
      <p style={{ marginTop: '20px', color: '#5a4a3a', fontSize: '16px' }}>Chargement des tenues de prière...</p>
    </div>
  )
      ...
      {showSizeChart && (
        <div style={{
          ...
          <div style={{
            ...
            <h2 style={{ fontSize: '28px', color: '#2c2418', marginBottom: '20px', textAlign: 'center', fontFamily: 'Playfair Display, serif' }}>Guide des Tailles - Tenues de Prière Turques</h2>
            ...
            <div style={{ overflowX: 'auto' }}>
              <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                ...
                <tbody>
                  {[['S','84-88','66-70','90-94','135'],['M','88-92','70-74','94-98','137'],['L','92-96','74-78','98-102','139'],['XL','96-100','78-82','102-106','141'],['2XL','100-104','82-86','106-110','143'],['3XL','104-108','86-90','110-114','145'],['4XL','108-112','90-94','114-118','147']].map((row,i)=>(
      ...
      <section style={{
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px', position: 'relative', zIndex: 1 }}>
          ...
          <h1 style={{ 
            ...
            Tenues de <span style={{ color: '#ff5a00' }}>Prière</span>
          </h1>
          <p style={{ fontSize: '18px', color: '#5a4a3a', maxWidth: '800px', margin: '0 auto', lineHeight: '1.6' }}>
            Découvrez notre collection de tenues de prière modestes turques en gros. Ensembles 2 pièces, 
            robes de prière, tissus confortables et couleurs sobres.
          </p>
          ...
          <main>
            ...
            {products.length === 0 ? (
              <div style={{
                ...
                <h3 style={{ fontSize: '24px', color: '#2c2418', marginBottom: '10px', fontWeight: 600 }}>Aucune tenue trouvée</h3>
                      ...
                      return (
                        <Link href={getProductUrl(p)} key={p._id} style={{ background: 'white', borderRadius: '16px', overflow: 'hidden', boxShadow: '0 5px 20px rgba(0,0,0,0.05)', transition: 'all 0.3s', textDecoration: 'none', color: 'inherit', border: '1px solid #f0e6dc', display: 'block' }} onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-8px)'; e.currentTarget.style.borderColor = '#ff5a00' }} onMouseLeave={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.borderColor = '#f0e6dc' }}>
                          <div style={{ position: 'relative', height: '280px', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, #fef9f2 0%, #faf5ed 100%)' }}>
                            <img src={getProductImage(p.mainImage, p.imageUrl, { width: 400 }, p.images)} alt={p.name_fr || p.name_en || 'Tenue prière turque'} style={{ maxWidth: '90%', maxHeight: '90%', objectFit: 'contain' }} loading="lazy" onError={(e) => { (e.target as HTMLImageElement).src = '/images/default.webp' }} />
      ...
      <section style={{ background: '#fef9f2', padding: '60px 0', borderTop: '1px solid #f0e6dc' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
          <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            <h2 style={{ fontSize: '32px', color: '#2c2418', textAlign: 'center', fontFamily: 'Playfair Display, serif' }}>Abbigliamento Preghiera Turco all'Ingrosso</h2>
            <p style={{ fontSize: '16px', color: '#5a4a3a', lineHeight: '1.8', textAlign: 'justify' }}>Benvenuto su Hijab Fashion Mall, il tuo <strong>grossista di fiducia per l'abbigliamento preghiera turco</strong>. La nostra collezione all'ingrosso offre set completi 2 pezzi (tunica + pantaloni o gonna) e abiti da preghiera in un unico pezzo, realizzati con tessuti comodi come jersey, cotone e poliestere di alta qualità. Perfetti per rivenditori di moda modesta. Contatta il nostro team via WhatsApp o Telegram per qualsiasi ordine all'ingrosso. Spedizione internazionale con tracciabilità.</p>
          </div>
        </div>
      </section>

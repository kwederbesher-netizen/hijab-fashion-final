...
export default function PrayerClothesCategoryPageFr() {
  ...
  const getColorCode = useCallback((color: string) => {
    const colors: any = { 'Black': '#1a1a1a', 'White': '#FFFFFF', 'Navy': '#0a192f', 'Gray': '#6b6b6b', 'Beige': '#d4b896', 'Cream': '#fdf6e3', 'Dusty Rose': '#c9a0a8', 'Mint Green': '#6fbf8f', 'Lavender': '#b8a9c9' }
  ...
  if (loading && products.length === 0) return (
    <div style={{ padding: '100px 20px', textAlign: 'center', minHeight: '60vh' }}>
      ...
      <p style={{ marginTop: '20px', color: '#5a4a3a' }}>Chargement des tenues de prière...</p>
    </div>
  )
  ...
  return (
    <>
      <Head>
        <title>Tenues de Prière Modestes Turques en Gros | Hijab Fashion Mall</title>
        <meta name="description" content={`Découvrez ${totalProducts}+ tenues de prière modestes turques en gros. Ensembles 2 pièces, robes de prière. Tissus confortables, couleurs sobres. Livraison mondiale.`} />
        <meta name="keywords" content="tenue de prière en gros, grossiste tenue prière, ensemble prière femme, robe prière musulmane, hijab prière, set prière, vêtement prière turc, tenue pour prière, ensemble 2 pièces prière, robe longue prière, accessoires prière" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://hijabfashionmall.com/fr/category/prayer-clothes" />
        ...
        <meta property="og:title" content="Tenues de Prière Modestes Turques en Gros" />
        <meta property="og:description" content={`${totalProducts}+ tenues de prière premium. Ensembles complets.`} />
      ...
      <section style={{ background: 'linear-gradient(135deg, #fdf8f2 0%, #ffffff 100%)', padding: '60px 0 40px', textAlign: 'center', borderBottom: '1px solid #f0e6dc', position: 'relative', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', fontSize: '200px', fontWeight: 800, color: 'rgba(255,90,0,0.03)', whiteSpace: 'nowrap', zIndex: 0, fontFamily: 'Playfair Display, serif' }}>PRIÈRE</div>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px', position: 'relative', zIndex: 1 }}>
          <div style={{ fontSize: '14px', color: '#7a6a5a', marginBottom: '20px' }}>
            ...
            <span style={{ color: '#7a6a5a' }}>Tenues de Prière</span>
          </div>
          <h1 style={{ fontSize: '48px', color: '#2c2418', marginBottom: '15px', fontWeight: 800, fontFamily: 'Playfair Display, serif' }}>Tenues de <span style={{ color: '#ff5a00' }}>Prière</span></h1>
          <p style={{ fontSize: '18px', color: '#5a4a3a', maxWidth: '800px', margin: '0 auto', lineHeight: '1.6' }}>Découvrez notre collection de tenues de prière modestes turques en gros. Ensembles 2 pièces, robes de prière, tissus confortables et couleurs sobres.</p>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '40px', marginTop: '40px', flexWrap: 'wrap' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <span style={{ color: '#4a3a2a' }}>Ensembles Complets</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <span style={{ color: '#4a3a2a' }}>Tissus Confortables</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <span style={{ color: '#4a3a2a' }}>Couleurs Sobres</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    {products.map((p: any) => {
                      ...
                      return (
                        <Link href={getProductUrl(p)} key={p._id} style={{ background: 'white', borderRadius: '16px', overflow: 'hidden', boxShadow: '0 5px 20px rgba(0,0,0,0.05)', transition: 'all 0.3s', textDecoration: 'none', color: 'inherit', border: '1px solid #f0e6dc', display: 'block' }}>
                          ...
                          <div style={{ padding: '20px', textAlign: 'center' }}>
                            <div style={{ fontSize: '11px', color: '#ff5a00', marginBottom: '8px', textTransform: 'uppercase' }}>Tenue de Prière</div>
      ...
      <section style={{ background: '#fef9f2', padding: '60px 0', borderTop: '1px solid #f0e6dc' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
          <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            <h2 style={{ fontSize: '32px', color: '#2c2418', textAlign: 'center', fontFamily: 'Playfair Display, serif' }}>Guide des Tailles - Tenues de Prière Turques</h2>
            <div style={{ overflowX: 'auto', marginTop: '30px' }}>
              <table style={{ width: '100%', borderCollapse: 'collapse', background: 'white', borderRadius: '20px', overflow: 'hidden' }}>
                ...
                <tbody>
                  {[['S', '84-88', '66-70', '90-94', '135'], ['M', '88-92', '70-74', '94-98', '137'], ['L', '92-96', '74-78', '98-102', '139'], ['XL', '96-100', '78-82', '102-106', '141'], ['2XL', '100-104', '82-86', '106-110', '143'], ['3XL', '104-108', '86-90', '110-114', '145'], ['4XL', '108-112', '90-94', '114-118', '147']].map((row, idx) => (

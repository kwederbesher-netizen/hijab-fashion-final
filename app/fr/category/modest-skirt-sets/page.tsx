...
export default function ModestSkirtSetsCategoryPageFr() {
  ...
  // Fetch products from API for Modest Skirt Sets category
  ...
  if (loading && products.length === 0) return (
    <div style={{ 
      ...
      `}</style>
      <p style={{ marginTop: '20px', color: '#5a4a3a', fontSize: '16px' }}>Chargement des ensembles jupe...</p>
    </div>
  )
  ...
  return (
    <>
      <Head>
        <title>Ensembles Jupe Modestes Turcs en Gros | Sets 2 Pièces | Hijab Fashion Mall</title>
        <meta name="description" content={`Découvrez ${totalProducts}+ ensembles jupe modestes turcs en gros. Sets 2 pièces (jupe + tunique). Parfaits pour la mode modeste quotidienne et professionnelle. Livraison mondiale.`} />
        <meta name="keywords" content="ensembles jupe en gros, grossiste ensemble jupe, set jupe modeste, ensemble 2 pièces musulman, jupe longue avec tunique, ensemble jupe professionnel, ensemble jupe quotidien, tenue modeste turque, coordonné jupe, outfit jupe, ensemble ramadan, ensemble aïd, jupe maxi avec haut, ensemble hijab, mode modeste ensemble" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://hijabfashionmall.com/fr/category/modest-skirt-sets" />
        ...
        <meta property="og:title" content="Ensembles Jupe Modestes Turcs en Gros - Sets 2 Pièces" />
        <meta property="og:description" content={`${totalProducts}+ ensembles jupe premium. Jupe longue + tunique assortie.`} />
        <meta property="og:url" content="https://hijabfashionmall.com/fr/category/modest-skirt-sets" />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://hijabfashionmall.com/images/og-skirt-sets-fr.jpg" />
      ...
      <section style={{
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px', position: 'relative', zIndex: 1 }}>
          <div style={{ fontSize: '14px', color: '#7a6a5a', marginBottom: '20px' }}>
            ...
            <span style={{ color: '#7a6a5a', margin: '0 8px' }}>/</span>
            <span style={{ color: '#7a6a5a' }}>Ensembles Jupe</span>
          </div>
          <h1 style={{ 
            fontSize: '48px', 
            color: '#2c2418', 
            ...
            Ensembles <span style={{ color: '#ff5a00' }}>Jupe</span> Modestes
          </h1>
          <p style={{ fontSize: '18px', color: '#5a4a3a', maxWidth: '800px', margin: '0 auto', lineHeight: '1.6' }}>
            Découvrez nos ensembles jupe turcs en gros. Sets coordonnés 2 pièces (jupe longue + tunique), 
            parfaits pour un look modeste et élégant au quotidien ou au bureau.
          </p>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{
                ...
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="1.8">
                  <rect x="3" y="6" width="18" height="14" rx="1" stroke="currentColor" fill="none"/>
                  <path d="M8 6V4h8v2" stroke="currentColor"/>
                </svg>
              </div>
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>2 Pièces Coordonnées</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{
                width: '44px',
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>Jupe Longue</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{
                width: '44px',
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>Tunique Assortie</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{
                width: '44px',
                ...
                {loading && products.length > 0 ? (
                  ...
                  <div style={{
                    ...
                    {products.map((p: any) => {
                      ...
                      // Determine set type for badge
                      const setName = (p.name_en || '').toLowerCase()
                      let setBadge = null
                      if (setName.includes('professional') || setName.includes('bureau') || setName.includes('travail')) {
                        setBadge = <span style={{
                          background: '#b87c4f',
                          color: 'white',
                          padding: '4px 12px',
                      ...
                      } else if (setName.includes('daily') || setName.includes('quotidien')) {
                        setBadge = <span style={{
                          background: '#d48c54',
                          color: 'white',
                          padding: '4px 12px',
                      ...
                      } else if (setName.includes('crepe') || setName.includes('crêpe')) {
                        setBadge = <span style={{
                          background: '#c98a60',
                          color: 'white',
                          padding: '4px 12px',
                      ...
                      } else if (setName.includes('jersey')) {
                        setBadge = <span style={{
                          background: '#b07d4a',
                          color: 'white',
                          padding: '4px 12px',
                        ...
                        >
                          <div style={{
                            ...
                            <img 
                              ...
                              alt={p.name_fr || p.name_en || p.name_ar || 'Ensemble jupe turc'}
                              style={{ 
                                maxWidth: '90%', 
                                maxHeight: '90%', 
                                objectFit: 'contain', 
      ...
      {/* SEO Content Section - Rich keywords for skirt sets */}
      <section style={{
        background: '#fef9f2',
        padding: '60px 0',
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
          <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            <h2 style={{
              ...
              Ensembles Jupe Modestes Turcs en Gros
            </h2>
            <p style={{
              fontSize: '16px',
              color: '#5a4a3a',
              ...
              Bienvenue sur Hijab Fashion Mall, votre <strong>grossiste de confiance pour les ensembles jupe modestes turcs</strong>. 
              Notre collection en gros propose plus de <strong>{totalProducts} ensembles 2 pièces</strong> (jupe longue + tunique assortie) 
              adaptés aux besoins des détaillants, boutiques en ligne et professionnels de la mode modeste. 
              Ces tenues coordonnées offrent une solution pratique et élégante pour vos clientes.
            </p>
            ...
            <h3 style={{
              ...
              Types d'Ensembles Jupe Disponibles à l'Achat en Gros
            </h3>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
                ...
                <span style={{ color: '#4a3a2a' }}><strong>Ensemble Jupe Professionnel</strong> – Pour le bureau, look sobre et élégant</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
                </svg>
                <span style={{ color: '#4a3a2a' }}><strong>Ensemble Jupe Quotidien</strong> – Confortable, décontracté, pour tous les jours</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
                </svg>
                <span style={{ color: '#4a3a2a' }}><strong>Ensemble Jupe Jersey</strong> – Tissu extensible, confort absolu</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
                </svg>
                <span style={{ color: '#4a3a2a' }}><strong>Ensemble Jupe Crêpe</strong> – Tissu résistant, tombé fluide et élégant</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
                </svg>
                <span style={{ color: '#4a3a2a' }}><strong>Ensemble Jupe Maxi</strong> – Jupe longue jusqu'aux chevilles</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
                </svg>
                <span style={{ color: '#4a3a2a' }}><strong>Ensemble Jupe Ramadan</strong> – Idéal pour les prières et rassemblements</span>
              </div>
            </div>
            ...
            <h3 style={{
              ...
              Caractéristiques Techniques des Ensembles Jupe Turcs
            </h3>
            ...
            <div style={{
              ...
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <span style={{ fontWeight: 700, color: '#ff5a00' }}>Composition :</span>
                <p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>Jupe + Tunique assortie (2 pièces coordonnées)</p>
              </div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <span style={{ fontWeight: 700, color: '#ff5a00' }}>Longueur jupe :</span>
                <p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>Maxi (100-110 cm), Midi (80-90 cm)</p>
              </div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <span style={{ fontWeight: 700, color: '#ff5a00' }}>Tissus :</span>
                <p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>Jersey, crêpe, viscose, coton, polyester</p>
              </div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
              ...
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                ...
                <p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>Noir, marine, beige, bordeaux, vert olive, taupe, rose poudré</p>
              </div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <span style={{ fontWeight: 700, color: '#ff5a00' }}>Conditionnement :</span>
                <p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>Pièce à l'unité (RSS) ou carton de 6/12 ensembles</p>
              </div>
            </div>
            ...
            <h3 style={{
              ...
              Avantages des Ensembles Jupe Turcs pour les Professionnels
            </h3>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                ...
                <span style={{ color: '#4a3a2a' }}>Tenues coordonnées prêtes à porter</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
                </svg>
                <span style={{ color: '#4a3a2a' }}>Gain de temps pour les clientes</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
                </svg>
                <span style={{ color: '#4a3a2a' }}>Rapport qualité-prix excellent</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
                </svg>
                <span style={{ color: '#4a3a2a' }}>Polyvalents (bureau, quotidien, maison)</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                ...
                <span style={{ color: '#4a3a2a' }}>Livraison rapide mondiale</span>
              </div>
            </div>
            ...
            <p style={{
              ...
              Les <strong>ensembles jupe modestes turcs</strong> sont une solution idéale pour les femmes recherchant 
              des tenues coordonnées, élégantes et conformes aux principes de la mode modeste. 
              Que vous soyez un détaillant cherchant à élargir votre offre, ou une boutique spécialisée, 
              notre collection en gros répond à vos besoins. Parcourez notre sélection et enrichissez 
              votre catalogue avec des ensembles jupe de qualité. Pour toute commande en gros ou demande 
              de renseignements, contactez notre équipe via WhatsApp ou Telegram. Livraison mondiale 
              assurée avec suivi de colis.
            </p>
          </div>
        </div>
      </section>

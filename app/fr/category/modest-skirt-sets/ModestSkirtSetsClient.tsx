// app/fr/category/modest-skirt-sets/ModestSkirtSetsClient.tsx
'use client'
      ...
      {showSizeChart && (
        <div style={{
          ...
          <div style={{
            ...
            <h2 style={{ fontSize: '28px', color: '#2c2418', marginBottom: '20px', textAlign: 'center', fontFamily: 'Playfair Display, serif' }}>Guide des Tailles - Ensembles Jupe Turcs</h2>
            <p style={{ textAlign: 'center', color: '#5a4a3a', marginBottom: '30px' }}>Les tailles suivantes correspondent aux standards turcs pour les ensembles jupe.</p>
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                <thead>
                  <tr style={{ background: '#ff5a00', color: 'white' }}>
                    ...
                    <th style={{ padding: '12px' }}>Longueur Jupe (cm)</th>
                  </tr>
                </thead>
                <tbody>
                  {[['S','84-88','66-70','90-94','100-105'],['M','88-92','70-74','94-98','102-107'],['L','92-96','74-78','98-102','104-109'],['XL','96-100','78-82','102-106','106-111'],['2XL','100-104','82-86','106-110','108-113'],['3XL','104-108','86-90','110-114','110-115'],['4XL','108-112','90-94','114-118','112-117']].map((row,i)=>(
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px', position: 'relative', zIndex: 1 }}>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <span style={{ color: '#4a3a2a' }}>Jupe Longue</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                      ...
                      return (
                        <Link href={getProductUrl(p)} key={p._id} style={{ background: 'white', borderRadius: '16px', overflow: 'hidden', boxShadow: '0 5px 20px rgba(0,0,0,0.05)', transition: 'all 0.3s', textDecoration: 'none', color: 'inherit', border: '1px solid #f0e6dc', display: 'block' }} onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-8px)'; e.currentTarget.style.borderColor = '#ff5a00' }} onMouseLeave={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.borderColor = '#f0e6dc' }}>
                          <div style={{ position: 'relative', height: '280px', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, #fef9f2 0%, #faf5ed 100%)' }}>
                            <img src={getProductImage(p.mainImage, p.imageUrl, { width: 400 }, p.images)} alt={p.name_fr || p.name_en || 'Ensemble jupe turc'} style={{ maxWidth: '90%', maxHeight: '90%', objectFit: 'contain' }} loading="lazy" onError={(e) => { (e.target as HTMLImageElement).src = '/images/default.webp' }} />
                            {badges.length > 0 && <div style={{ position: 'absolute', top: '15px', right: '15px', display: 'flex', gap: '6px', flexDirection: 'column' }}>{badges}</div>}
                          </div>
                          <div style={{ padding: '20px', textAlign: 'center' }}>
                            <div style={{ fontSize: '11px', color: '#ff5a00', marginBottom: '8px', textTransform: 'uppercase' }}>Ensemble 2 Pièces</div>
      ...
      <section style={{ background: '#fef9f2', padding: '60px 0', borderTop: '1px solid #f0e6dc' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
          <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            <h2 style={{ fontSize: '32px', color: '#2c2418', textAlign: 'center', fontFamily: 'Playfair Display, serif' }}>Ensembles Jupe Modestes Turcs en Gros</h2>
            <p style={{ fontSize: '16px', color: '#5a4a3a', lineHeight: '1.8', textAlign: 'justify' }}>Notre collection d'<strong>ensembles jupe modestes turcs</strong> propose des tenues coordonnées 2 pièces (jupe longue + tunique) adaptées au quotidien, au bureau ou aux sorties. Parcourez notre sélection et enrichissez votre offre de mode modeste. Pour toute commande en gros, contactez notre équipe via WhatsApp ou Telegram. Livraison mondiale.</p>
          </div>
        </div>
      </section>

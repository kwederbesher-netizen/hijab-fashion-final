// app/ar/category/modest-sportswear/page.tsx
'use client'
...
export default function ModestSportswearCategoryPageAr() {
  ...
  if (loading && products.length === 0) return (
    <div style={{ padding: '100px 20px', textAlign: 'center', minHeight: '60vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <p style={{ marginTop: '20px', color: '#555', fontSize: '16px' }}>جاري تحميل الملابس الرياضية...</p>
    </div>
  )
  ...
  return (
    <>
      <Head>
        <title>ملابس رياضية محتشمة تركية بالجملة | طقم رياضي محتشم | هجاب فاشن مول</title>
        <meta name="description" content={`تشكيلة ملابس رياضية محتشمة تركية بالجملة. طقم رياضي بأقمشة قابلة للتنفس ومناسبة للتمارين. تصاميم عملية للرياضات المختلفة.`} />
        <meta name="keywords" content="ملابس رياضية محتشمة بالجملة, طقم رياضي محتشم, ملابس رياضية تركية, بدلة رياضية محتشمة, تيشيرت رياضي كم طويل, بنطال رياضي واسع, ملابس جيم محتشمة, ملابس يوجا محتشمة" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://hijabfashionmall.com/ar/category/modest-sportswear" />
        ...
        <meta property="og:title" content="ملابس رياضية محتشمة تركية بالجملة - عملية ومريحة" />
        <meta property="og:description" content={`${totalProducts}+ قطعة ملابس رياضية محتشمة. تصاميم تناسب جميع الأنشطة الرياضية.`} />
        <meta property="og:url" content="https://hijabfashionmall.com/ar/category/modest-sportswear" />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://hijabfashionmall.com/images/og-modest-sportswear-ar.jpg" />
      ...
      <section style={{ background: 'linear-gradient(135deg, #fdf8f2 0%, #ffffff 100%)', padding: '60px 0 40px', textAlign: 'center', borderBottom: '1px solid #f0e6dc', position: 'relative', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', fontSize: '160px', fontWeight: 800, color: 'rgba(255,90,0,0.03)', whiteSpace: 'nowrap', zIndex: 0, pointerEvents: 'none', fontFamily: 'Playfair Display, serif' }}>رياضة</div>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px', position: 'relative', zIndex: 1 }}>
          <div style={{ fontSize: '14px', color: '#7a6a5a', marginBottom: '20px' }}>
            ...
            <span style={{ margin: '0 8px' }}>/</span>
            <span>ملابس رياضية محتشمة</span>
          </div>
          <h1 style={{ fontSize: '48px', color: '#2c2418', marginBottom: '15px', fontWeight: 800, lineHeight: '1.2', fontFamily: 'Playfair Display, serif' }}>
            ملابس رياضية <span style={{ color: '#ff5a00' }}>محتشمة</span>
          </h1>
          <p style={{ fontSize: '18px', color: '#5a4a3a', maxWidth: '800px', margin: '0 auto', lineHeight: '1.6' }}>
            أطقم رياضية عملية بأقمشة قابلة للتنفس ومناسبة لممارسة التمارين. تصاميم 
            مريحة تناسب الجري، اليوغا، التمارين المنزلية، والأنشطة الرياضية المختلفة.
          </p>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '40px', marginTop: '40px', flexWrap: 'wrap' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>تيشيرتات رياضية</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>بناطيل رياضية</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>أقمشة قابلة للتنفس</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>ألوان متنوعة</span>
            </div>
          </div>
        </div>
      </section>
          ...
          <main>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '30px', flexWrap: 'wrap', gap: '15px', background: 'white', padding: '15px 25px', borderRadius: '20px', boxShadow: '0 5px 15px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
              <div style={{ color: '#5a4a3a', fontSize: '15px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                ...
                <span><span style={{ fontWeight: 600, color: '#ff5a00' }}>{totalProducts}</span> منتج رياضي</span>
                {totalProducts > 0 && <span style={{ marginRight: '10px', color: '#a08c7a', fontSize: '13px' }}>({startIndex}-{endIndex})</span>}
              </div>
              <div style={{ display: 'flex', gap: '15px', alignItems: 'center', flexWrap: 'wrap' }}>
                <div style={{ position: 'relative' }}>
                  <input ref={searchInputRef} type="text" placeholder="ابحث بالاسم، الرمز..." defaultValue={initialSearch} onChange={handleSearchChange} style={{ padding: '12px 18px 12px 42px', border: '2px solid #f0e6dc', borderRadius: '40px', fontFamily: 'Poppins, sans-serif', fontSize: '14px', transition: 'all 0.3s', outline: 'none', width: '260px', background: 'white' }} onFocus={(e) => e.currentTarget.style.borderColor = '#ff5a00'} onBlur={(e) => e.currentTarget.style.borderColor = '#f0e6dc'} />
            ...
            {products.length === 0 ? (
              <div style={{ textAlign: 'center', padding: '80px 20px', background: 'white', borderRadius: '20px', boxShadow: '0 10px 30px rgba(0,0,0,0.05)', border: '1px solid #f0e6dc' }}>
                ...
                <h3 style={{ fontSize: '24px', color: '#2c2418', marginBottom: '10px', fontWeight: 600 }}>لم يتم العثور على ملابس رياضية</h3>
                      ...
                      return (
                        <Link href={getProductUrl(p)} key={p._id} style={{ background: 'white', borderRadius: '16px', overflow: 'hidden', boxShadow: '0 5px 20px rgba(0,0,0,0.05)', transition: 'all 0.3s', textDecoration: 'none', color: 'inherit', border: '1px solid #f0e6dc', display: 'block' }} onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-8px)'; e.currentTarget.style.boxShadow = '0 15px 30px rgba(255,90,0,0.12)'; e.currentTarget.style.borderColor = '#ff5a00'; }} onMouseLeave={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 5px 20px rgba(0,0,0,0.05)'; e.currentTarget.style.borderColor = '#f0e6dc'; }}>
                          <div style={{ position: 'relative', height: '280px', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, #fef9f2 0%, #faf5ed 100%)' }}>
                            <img src={p.imageUrl || '/images/default.webp'} alt={p.name_ar || 'ملابس رياضية'} style={{ maxWidth: '90%', maxHeight: '90%', objectFit: 'contain', transition: 'transform 0.5s' }} loading="lazy" onError={(e) => { (e.target as HTMLImageElement).src = '/images/default.webp' }} />
                            {badges.length > 0 && <div style={{ position: 'absolute', top: '15px', right: '15px', display: 'flex', gap: '6px', flexDirection: 'column' }}>{badges}</div>}
                          </div>
                          <div style={{ padding: '20px', textAlign: 'center' }}>
                            <div style={{ fontSize: '11px', color: '#ff5a00', marginBottom: '8px', fontWeight: 500, textTransform: 'uppercase', letterSpacing: '1px' }}>ملابس رياضية</div>
      ...
      <section style={{ background: 'white', padding: '60px 0', borderTop: '1px solid #f0e6dc', borderBottom: '1px solid #f0e6dc' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
          <div style={{ textAlign: 'center', marginBottom: '40px' }}>
            <h2 style={{ fontSize: '32px', color: '#2c2418', marginBottom: '15px', fontWeight: 700, fontFamily: 'Playfair Display, serif' }}>دليل مقاسات الملابس الرياضية التركية</h2>
            <p style={{ fontSize: '16px', color: '#5a4a3a', maxWidth: '700px', margin: '0 auto' }}>المقاسات القياسية المعتمدة للملابس الرياضية التركية. قد تختلف المقاسات حسب الموديل.</p>
          </div>
          <div style={{ overflowX: 'auto', borderRadius: '20px', border: '1px solid #f0e6dc', background: 'white' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'center', minWidth: '550px' }}>
              <thead>
              ...
              <tbody>
                {[
                  { size: 'XS / 34', chest: '80-84', waist: '62-66', hip: '86-90', length: '95-100' },
                  { size: 'S / 36', chest: '84-88', waist: '66-70', hip: '90-94', length: '95-100' },
                  { size: 'M / 38', chest: '88-92', waist: '70-74', hip: '94-98', length: '100-105' },
                  { size: 'L / 40', chest: '92-96', waist: '74-78', hip: '98-102', length: '100-105' },
                  { size: 'XL / 42', chest: '96-100', waist: '78-82', hip: '102-106', length: '105-110' },
                  { size: '2XL / 44', chest: '100-104', waist: '82-86', hip: '106-110', length: '105-110' },
                  { size: '3XL / 46', chest: '104-108', waist: '86-90', hip: '110-114', length: '110-115' },
                  { size: '4XL / 48', chest: '108-112', waist: '90-94', hip: '114-118', length: '110-115' },
                ].map((row, index) => (
          ...
          <div style={{ marginTop: '30px', padding: '20px', background: '#fef9f2', borderRadius: '16px', border: '1px solid #f0e6dc' }}>
            ...
            <ul style={{ color: '#5a4a3a', lineHeight: '1.8', paddingRight: '20px' }}>
              <li>✓ اختر أقمشة قابلة للتنفس مثل القطن أو الألياف الرياضية الماصة للرطوبة.</li>
              <li>✓ يفضل اختيار مقاس مريح يسمح بحرية الحركة أثناء التمارين.</li>
              <li>✓ الملابس الرياضية الواسعة توفر راحة أكبر أثناء ممارسة الرياضة.</li>
              <li>✓ تأكد من جودة الخياطة خاصة في مناطق الإبطين والمناطق التي تتعرض للاحتكاك.</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section style={{ background: '#fef9f2', padding: '60px 0', borderTop: '1px solid #f0e6dc' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
          <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            <h2 style={{ fontSize: '32px', color: '#2c2418', marginBottom: '20px', fontWeight: 700, textAlign: 'center', fontFamily: 'Playfair Display, serif' }}>ملابس رياضية محتشمة تركية بالجملة</h2>
            <p style={{ fontSize: '16px', color: '#5a4a3a', lineHeight: '1.8', marginBottom: '25px', textAlign: 'justify' }}>
              هجاب فاشن مول يقدم <strong>ملابس رياضية محتشمة تركية بالجملة</strong> بتصاميم عملية وأقمشة عالية الجودة. مجموعتنا تضم أكثر من <strong>{totalProducts} قطعة رياضية</strong> مناسبة للجري، اليوغا، التمارين المنزلية، والأنشطة الرياضية المختلفة. تتميز ملابسنا بأقمشة قابلة للتنفس وخياطة متقنة.
            </p>
            <h3 style={{ fontSize: '24px', color: '#2c2418', margin: '35px 0 20px', fontWeight: 600 }}>أنواع الملابس الرياضية المتاحة</h3>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '15px', marginBottom: '35px' }}>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>تيشيرتات رياضية:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>أكمام طويلة وقصيرة بأقمشة ماصة للرطوبة</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>بناطيل رياضية:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>واسعة ومريحة للتمارين والجري</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>طقم رياضي كامل:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>مجموعة متكاملة من تيشيرت وبنطال</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>ملابس يوجا:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>مريحة ومرنة تناسب تمارين اليوجا والتأمل</p></div>
            </div>
            <h3 style={{ fontSize: '24px', color: '#2c2418', margin: '35px 0 20px', fontWeight: 600 }}>مميزات الملابس الرياضية التركية</h3>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '15px', marginBottom: '35px' }}>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>أقمشة تقنية:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>تمتص الرطوبة وتسمح بمرور الهواء</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>مرونة عالية:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>تسمح بحرية الحركة أثناء التمارين</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>متانة وجودة:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>خياطة متقنة تتحمل الاستخدام المتكرر</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>تصاميم عصرية:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>ألوان وتصاميم جذابة تناسب جميع الأذواق</p></div>
            </div>
          </div>
        </div>
      </section>

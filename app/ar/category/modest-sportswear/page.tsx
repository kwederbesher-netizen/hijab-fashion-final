...
export default function ModestSportswearCategoryPage() {
  // تكوين الصفحة حسب التصنيف - ملابس رياضية محجبات
  const PAGE_CONFIG = {
    category: "ملابس رياضية محجبات",
    categoryName: "Modest Sportswear",
    pageTitle: "ملابس رياضية محجبات تركية بالجملة | أطقم رياضية محتشمة | بدل رياضة محجبات | حجاب فاشون مول",
    pageDescription: "تسوق أفضل الملابس الرياضية المحجبات التركية بالجملة. أطقم رياضية محتشمة، بدل رياضة، ملابس جيم ويوجا، طقم رياضي قطعتين. بدون حد أدنى للطلب، شحن عالمي سريع.",
    pageKeywords: "ملابس رياضية محجبات, أطقم رياضية محتشمة, بدل رياضة محجبات, ملابس جيم محجبات, طقم رياضي تركي, ملابس يوجا محجبات, ملابس رياضية تركية بالجملة",
    h1: "ملابس رياضية محجبات تركية بالجملة – أناقة وحرية في الحركة",
    subtitle: "اكتشفي مجموعتنا الرائعة من الملابس الرياضية المحتشمة من تركيا. أطقم رياضية مريحة وعملية تناسب جميع الأنشطة الرياضية من الجيم إلى اليوجا والجري.",
    seoContent: {
      h2: "ملابس رياضية محجبات بالجملة – راحة وأداء عالي مع الاحتشام",
      p1: "مرحباً بك في حجاب فاشون مول، مصدرك الأول للملابس الرياضية التركية المحتشمة. تشكيلتنا تضم أطقم رياضية مصممة خصيصاً لتوفير الراحة والأداء العالي مع الحفاظ على مبادئ الاحتشام. سواء كنت تبحثين عن ملابس للجيم، اليوجا، الجري، أو الأنشطة الرياضية اليومية، لدينا ما يناسب احتياجاتك.",
      features: [
        "صناعة تركية 100% أصلية",
        "أقمشة عالية الجودة: قطن، بوليستر، ألياف مرنة، قطن عضوي",
        "تقنيات تهوية وامتصاص العرق",
        "مقاسات متعددة (XS إلى 4XL)",
        "بدون حد أدنى للطلب",
        "شحن سريع عالمي (3-7 أيام)",
        "طرق دفع آمنة"
      ],
      popularStyles: "أطقم رياضية قطعتين, بدل رياضة, ملابس يوجا, ملابس جيم, طقم رياضي واسع, تيشيرتات رياضية طويلة, بنطلونات رياضية واسعة, جاكيتات رياضية."
    }
  }
    ...
    <>
      ...
      <section className="products-section">
        <div className="container">
          <div className="products-header">
            <h2>تشكيلة <span>ملابس رياضية محجبات</span></h2>
            ...
            <>
              <div className="products-grid">
                {products.map((product: any) => {
                  const name = product.name_ar || product.name_en || 'طقم رياضي'
      ...
      <section className="seo-content">
        <div className="container">
          ...
          <h3>لماذا تختارين الملابس الرياضية التركية؟</h3>
          <ul>
          ...
          <p>انضمي إلى أكثر من 5000+ تاجر تجزئة حول العالم يثقون بنا في مجموعات الملابس الرياضية. من البوتيكات الصغيرة إلى كبار تجار التجزئة، نقدم جودة ثابتة وخدمة موثوقة. تصفحي مجموعتنا وقدمي استفسارك اليوم!</p>
          
          <p><strong>أنماط الملابس الرياضية الشائعة:</strong> {PAGE_CONFIG.seoContent.popularStyles}</p>
        </div>
      </section>
    </>
  )

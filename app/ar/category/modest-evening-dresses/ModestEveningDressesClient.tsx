...
<div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', fontSize: '160px', fontWeight: 800, color: 'rgba(255,90,0,0.03)', whiteSpace: 'nowrap', zIndex: 0, pointerEvents: 'none', fontFamily: 'Playfair Display, serif' }}>فساتين سهرة</div>
...
<span style={{ color: '#7a6a5a', margin: '0 8px' }}>/</span>
<span style={{ color: '#7a6a5a' }}>فساتين سهرة محجبات</span>
</div>
<h1 style={{ fontSize: '48px', color: '#2c2418', marginBottom: '15px', fontWeight: 800, lineHeight: '1.2', fontFamily: 'Playfair Display, serif' }}>
فساتين <span style={{ color: '#ff5a00' }}>سهرة محجبات</span>
</h1>
<p style={{ fontSize: '18px', color: '#5a4a3a', maxWidth: '800px', margin: '0 auto', lineHeight: '1.6' }}>
اكتشفي مجموعتنا بالجملة من فساتين السهرة التركية للمحجبات. فساتين أنيقة لحفلات الزفاف 
والمناسبات الرسمية بتصاميم راقية وتغطية كاملة.
</p>
...
<span style={{ color: '#4a3a2a', fontSize: '15px' }}>ضيوف حفلات الزفاف</span>
</div>
<div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
<div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
...
<span style={{ color: '#4a3a2a', fontSize: '15px' }}>فساتين رسمية</span>
</div>
<div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
<div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
...
<span style={{ color: '#4a3a2a', fontSize: '15px' }}>طول كامل</span>
</div>
</div>
</div>
</section>
...
<h3 style={{ fontSize: '24px', color: '#2c2418', marginBottom: '10px', fontWeight: 600 }}>لا توجد فساتين سهرة</h3>
...
else if (fabric.includes('ساتان')) fabricBadge = <span style={{ background: '#e8a87c', color: 'white', padding: '4px 12px', borderRadius: '20px', fontSize: '11px', fontWeight: 600 }}>ساتان</span>
else if (fabric.includes('مخمل')) fabricBadge = <span style={{ background: '#8B4513', color: 'white', padding: '4px 12px', borderRadius: '20px', fontSize: '11px', fontWeight: 600 }}>مخمل</span>
...
<img src={getProductImage(p.mainImage, p.imageUrl, { width: 400 }, p.images)} alt={p.name_ar || p.name_en || p.name_fr || 'فستان سهرة'} style={{ maxWidth: '90%', maxHeight: '90%', objectFit: 'contain', transition: 'transform 0.5s' }} loading="lazy" onError={(e) => { (e.target as HTMLImageElement).src = '/images/default.webp' }} />
...
<h2 style={{ fontSize: '32px', color: '#2c2418', marginBottom: '20px', fontWeight: 700, textAlign: 'center', fontFamily: 'Playfair Display, serif' }}>مجموعة فساتين السهرة التركية للمحجبات</h2>
<p style={{ fontSize: '16px', color: '#5a4a3a', lineHeight: '1.8', marginBottom: '25px', textAlign: 'justify' }}>
اكتشفي مجموعتنا المختارة من <strong>فساتين السهرة التركية للمحجبات</strong> المصممة للمناسبات الرسمية 
حيث تلتقي الأناقة مع التغطية. تشمل مجموعتنا بالجملة أكثر من <strong>{totalProducts} موديل فستان سهرة</strong> 
بأقمشة فاخرة تشمل الدانتيل والساتان والشيفون والمخمل.
</p>

<h3 style={{ fontSize: '24px', color: '#2c2418', margin: '35px 0 20px', fontWeight: 600 }}>أنواع فساتين السهرة المتاحة للشراء بالجملة</h3>
<div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '15px', marginBottom: '35px' }}>
<div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/></svg><span style={{ color: '#4a3a2a' }}><strong>فساتين ضيوف حفلات الزفاف</strong> – تصاميم أنيقة مناسبة لحفلات الزفاف</span></div>
<div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/></svg><span style={{ color: '#4a3a2a' }}><strong>فساتين رسمية</strong> – طول كامل، راقية للحفلات والمناسبات</span></div>
<div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/></svg><span style={{ color: '#4a3a2a' }}><strong>فساتين دانتيل</strong> – تفاصيل دانتيل دقيقة لأناقة رومانسية</span></div>
<div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/></svg><span style={{ color: '#4a3a2a' }}><strong>فساتين ساتان</strong> – لمعان فاخر، مظهر رسمي راقي</span></div>
</div>

<h3 style={{ fontSize: '24px', color: '#2c2418', margin: '35px 0 20px', fontWeight: 600 }}>جدول المقاسات لفساتين السهرة التركية</h3>
...
<p style={{ fontSize: '12px', color: '#a08c7a', textAlign: 'center', marginTop: '20px', fontStyle: 'italic' }}>*المقاسات تقريبية. قد يختلف الطول حسب الموديل. يرجى التحقق من مواصفات المنتج الفردية.</p>
</div>

<p style={{ fontSize: '16px', color: '#5a4a3a', lineHeight: '1.8', textAlign: 'justify', marginTop: '20px' }}>
تجمع فساتين السهرة التركية للمحجبات بين التصميم الراقي والتغطية الكاملة، مما يوفر خيارات أنيقة 
للمناسبات الرسمية. تتميز هذه الفساتين <strong>بقصات بطول الأرض، وأكمام طويلة، وخطوط رقبة محتشمة</strong> 
مع دمج الأقمشة الفاخرة والتفاصيل المعقدة.
</p>
</div>
</div>
</section>

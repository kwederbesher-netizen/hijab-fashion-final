...
export default function ModestEveningDressesCategoryPage() {
  // تكوين الصفحة حسب التصنيف - فساتين سهرة محجبات
  const PAGE_CONFIG = {
    category: "فساتين سهرة محجبات",
    categoryName: "Modest Evening Dresses",
    pageTitle: "فساتين سهرة محجبات تركية بالجملة | تشكيلة راقية من فساتين السهرة المحتشمة | حجاب فاشون مول",
    pageDescription: "تسوق أفضل فساتين السهرة المحجبات التركية بالجملة. تشكيلة واسعة من فساتين السهرة الفاخرة والمناسبات الخاصة. فساتين ملكية، فساتين خطوبة، فساتين أفراح. شحن عالمي سريع.",
    pageKeywords: "فساتين سهرة محجبات, فساتين سهرة تركية, فساتين أفراح محجبات, فساتين خطوبة محجبات, فساتين ملكية محجبات, فساتين مناسبات, فساتين سواريه محجبات",
    h1: "فساتين سهرة محجبات تركية بالجملة – أناقة استثنائية للمناسبات",
    subtitle: "اكتشفي مجموعتنا الفاخرة من فساتين السهرة المحتشمة من تركيا. من فساتين الأفراح الملكية إلى فساتين الخطوبة الأنيقة، ستجدين القطع المثالية للمناسبات الخاصة بأسعار الجملة.",
    seoContent: {
      h2: "فساتين سهرة محجبات بالجملة – فخامة وأناقة للمناسبات الخاصة",
      p1: "مرحباً بك في حجاب فاشون مول، مصدرك الأول لفساتين السهرة التركية الفاخرة المحتشمة. تشكيلتنا تضم أرقى التصاميم التي تجمع بين الفخامة والاحتشام. سواء كنت تبحثين عن فساتين أفراح ملكية، فساتين خطوبة أنيقة، أو فساتين مناسبات خاصة، لدينا ما يناسب كل مناسبة.",
      features: [
        "صناعة تركية 100% أصلية",
        "أقمشة فاخرة: دانتيل، تفتا، شيفون، ساتان، كريب، مخمل",
        "تطريزات يدوية وخرز راقي",
        "تصاميم عصرية مع الاحتشام الكامل",
        "مقاسات متعددة (XS إلى 4XL)",
        "بدون حد أدنى للطلب",
        "شحن سريع عالمي (3-7 أيام)",
        "طرق دفع آمنة"
      ],
      popularStyles: "فساتين أفراح ملكية، فساتين خطوبة، فساتين سواريه، فساتين سهرة طويلة، فساتين مناسبات، فساتين حفلات، فساتين زفاف، فساتين تخرج."
    }
  }
    ...
    <>
          ...
          <div className="stats-container">
            <div className="stats-info">
              <div className="stat-item">
                ...
                <span><strong>{totalProducts}</strong> فستان سهرة</span>
              </div>
              <div className="stat-item">
      ...
      <section className="products-section">
        <div className="container">
          <div className="products-header">
            <h2>تشكيلة <span>فساتين سهرة محجبات</span></h2>
            ...
            <>
              <div className="products-grid">
                {products.map((product: any) => {
                  const name = product.name_ar || product.name_en || 'فستان سهرة'
      ...
      <section className="seo-content">
        <div className="container">
          ...
          <h3>لماذا تختارين فساتين السهرة التركية؟</h3>
          <ul>
          ...
          <p>انضمي إلى أكثر من 5000+ تاجر تجزئة حول العالم يثقون بنا في مجموعات فساتين السهرة. من البوتيكات الصغيرة إلى كبار تجار التجزئة، نقدم جودة ثابتة وخدمة موثوقة. تصفحي مجموعتنا وقدمي استفسارك اليوم!</p>
          
          <p><strong>أنماط فساتين السهرة الشائعة:</strong> {PAGE_CONFIG.seoContent.popularStyles}</p>
        </div>
      </section>
    </>
  )

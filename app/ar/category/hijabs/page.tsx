...
export default function HijabsCategoryPage() {
  // تكوين الصفحة حسب التصنيف - حجاب
  const PAGE_CONFIG = {
    category: "حجاب",
    categoryName: "Hijabs",
    pageTitle: "حجاب تركي بالجملة | تشكيلة واسعة من الحجابات والشيلان التركية | حجاب فاشون مول",
    pageDescription: "تسوق أفضل الحجابات التركية بالجملة. تشكيلة واسعة من حجابات الشيفون والحرير والقطن والجيرسي. بدون حد أدنى للطلب، شحن عالمي سريع.",
    pageKeywords: "حجاب تركي بالجملة, شيلان تركية, حجاب شيفون, حجاب حرير, حجاب قطن, حجاب جيرسي, حجاب تركي, شيلة تركي, اكسسوارات حجاب",
    h1: "حجاب تركي بالجملة – أجود أنواع الحجابات والشيلان",
    subtitle: "اكتشفي مجموعتنا الرائعة من الحجابات التركية الأصلية. من حجابات الشيفون الفاخرة إلى حجابات القطن المريحة، ستجدين التشكيلة المثالية لمتجرك بأسعار الجملة.",
    seoContent: {
      h2: "حجاب تركي بالجملة – جودة وتنوع لجميع الأذواق",
      p1: "مرحباً بك في حجاب فاشون مول، مصدرك الأول للحجابات التركية الأصلية. تشكيلتنا تضم حجابات بمختلف الأقمشة والألوان والتصاميم. من حجابات الشيفون الفاخرة إلى حجابات الجيرسي المريحة، نوفر حجابات تناسب جميع الأذواق والمناسبات.",
      features: [
        "صناعة تركية 100% أصلية",
        "أقمشة فاخرة: شيفون، حرير، ساتان، قطن، جيرسي، فيسكوز",
        "مقاسات متنوعة",
      ...
      popularStyles: "حجاب شيفون، حجاب حرير، حجاب قطن، حجاب جيرسي، حجاب ساتان، حجاب مطبوع، حجاب مطرز، شيلان تركي، حجاب كريب."
    }
  }
    ...
    <>
          ...
          <div className="stats-container">
            <div className="stats-info">
              <div className="stat-item">
                ...
                <span><strong>{totalProducts}</strong> حجاب</span>
              </div>
              <div className="stat-item">
      ...
      <section className="products-section">
        <div className="container">
          <div className="products-header">
            <h2>تشكيلة <span>حجابات تركية</span></h2>
            ...
            <>
              <div className="products-grid">
                {products.map((product: any) => {
                  const name = product.name_ar || product.name_en || 'حجاب'
      ...
      <section className="seo-content">
        <div className="container">
          ...
          <h3>لماذا تختارين حجاباتنا التركية؟</h3>
          <ul>
          ...
          <p>انضمي إلى أكثر من 5000+ تاجر تجزئة حول العالم يثقون بنا في مجموعات الحجابات. من البوتيكات الصغيرة إلى كبار تجار التجزئة، نقدم جودة ثابتة وخدمة موثوقة. تصفحي مجموعتنا وقدمي استفسارك اليوم!</p>
          
          <p><strong>أنماط الحجابات الشائعة:</strong> {PAGE_CONFIG.seoContent.popularStyles}</p>
        </div>
      </section>
    </>
  )

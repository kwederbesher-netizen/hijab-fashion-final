// app/ar/category/hijabs/page.tsx
'use client'
...
export default function HijabsCategoryPageAr() {
  ...
  if (loading && products.length === 0) return (
    <div style={{ padding: '100px 20px', textAlign: 'center', minHeight: '60vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <p style={{ marginTop: '20px', color: '#555', fontSize: '16px' }}>جاري تحميل الحجابات...</p>
    </div>
  )
  ...
  return (
    <>
      <Head>
        <title>حجابات تركية بالجملة | مجموعة الشيفون والحرير والمخمل والقطن | هجاب فاشن مول</title>
        <meta name="description" content={`تشكيلة واسعة من الحجابات التركية بالجملة. شيفون انسيابي، حرير فاخر، مخمل دافئ، قطن ناعم. ألوان عصرية ومحايدة. تسوقوا الآن.`} />
        <meta name="keywords" content="حجابات تركية بالجملة, حجاب تركي, شيفون تركي, حجاب حرير, حجاب مخمل, حجاب قطن, حجاب بيز, اوشحة تركية, طرحة تركية, حجاب مدرج, حجاب فاخر, حجاب عصري, محجبات, حجابات موضة, استيراد حجابات من تركيا" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://hijabfashionmall.com/ar/category/hijabs" />
        ...
        <meta property="og:title" content="حجابات تركية بالجملة - شيفون وحرير ومخمل" />
        <meta property="og:description" content={`${totalProducts}+ موديل حجاب تركي. تشكيلة واسعة من الأقمشة الفاخرة والألوان العصرية.`} />
        <meta property="og:url" content="https://hijabfashionmall.com/ar/category/hijabs" />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://hijabfashionmall.com/images/og-hijabs-ar.jpg" />
      ...
      <section style={{ background: 'linear-gradient(135deg, #fdf8f2 0%, #ffffff 100%)', padding: '60px 0 40px', textAlign: 'center', borderBottom: '1px solid #f0e6dc', position: 'relative', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', fontSize: '200px', fontWeight: 800, color: 'rgba(255,90,0,0.03)', whiteSpace: 'nowrap', zIndex: 0, pointerEvents: 'none', fontFamily: 'Playfair Display, serif' }}>حجابات</div>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px', position: 'relative', zIndex: 1 }}>
          ...
          <h1 style={{ fontSize: '48px', color: '#2c2418', marginBottom: '15px', fontWeight: 800, lineHeight: '1.2', fontFamily: 'Playfair Display, serif' }}>
            حجابات تركية <span style={{ color: '#ff5a00' }}>راقية</span>
          </h1>
          <p style={{ fontSize: '18px', color: '#5a4a3a', maxWidth: '800px', margin: '0 auto', lineHeight: '1.6' }}>
            اكتشفوا مجموعتنا الواسعة من الحجابات التركية بالجملة. شيفون انسيابي، حرير فاخر، 
            مخمل دافئ وقطن ناعم لإطلالات متنوعة تناسب جميع الأذواق.
          </p>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '40px', marginTop: '40px', flexWrap: 'wrap' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>شيفون تركي</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>حرير ومخمل</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          ...
          <main>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '30px', flexWrap: 'wrap', gap: '15px', background: 'white', padding: '15px 25px', borderRadius: '20px', boxShadow: '0 5px 15px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
              <div style={{ color: '#5a4a3a', fontSize: '15px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                ...
                <span><span style={{ fontWeight: 600, color: '#ff5a00' }}>{totalProducts}</span> حجاب</span>
            ...
            {products.length === 0 ? (
              <div style={{ textAlign: 'center', padding: '80px 20px', background: 'white', borderRadius: '20px', boxShadow: '0 10px 30px rgba(0,0,0,0.05)', border: '1px solid #f0e6dc' }}>
                ...
                <h3 style={{ fontSize: '24px', color: '#2c2418', marginBottom: '10px', fontWeight: 600 }}>لم يتم العثور على حجابات</h3>
                ...
                {loading && products.length > 0 ? <LoadingSkeleton /> : (
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '25px', marginBottom: '50px' }}>
                    {products.map((p: any) => {
                      ...
                      const fabric = (p.name_ar || '').toLowerCase()
                      let fabricBadge = null
                      if (fabric.includes('شيفون')) fabricBadge = <span style={{ background: '#b87c4f', color: 'white', padding: '4px 12px', borderRadius: '20px', fontSize: '11px', fontWeight: 600 }}>شيفون</span>
                      else if (fabric.includes('حرير')) fabricBadge = <span style={{ background: '#d48c54', color: 'white', padding: '4px 12px', borderRadius: '20px', fontSize: '11px', fontWeight: 600 }}>حرير</span>
                      else if (fabric.includes('مخمل')) fabricBadge = <span style={{ background: '#a06e42', color: 'white', padding: '4px 12px', borderRadius: '20px', fontSize: '11px', fontWeight: 600 }}>مخمل</span>
                      else if (fabric.includes('قطن')) fabricBadge = <span style={{ background: '#c98a60', color: 'white', padding: '4px 12px', borderRadius: '20px', fontSize: '11px', fontWeight: 600 }}>قطن</span>
                      ...
                      return (
                        <Link href={getProductUrl(p)} key={p._id} style={{ background: 'white', borderRadius: '16px', overflow: 'hidden', boxShadow: '0 5px 20px rgba(0,0,0,0.05)', transition: 'all 0.3s', textDecoration: 'none', color: 'inherit', border: '1px solid #f0e6dc', display: 'block' }} onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-8px)'; e.currentTarget.style.boxShadow = '0 15px 30px rgba(255,90,0,0.12)'; e.currentTarget.style.borderColor = '#ff5a00'; }} onMouseLeave={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 5px 20px rgba(0,0,0,0.05)'; e.currentTarget.style.borderColor = '#f0e6dc'; }}>
                          <div style={{ position: 'relative', height: '280px', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, #fef9f2 0%, #faf5ed 100%)' }}>
                            <img src={p.imageUrl || '/images/default.webp'} alt={p.name_ar || 'حجاب تركي'} style={{ maxWidth: '90%', maxHeight: '90%', objectFit: 'contain', transition: 'transform 0.5s' }} loading="lazy" onError={(e) => { (e.target as HTMLImageElement).src = '/images/default.webp' }} />
                          ...
                          <div style={{ padding: '20px', textAlign: 'center' }}>
                            <div style={{ fontSize: '11px', color: '#ff5a00', marginBottom: '8px', fontWeight: 500, textTransform: 'uppercase', letterSpacing: '1px' }}>حجاب</div>
      ...
      {/* Size Chart for Hijabs */}
      <section style={{ background: 'white', padding: '60px 0', borderTop: '1px solid #f0e6dc', borderBottom: '1px solid #f0e6dc' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
          <div style={{ textAlign: 'center', marginBottom: '40px' }}>
            <h2 style={{ fontSize: '32px', color: '#2c2418', marginBottom: '15px', fontWeight: 700, fontFamily: 'Playfair Display, serif' }}>مقاسات الحجابات التركية القياسية</h2>
            <p style={{ fontSize: '16px', color: '#5a4a3a', maxWidth: '700px', margin: '0 auto' }}>المقاسات التالية هي المقاسات المعتمدة في المصانع التركية للحجابات والطرحات.</p>
          </div>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'center', minWidth: '500px' }}>
              <thead>
                <tr style={{ background: 'linear-gradient(135deg, #ff5a00 0%, #e04e00 100%)', color: 'white' }}>
                  <th style={{ padding: '15px', fontSize: '16px', fontWeight: 600 }}>النوع</th>
                  <th style={{ padding: '15px', fontSize: '16px', fontWeight: 600 }}>الطول (سم)</th>
                  <th style={{ padding: '15px', fontSize: '16px', fontWeight: 600 }}>العرض (سم)</th>
                  <th style={{ padding: '15px', fontSize: '16px', fontWeight: 600 }}>الوزن (جرام)</th>
                </tr>
              </thead>
              <tbody>
                {[
                  { type: 'شيفون', length: '180', width: '90', weight: '70-80' },
                  { type: 'حرير', length: '180', width: '90', weight: '60-70' },
                  { type: 'جيرسي', length: '180', width: '75', weight: '120-140' },
                  { type: 'مخمل', length: '180', width: '70', weight: '150-170' },
                  { type: 'قطن', length: '180', width: '90', weight: '100-120' },
                  { type: 'لنن', length: '180', width: '90', weight: '80-100' },
                  { type: 'حجاب مدرج', length: '200', width: '70', weight: '90-110' },
                  { type: 'طرحة مربعة', length: '110', width: '110', weight: '50-60' },
                ].map((row, index) => (
                  <tr key={row.type} style={{ background: index % 2 === 0 ? '#fef9f2' : 'white', borderBottom: '1px solid #f0e6dc' }}>
                    <td style={{ padding: '12px 15px', fontWeight: 600, color: '#ff5a00' }}>{row.type}</td>
                    <td style={{ padding: '12px 15px', color: '#4a3a2a' }}>{row.length}</td>
                    <td style={{ padding: '12px 15px', color: '#4a3a2a' }}>{row.width}</td>
                    <td style={{ padding: '12px 15px', color: '#4a3a2a' }}>{row.weight}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <div style={{ marginTop: '30px', padding: '20px', background: '#fef9f2', borderRadius: '16px', border: '1px solid #f0e6dc' }}>
            <h3 style={{ fontSize: '18px', color: '#2c2418', marginBottom: '15px', fontWeight: 600, display: 'flex', alignItems: 'center', gap: '10px' }}>
              ...
              نصائح لاختيار الحجاب المناسب
            </h3>
            <ul style={{ color: '#5a4a3a', lineHeight: '1.8', paddingRight: '20px' }}>
              <li>✓ الحجاب الشيفون مثالي للإطلالات اليومية والمناسبات، يتميز بخفة الوزن والانسيابية.</li>
              <li>✓ الحجاب الجيرسي مناسب للاستخدام اليومي لأنه لا ينزلق بسهولة ويتطلب تثبيت أقل.</li>
              <li>✓ الحجاب المخمل يضيف لمسة فاخرة للمناسبات الخاصة في فصل الشتاء.</li>
              <li>✓ الحجاب المربع مناسب لطرق لف مختلفة ويعطي تنوعاً في الإطلالة.</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section style={{ background: '#fef9f2', padding: '60px 0', borderTop: '1px solid #f0e6dc' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
          <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            <h2 style={{ fontSize: '32px', color: '#2c2418', marginBottom: '20px', fontWeight: 700, textAlign: 'center', fontFamily: 'Playfair Display, serif' }}>مجموعة متكاملة من الحجابات التركية بالجملة</h2>
            <p style={{ fontSize: '16px', color: '#5a4a3a', lineHeight: '1.8', marginBottom: '25px', textAlign: 'justify' }}>
              هجاب فاشن مول يوفر تشكيلة واسعة من <strong>الحجابات التركية بالجملة</strong> بجودة عالية وأسعار تنافسية. مجموعتنا تضم أكثر من <strong>{totalProducts} حجاب</strong> بتصاميم وألوان تناسب جميع الأذواق. نقدم حجابات الشيفون التركي الفاخر، الحجابات الحريرية الناعمة، الحجابات المخملية الدافئة، والحجابات القطنية المريحة. جميع المنتجات مصنوعة من أقمشة مختارة بعناية لضمان الراحة والجمال.
            </p>
            <h3 style={{ fontSize: '24px', color: '#2c2418', margin: '35px 0 20px', fontWeight: 600 }}>أنواع الحجابات المتاحة</h3>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '15px', marginBottom: '35px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00"><path d="M20 6L9 17l-5-5"/></svg><span><strong>حجاب شيفون تركي</strong> – قماش انسيابي، خفيف، مثالي لجميع الفصول</span></div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00"><path d="M20 6L9 17l-5-5"/></svg><span><strong>حجاب حرير</strong> – لمسة فاخرة ولمعة طبيعية للمناسبات</span></div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00"><path d="M20 6L9 17l-5-5"/></svg><span><strong>حجاب جيرسي</strong> – قماش مطاطي، لا ينزلق، مثالي للارتداء اليومي</span></div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00"><path d="M20 6L9 17l-5-5"/></svg><span><strong>حجاب مخمل</strong> – قماش فاخر دافئ للمناسبات الشتوية</span></div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00"><path d="M20 6L9 17l-5-5"/></svg><span><strong>حجاب قطن</strong> – مريح وقابل للتنفس، مناسب للاستخدام اليومي</span></div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00"><path d="M20 6L9 17l-5-5"/></svg><span><strong>حجاب مدرج</strong> – تصميم عصري بألوان متدرجة جذابة</span></div>
            </div>
            <h3 style={{ fontSize: '24px', color: '#2c2418', margin: '35px 0 20px', fontWeight: 600 }}>خصائص الحجابات التركية</h3>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '15px', marginBottom: '35px' }}>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>جودة الأقمشة:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>أقمشة تركية عالية الجودة، ناعمة الملمس، لا تبهت بسرعة</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>تشكيلة الألوان:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>ألوان موسمية عصرية وألوان أساسية محايدة تناسب الجميع</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>المتانة:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>خياطة متقنة وحواف مدعمة لتدوم طويلاً</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>سهولة العناية:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>غسيل يدوي أو في الغسالة على برنامج لطيف</p></div>
            </div>
            <p style={{ fontSize: '16px', color: '#5a4a3a', lineHeight: '1.8', textAlign: 'justify' }}>
              سواء كنتم تبحثون عن حجابات يومية عملية أو حجابات فاخرة للمناسبات، مجموعة الحجابات التركية بالجملة في هجاب فاشن مول توفر لكم خيارات متنوعة تناسب جميع الأذواق والميزانيات. جميع المنتجات متوفرة بكميات الجملة مع خيارات تغليف مرنة (قطعة واحدة أو حزمة كاملة). للاستفسار عن الطلبات بالجملة، تواصلوا مع فريق المبيعات لدينا عبر الواتساب أو التيليغرام.
            </p>
          </div>
        </div>
      </section>

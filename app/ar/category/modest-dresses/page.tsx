...
export default function ModestDressesCategoryPage() {
  // تكوين الصفحة حسب التصنيف - فساتين محجبات
  const PAGE_CONFIG = {
    category: "فساتين محجبات",
    categoryName: "Modest Dresses",
    pageTitle: "فساتين محجبات تركية بالجملة | تشكيلة واسعة من الفساتين المحتشمة | حجاب فاشون مول",
    pageDescription: "تسوق أفضل الفساتين المحتشمة للباحثات عن الأناقة والاحتشام. فساتين محجبات تركية بالجملة بأفضل الأسعار. تشكيلة واسعة من الفساتين الطويلة والقصيرة والميدي.",
    pageKeywords: "فساتين محجبات, فساتين محتشمة, فساتين تركية بالجملة, فساتين طويلة, فساتين سهرة محجبات, فساتين صيفية, فساتين شتوية, ملابس محجبات تركية",
    h1: "فساتين محجبات تركية بالجملة – تشكيلة راقية",
    subtitle: "اكتشفي مجموعتنا الرائعة من الفساتين المحتشمة من تركيا. من الفساتين الطويلة الأنيقة إلى فساتين السهرة المميزة، ستجدين القطع المثالية لمتجرك بأسعار الجملة.",
    seoContent: {
      h2: "فساتين محجبات بالجملة – أناقة واحتشام في آن واحد",
      p1: "مرحباً بك في حجاب فاشون مول، مصدرك الأول للفساتين التركية المحتشمة الأصلية. تشكيلتنا تضم فساتين تجمع بشكل مثالي بين الأناقة العصرية ومتطلبات الموضة المحتشمة. سواء كنت تبحثين عن فساتين يومية كاجوال أو فساتين سهرة أنيقة، لدينا ما يناسب كل المناسبات.",
      features: [
        "صناعة تركية 100% أصلية",
        "أقمشة فاخرة: كريب، فيسكوز، قطن، بوليستر، شيفون",
      ...
      popularStyles: "فساتين طويلة (ماكسي)، فساتين قصيرة (ميدي)، فساتين سهرة، فساتين كاجوال، فساتين حفلات، فساتين عمل، تشكيلة رمضان، مجموعة العيد."
    }
  }
    ...
    <>
          ...
          <div className="stats-container">
            <div className="stats-info">
              <div className="stat-item">
                ...
                <span><strong>{totalProducts}</strong> فستان</span>
              </div>
              <div className="stat-item">
      ...
      <section className="products-section">
        <div className="container">
          <div className="products-header">
            <h2>تشكيلة <span>فساتين محجبات</span></h2>
            ...
            <>
              <div className="products-grid">
                {products.map((product: any) => {
                  const name = product.name_ar || product.name_en || 'فستان'
      ...
      <section className="seo-content">
        <div className="container">
          ...
          <h3>لماذا تختارين فساتيننا التركية؟</h3>
          <ul>
          ...
          <p>انضمي إلى أكثر من 5000+ تاجر تجزئة حول العالم يثقون بنا في مجموعات فساتينهم. من البوتيكات الصغيرة إلى كبار تجار التجزئة، نقدم جودة ثابتة وخدمة موثوقة. تصفحي مجموعتنا وقدمي استفسارك اليوم!</p>
          
          <p><strong>أنماط الفساتين الشائعة:</strong> {PAGE_CONFIG.seoContent.popularStyles}</p>
        </div>
      </section>
    </>
  )

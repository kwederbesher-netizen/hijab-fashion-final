// app/ar/category/modest-dresses/page.tsx
'use client'
...
export default function ModestDressesCategoryPageAr() {
  ...
  if (loading && products.length === 0) return (
    <div style={{ padding: '100px 20px', textAlign: 'center', minHeight: '60vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <p style={{ marginTop: '20px', color: '#555', fontSize: '16px' }}>جاري تحميل الفساتين المحتشمة...</p>
    </div>
  )
  ...
  return (
    <>
      <Head>
        <title>فساتين محتشمة تركية بالجملة | فساتين ناعمة وكاجوال وسهرة | هجاب فاشن مول</title>
        <meta name="description" content={`تشكيلة فساتين محتشمة تركية بالجملة. فساتين ناعمة للاستخدام اليومي، فساتين سهرة للمناسبات، فساتين كاجوال أنيقة. تصاميم عصرية تغطي المعايير.`} />
        <meta name="keywords" content="فساتين محتشمة بالجملة, فساتين تركية محتشمة, فساتين طويلة, فساتين ناعمة, فساتين كاجوال, فساتين سهرة محتشمة, فساتين أنيقة, فساتين كم طويل, فساتين عصرية, موضة محتشمة" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://hijabfashionmall.com/ar/category/modest-dresses" />
        ...
        <meta property="og:title" content="فساتين محتشمة تركية بالجملة - ناعمة وأنيقة" />
        <meta property="og:description" content={`${totalProducts}+ موديل فستان محتشم. تشكيلة متنوعة تناسب جميع المناسبات.`} />
        <meta property="og:url" content="https://hijabfashionmall.com/ar/category/modest-dresses" />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://hijabfashionmall.com/images/og-modest-dresses-ar.jpg" />
      ...
      <section style={{ background: 'linear-gradient(135deg, #fdf8f2 0%, #ffffff 100%)', padding: '60px 0 40px', textAlign: 'center', borderBottom: '1px solid #f0e6dc', position: 'relative', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', fontSize: '180px', fontWeight: 800, color: 'rgba(255,90,0,0.03)', whiteSpace: 'nowrap', zIndex: 0, pointerEvents: 'none', fontFamily: 'Playfair Display, serif' }}>فساتين</div>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px', position: 'relative', zIndex: 1 }}>
          <div style={{ fontSize: '14px', color: '#7a6a5a', marginBottom: '20px' }}>
            ...
            <span style={{ margin: '0 8px' }}>/</span>
            <span>الفساتين المحتشمة</span>
          </div>
          <h1 style={{ fontSize: '48px', color: '#2c2418', marginBottom: '15px', fontWeight: 800, lineHeight: '1.2', fontFamily: 'Playfair Display, serif' }}>
            فساتين محتشمة <span style={{ color: '#ff5a00' }}>عصرية</span>
          </h1>
          <p style={{ fontSize: '18px', color: '#5a4a3a', maxWidth: '800px', margin: '0 auto', lineHeight: '1.6' }}>
            اكتشفوا تشكيلتنا من الفساتين المحتشمة التركية. تصاميم ناعمة للمناسبات اليومية، 
            وفساتين أنيقة للمناسبات الخاصة، وقطع كاجوال مريحة بتفاصيل عصرية.
          </p>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '40px', marginTop: '40px', flexWrap: 'wrap' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>فساتين ناعمة</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>فساتين سهرة</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          ...
          <main>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '30px', flexWrap: 'wrap', gap: '15px', background: 'white', padding: '15px 25px', borderRadius: '20px', boxShadow: '0 5px 15px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
              <div style={{ color: '#5a4a3a', fontSize: '15px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                ...
                <span><span style={{ fontWeight: 600, color: '#ff5a00' }}>{totalProducts}</span> فستان محتشم</span>
            ...
            {products.length === 0 ? (
              <div style={{ textAlign: 'center', padding: '80px 20px', background: 'white', borderRadius: '20px', boxShadow: '0 10px 30px rgba(0,0,0,0.05)', border: '1px solid #f0e6dc' }}>
                ...
                <h3 style={{ fontSize: '24px', color: '#2c2418', marginBottom: '10px', fontWeight: 600 }}>لم يتم العثور على فساتين</h3>
                ...
                {loading && products.length > 0 ? <LoadingSkeleton /> : (
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '25px', marginBottom: '50px' }}>
                    {products.map((p: any) => {
                      ...
                      if (fabric.includes('كتان')) fabricBadge = <span style={{ background: '#b87c4f', color: 'white', padding: '4px 12px', borderRadius: '20px', fontSize: '11px', fontWeight: 600 }}>كتان</span>
                      else if (fabric.includes('قطن')) fabricBadge = <span style={{ background: '#d48c54', color: 'white', padding: '4px 12px', borderRadius: '20px', fontSize: '11px', fontWeight: 600 }}>قطن</span>
                      else if (fabric.includes('شيفون')) fabricBadge = <span style={{ background: '#a06e42', color: 'white', padding: '4px 12px', borderRadius: '20px', fontSize: '11px', fontWeight: 600 }}>شيفون</span>
                      ...
                      return (
                        <Link href={getProductUrl(p)} key={p._id} style={{ background: 'white', borderRadius: '16px', overflow: 'hidden', boxShadow: '0 5px 20px rgba(0,0,0,0.05)', transition: 'all 0.3s', textDecoration: 'none', color: 'inherit', border: '1px solid #f0e6dc', display: 'block' }} onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-8px)'; e.currentTarget.style.boxShadow = '0 15px 30px rgba(255,90,0,0.12)'; e.currentTarget.style.borderColor = '#ff5a00'; }} onMouseLeave={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 5px 20px rgba(0,0,0,0.05)'; e.currentTarget.style.borderColor = '#f0e6dc'; }}>
                          <div style={{ position: 'relative', height: '280px', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, #fef9f2 0%, #faf5ed 100%)' }}>
                            <img src={p.imageUrl || '/images/default.webp'} alt={p.name_ar || 'فستان محتشم'} style={{ maxWidth: '90%', maxHeight: '90%', objectFit: 'contain', transition: 'transform 0.5s' }} loading="lazy" onError={(e) => { (e.target as HTMLImageElement).src = '/images/default.webp' }} />
                          ...
                          <div style={{ padding: '20px', textAlign: 'center' }}>
                            <div style={{ fontSize: '11px', color: '#ff5a00', marginBottom: '8px', fontWeight: 500, textTransform: 'uppercase', letterSpacing: '1px' }}>فستان محتشم</div>
      ...
      {/* Size Chart for Modest Dresses */}
      <section style={{ background: 'white', padding: '60px 0', borderTop: '1px solid #f0e6dc', borderBottom: '1px solid #f0e6dc' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
          <div style={{ textAlign: 'center', marginBottom: '40px' }}>
            <h2 style={{ fontSize: '32px', color: '#2c2418', marginBottom: '15px', fontWeight: 700, fontFamily: 'Playfair Display, serif' }}>دليل مقاسات الفساتين المحتشمة التركية</h2>
            <p style={{ fontSize: '16px', color: '#5a4a3a', maxWidth: '700px', margin: '0 auto' }}>المقاسات المعتمدة للموديلات التركية. يرجى مراعاة اختلاف 1-2 سم حسب الموديل ونوع القماش.</p>
          </div>
          <div style={{ overflowX: 'auto', borderRadius: '20px', border: '1px solid #f0e6dc', background: 'white' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'center', minWidth: '600px' }}>
              ...
              <tbody>
                {[
                  { size: 'XS / 34', chest: '80-84', waist: '62-66', hip: '86-90', length: '135-140' },
                  { size: 'S / 36', chest: '84-88', waist: '66-70', hip: '90-94', length: '135-140' },
                  { size: 'M / 38', chest: '88-92', waist: '70-74', hip: '94-98', length: '140-145' },
                  { size: 'L / 40', chest: '92-96', waist: '74-78', hip: '98-102', length: '140-145' },
                  { size: 'XL / 42', chest: '96-100', waist: '78-82', hip: '102-106', length: '145-150' },
                  { size: '2XL / 44', chest: '100-104', waist: '82-86', hip: '106-110', length: '145-150' },
                  { size: '3XL / 46', chest: '104-108', waist: '86-90', hip: '110-114', length: '150-155' },
                  { size: '4XL / 48', chest: '108-112', waist: '90-94', hip: '114-118', length: '150-155' },
                ].map((row, index) => (
          ...
          <div style={{ marginTop: '30px', padding: '20px', background: '#fef9f2', borderRadius: '16px', border: '1px solid #f0e6dc' }}>
            <h3 style={{ fontSize: '18px', color: '#2c2418', marginBottom: '15px', fontWeight: 600, display: 'flex', alignItems: 'center', gap: '10px' }}>
              ...
              نصائح لاختيار مقاس الفستان المناسب
            </h3>
            <ul style={{ color: '#5a4a3a', lineHeight: '1.8', paddingRight: '20px' }}>
              <li>✓ قم بقياس الصدر والخصر والورك بدقة باستخدام شريط القياس.</li>
              <li>✓ إذا كنت بين مقاسين، ننصح باختيار المقاس الأكبر للحصول على راحة أفضل.</li>
              <li>✓ الأقمشة المطاطية تعطي مرونة أكبر في المقاس.</li>
              <li>✓ طول الفستان يختلف حسب الموديل (ماكسي، ميدي، منتصف الساق).</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section style={{ background: '#fef9f2', padding: '60px 0', borderTop: '1px solid #f0e6dc' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
          <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            <h2 style={{ fontSize: '32px', color: '#2c2418', marginBottom: '20px', fontWeight: 700, textAlign: 'center', fontFamily: 'Playfair Display, serif' }}>تشكيلة فساتين محتشمة تركية بالجملة</h2>
            <p style={{ fontSize: '16px', color: '#5a4a3a', lineHeight: '1.8', marginBottom: '25px', textAlign: 'justify' }}>
              هجاب فاشن مول يقدم <strong>فساتين محتشمة تركية بالجملة</strong> بتصاميم عصرية وأقمشة عالية الجودة. مجموعتنا تضم أكثر من <strong>{totalProducts} فستان</strong> يناسب مختلف الأذواق والمناسبات. نوفر فساتين يومية ناعمة، فساتين سهرة أنيقة، فساتين كاجوال مريحة، وفساتين عمل عملية.
            </p>
            <h3 style={{ fontSize: '24px', color: '#2c2418', margin: '35px 0 20px', fontWeight: 600 }}>أنواع الفساتين المتاحة</h3>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '15px', marginBottom: '35px' }}>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>فساتين ناعمة:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>تصاميم بسيطة وأنيقة للاستخدام اليومي</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>فساتين سهرة:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>تفاصيل راقية وأقمشة فاخرة للمناسبات</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>فساتين كاجوال:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>مريحة وعملية للخروجات اليومية</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>فساتين عمل:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>تصاميم احترافية مناسبة لبيئة العمل</p></div>
            </div>
            <h3 style={{ fontSize: '24px', color: '#2c2418', margin: '35px 0 20px', fontWeight: 600 }}>خصائص الفساتين المحتشمة التركية</h3>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '15px', marginBottom: '35px' }}>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>خامات ممتازة:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>أقمشة تركية عالية الجودة وناعمة الملمس</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>تشكيلة ألوان:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>ألوان موسمية وأساسية تناسب جميع الأذواق</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>مقاسات متنوعة:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>مقاسات من XS إلى 4XL لتلبية احتياجات الجميع</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>تفاصيل متقنة:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>خياطة متقنة وتشطيبات عالية الجودة</p></div>
            </div>
          </div>
        </div>
      </section>

// app/ar/category/burkini/page.tsx
'use client'
...
export default function BurkiniCategoryPageAr() {
  ...
  return (
    <>
      <Head>
        <title>بوركيني تركي بالجملة | مايوه محتشم للسباحة | هجاب فاشن مول</title>
        <meta name="description" content={`تشكيلة بوركيني تركي بالجملة. مايوهات محتشمة للسباحة بأقمشة سريعة الجفاف ومقاومة للملح والكلور. تصاميم عصرية تناسب جميع الأذواق.`} />
        <meta name="keywords" content="بوركيني بالجملة, بوركيني تركي, مايوه محتشم, بوركيني شاطئ, سباحة محتشمة, بوركيني قطعتين, بوركيني قطعة واحدة, بوركيني للأطفال, ملابس سباحة محتشمة" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://hijabfashionmall.com/ar/category/burkini" />
        ...
        <meta property="og:title" content="بوركيني تركي بالجملة - مايوه محتشم للسباحة" />
        <meta property="og:description" content={`${totalProducts}+ بوركيني. تصاميم عصرية ومريحة للسباحة.`} />
        <meta property="og:url" content="https://hijabfashionmall.com/ar/category/burkini" />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://hijabfashionmall.com/images/og-burkini-ar.jpg" />
      ...
      <section style={{ background: 'linear-gradient(135deg, #fdf8f2 0%, #ffffff 100%)', padding: '60px 0 40px', textAlign: 'center', borderBottom: '1px solid #f0e6dc', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px', position: 'relative', zIndex: 1 }}>
          ...
          <h1 style={{ fontSize: '48px', color: '#2c2418', marginBottom: '15px', fontWeight: 800, lineHeight: '1.2', fontFamily: 'Playfair Display, serif' }}>
            بوركيني <span style={{ color: '#ff5a00' }}>تركي</span>
          </h1>
          <p style={{ fontSize: '18px', color: '#5a4a3a', maxWidth: '800px', margin: '0 auto', lineHeight: '1.6' }}>
            مايوهات محتشمة للسباحة بأقمشة سريعة الجفاف ومقاومة للملح والكلور. 
            تصاميم عصرية تناسب الشاطئ والمسابح.
          </p>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '40px', marginTop: '40px', flexWrap: 'wrap' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>بوركيني قطعة واحدة</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>بوركيني قطعتين</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          ...
          <main>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '30px', flexWrap: 'wrap', gap: '15px', background: 'white', padding: '15px 25px', borderRadius: '20px', boxShadow: '0 5px 15px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
              <div style={{ color: '#5a4a3a', fontSize: '15px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                ...
                <span><span style={{ fontWeight: 600, color: '#ff5a00' }}>{totalProducts}</span> بوركيني</span>
            ...
            {products.length === 0 ? (
              <div style={{ textAlign: 'center', padding: '80px 20px', background: 'white', borderRadius: '20px', boxShadow: '0 10px 30px rgba(0,0,0,0.05)', border: '1px solid #f0e6dc' }}>
                ...
                <h3 style={{ fontSize: '24px', color: '#2c2418', marginBottom: '10px', fontWeight: 600 }}>لم يتم العثور على بوركيني</h3>
                      ...
                      return (
                        <Link href={getProductUrl(p)} key={p._id} style={{ background: 'white', borderRadius: '16px', overflow: 'hidden', boxShadow: '0 5px 20px rgba(0,0,0,0.05)', transition: 'all 0.3s', textDecoration: 'none', color: 'inherit', border: '1px solid #f0e6dc', display: 'block' }} onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-8px)'; e.currentTarget.style.boxShadow = '0 15px 30px rgba(255,90,0,0.12)'; e.currentTarget.style.borderColor = '#ff5a00'; }} onMouseLeave={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 5px 20px rgba(0,0,0,0.05)'; e.currentTarget.style.borderColor = '#f0e6dc'; }}>
                          <div style={{ position: 'relative', height: '280px', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, #fef9f2 0%, #faf5ed 100%)' }}>
                            <img src={p.imageUrl || '/images/default.webp'} alt={p.name_ar || 'بوركيني'} style={{ maxWidth: '90%', maxHeight: '90%', objectFit: 'contain', transition: 'transform 0.5s' }} loading="lazy" onError={(e) => { (e.target as HTMLImageElement).src = '/images/default.webp' }} />
      ...
      {/* Size Chart for Burkini */}
      <section style={{ background: 'white', padding: '60px 0', borderTop: '1px solid #f0e6dc', borderBottom: '1px solid #f0e6dc' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
          <div style={{ textAlign: 'center', marginBottom: '40px' }}>
            <h2 style={{ fontSize: '32px', color: '#2c2418', marginBottom: '15px', fontWeight: 700, fontFamily: 'Playfair Display, serif' }}>دليل مقاسات البوركيني التركي</h2>
            <p style={{ fontSize: '16px', color: '#5a4a3a', maxWidth: '700px', margin: '0 auto' }}>المقاسات القياسية المعتمدة للبوركيني التركي. يفضل اختيار مقاس مريح للسباحة.</p>
          </div>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'center', minWidth: '550px' }}>
              <thead>
                <tr style={{ background: 'linear-gradient(135deg, #ff5a00 0%, #e04e00 100%)', color: 'white' }}>
                  ...
                  <th style={{ padding: '15px', fontSize: '16px', fontWeight: 600 }}>طول البوركيني (سم)</th>
                </tr>
              </thead>
              <tbody>
                {[
                  { size: 'XS / 34', chest: '80-84', waist: '62-66', hip: '86-90', length: '130-135' },
                  { size: 'S / 36', chest: '84-88', waist: '66-70', hip: '90-94', length: '135-140' },
                  { size: 'M / 38', chest: '88-92', waist: '70-74', hip: '94-98', length: '140-145' },
                  { size: 'L / 40', chest: '92-96', waist: '74-78', hip: '98-102', length: '145-150' },
                  { size: 'XL / 42', chest: '96-100', waist: '78-82', hip: '102-106', length: '150-155' },
                  ...
                  { size: '4XL / 48', chest: '108-112', waist: '90-94', hip: '114-118', length: '165-170' },
                ].map((row, index) => (
          ...
          <div style={{ marginTop: '30px', padding: '20px', background: '#fef9f2', borderRadius: '16px', border: '1px solid #f0e6dc' }}>
            <h3 style={{ fontSize: '18px', color: '#2c2418', marginBottom: '15px', fontWeight: 600, display: 'flex', alignItems: 'center', gap: '10px' }}>
              ...
              نصائح لاختيار البوركيني المناسب
            </h3>
            <ul style={{ color: '#5a4a3a', lineHeight: '1.8', paddingRight: '20px' }}>
              <li>✓ اختر أقمشة سريعة الجفاف ومقاومة للملح والكلور مثل الليكرا والبوليستر.</li>
              <li>✓ يفضل اختيار مقاس مريح يسمح بحرية الحركة أثناء السباحة.</li>
              <li>✓ البوركيني التركي يتميز بتصاميم عصرية تغطي الجسم بالكامل.</li>
              <li>✓ تأكد من جودة الخياطة خاصة في المناطق التي تتعرض للتمدد أثناء الحركة.</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section style={{ background: '#fef9f2', padding: '60px 0', borderTop: '1px solid #f0e6dc' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
          <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            <h2 style={{ fontSize: '32px', color: '#2c2418', marginBottom: '20px', fontWeight: 700, textAlign: 'center', fontFamily: 'Playfair Display, serif' }}>بوركيني تركي بالجملة للسباحة</h2>
            <p style={{ fontSize: '16px', color: '#5a4a3a', lineHeight: '1.8', marginBottom: '25px', textAlign: 'justify' }}>
              هجاب فاشن مول يقدم <strong>بوركيني تركي بالجملة</strong> بتصاميم عصرية وأقمشة عالية الجودة. مجموعتنا تضم أكثر من <strong>{totalProducts} بوركيني</strong> مناسب للسباحة والشاطئ. يتميز البوركيني التركي بالأقمشة سريعة الجفاف والمقاومة للملح والكلور.
            </p>
            <h3 style={{ fontSize: '24px', color: '#2c2418', margin: '35px 0 20px', fontWeight: 600 }}>أنواع البوركيني المتاحة</h3>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '15px', marginBottom: '35px' }}>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>بوركيني قطعة واحدة:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>تصميم كلاسيكي يغطي الجسم بالكامل</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>بوركيني قطعتين:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>يتكون من تيشيرت وبنطال سباحة</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>بوركيني مع طاقية:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>مجموعة متكاملة تشمل طاقية سباحة</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>بوركيني للأطفال:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>تصاميم خاصة للأطفال تناسب حمامات السباحة</p></div>
            </div>
            <h3 style={{ fontSize: '24px', color: '#2c2418', margin: '35px 0 20px', fontWeight: 600 }}>مميزات البوركيني التركي</h3>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '15px', marginBottom: '35px' }}>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>جفاف سريع:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>أقمشة تقنية تجف بسرعة بعد السباحة</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>مقاومة للماء:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>تتحمل التعرض المستمر للملح والكلور</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>حماية من الشمس:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>تغطي الجسم وتحمي من أشعة الشمس</p></div>

...
export default function BurkiniCategoryPage() {
  // تكوين الصفحة حسب التصنيف - بوركيني وملابس سباحة محجبات
  const PAGE_CONFIG = {
    category: "بوركيني وملابس سباحة محجبات",
    categoryName: "Burkini",
    pageTitle: "بوركيني تركي بالجملة | ملابس سباحة محجبات | أطقم بوركيني محتشمة | حجاب فاشون مول",
    pageDescription: "تسوق أفضل البوركيني التركي وملابس السباحة المحجبات بالجملة. أطقم بوركيني عصرية، ملابس سباحة محتشمة، أطقم شاطئ كاملة. بدون حد أدنى للطلب، شحن عالمي سريع.",
    pageKeywords: "بوركيني, ملابس سباحة محجبات, بوركيني تركي, أطقم بوركيني, ملابس شاطئ محتشمة, بوركيني بالجملة, swimwear modest, burkini wholesale",
    h1: "بوركيني تركي بالجملة – أناقة وراحة على الشاطئ",
    subtitle: "اكتشفي مجموعتنا الرائعة من البوركيني التركي وملابس السباحة المحجبات. أطقم بوركيني عصرية مصممة لتوفير أقصى درجات الراحة والاحتشام أثناء السباحة والأنشطة المائية.",
    seoContent: {
      h2: "بوركيني تركي بالجملة – أحدث تصاميم ملابس السباحة المحتشمة",
      p1: "مرحباً بك في حجاب فاشون مول، مصدرك الأول للبوركيني التركي الأصلي وملابس السباحة المحجبات. تشكيلتنا تضم أطقم بوركيني عصرية مصممة خصيصاً لتوفير الراحة والاحتشام أثناء السباحة. من البوركيني الكلاسيكي إلى التصاميم العصرية الملونة، نوفر ملابس سباحة تناسب جميع الأذواق.",
      features: [
        "صناعة تركية 100% أصلية",
        "أقمشة عالية الجودة: ليكرا، بوليستر، نايلون، أقمشة سريعة الجفاف",
        "حماية من الأشعة فوق البنفسجية (UPF 50+)",
        "مقاسات متعددة (XS إلى 4XL)",
        "تشكيلة واسعة من الألوان والتصاميم",
        "أطقم كاملة (بوركيني + حجاب سباحة)",
        "بدون حد أدنى للطلب",
        "شحن سريع عالمي (3-7 أيام)",
        "طرق دفع آمنة"
      ],
      popularStyles: "بوركيني قطعتين, بوركيني قطعة واحدة, بوركيني بأكمام طويلة, بوركيني بأكمام قصيرة, أطقم شاطئ كاملة, حجاب سباحة, بوركيني للأطفال, بوركيني رياضي."
    }
  }
    ...
    <>
      ...
      <section className="page-header">
        <div className="container">
          <div className="breadcrumb">
            ...
            <span>بوركيني وملابس سباحة محجبات</span>
          </div>
      ...
      <section className="products-section">
        <div className="container">
          <div className="products-header">
            <h2>تشكيلة <span>بوركيني وملابس سباحة محجبات</span></h2>
            ...
            <>
              <div className="products-grid">
                {products.map((product: any) => {
                  const name = product.name_ar || product.name_en || 'بوركيني'
      ...
      <section className="seo-content">
        <div className="container">
          ...
          <h3>لماذا تختارين البوركيني التركي؟</h3>
          <ul>
          ...
          <p>انضمي إلى أكثر من 5000+ تاجر تجزئة حول العالم يثقون بنا في مجموعات البوركيني وملابس السباحة المحجبات. من البوتيكات الصغيرة إلى كبار تجار التجزئة، نقدم جودة ثابتة وخدمة موثوقة. تصفحي مجموعتنا وقدمي استفسارك اليوم!</p>
          
          <p><strong>أنماط البوركيني الشائعة:</strong> {PAGE_CONFIG.seoContent.popularStyles}</p>
        </div>
      </section>
    </>
  )

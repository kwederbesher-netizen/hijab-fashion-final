...
export default function ModestSkirtSetsCategoryPageAr() {
  ...
  if (loading && products.length === 0) return (
    <div style={{ padding: '100px 20px', textAlign: 'center', minHeight: '60vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <p style={{ marginTop: '20px', color: '#555', fontSize: '16px' }}>جاري تحميل التنانير والبلوزات...</p>
    </div>
  )
  ...
  return (
    <>
      <Head>
        <title>تنانير وبلوزات محتشمة تركية بالجملة | طقم تنورة وبلوزة | هجاب فاشن مول</title>
        <meta name="description" content={`تشكيلة تنانير وبلوزات محتشمة تركية بالجملة. أطقم متناسقة من التنانير الطويلة والبلوزات الأنيقة. تصاميم عصرية للمناسبات اليومية والعمل.`} />
        <meta name="keywords" content="تنانير محتشمة بالجملة, بلوزات محتشمة, طقم تنورة وبلوزة, جيبة طويلة, بلوزة كم طويل, أطقم محتشمة, موضة محتشمة, تنورة تركية, بلوزة تركية" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://hijabfashionmall.com/ar/category/modest-skirt-sets" />
        ...
        <meta property="og:title" content="تنانير وبلوزات محتشمة تركية بالجملة - أطقم متناسقة" />
        <meta property="og:description" content={`${totalProducts}+ طقم تنورة وبلوزة. تشكيلة أنيقة تناسب جميع الأوقات.`} />
        <meta property="og:url" content="https://hijabfashionmall.com/ar/category/modest-skirt-sets" />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://hijabfashionmall.com/images/og-modest-skirt-sets-ar.jpg" />
      ...
      <section style={{ background: 'linear-gradient(135deg, #fdf8f2 0%, #ffffff 100%)', padding: '60px 0 40px', textAlign: 'center', borderBottom: '1px solid #f0e6dc', position: 'relative', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', fontSize: '160px', fontWeight: 800, color: 'rgba(255,90,0,0.03)', whiteSpace: 'nowrap', zIndex: 0, pointerEvents: 'none', fontFamily: 'Playfair Display, serif' }}>تنانير</div>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px', position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '40px', marginTop: '40px', flexWrap: 'wrap' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>تنانير طويلة</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          ...
          <main>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '30px', flexWrap: 'wrap', gap: '15px', background: 'white', padding: '15px 25px', borderRadius: '20px', boxShadow: '0 5px 15px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
              <div style={{ color: '#5a4a3a', fontSize: '15px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                ...
                <span><span style={{ fontWeight: 600, color: '#ff5a00' }}>{totalProducts}</span> طقم تنورة وبلوزة</span>
            ...
            {products.length === 0 ? (
              <div style={{ textAlign: 'center', padding: '80px 20px', background: 'white', borderRadius: '20px', boxShadow: '0 10px 30px rgba(0,0,0,0.05)', border: '1px solid #f0e6dc' }}>
                ...
                <h3 style={{ fontSize: '24px', color: '#2c2418', marginBottom: '10px', fontWeight: 600 }}>لم يتم العثور على أطقم</h3>
                      ...
                      return (
                        <Link href={getProductUrl(p)} key={p._id} style={{ background: 'white', borderRadius: '16px', overflow: 'hidden', boxShadow: '0 5px 20px rgba(0,0,0,0.05)', transition: 'all 0.3s', textDecoration: 'none', color: 'inherit', border: '1px solid #f0e6dc', display: 'block' }} onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-8px)'; e.currentTarget.style.boxShadow = '0 15px 30px rgba(255,90,0,0.12)'; e.currentTarget.style.borderColor = '#ff5a00'; }} onMouseLeave={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 5px 20px rgba(0,0,0,0.05)'; e.currentTarget.style.borderColor = '#f0e6dc'; }}>
                          <div style={{ position: 'relative', height: '280px', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, #fef9f2 0%, #faf5ed 100%)' }}>
                            <img src={p.imageUrl || '/images/default.webp'} alt={p.name_ar || 'طقم تنورة وبلوزة'} style={{ maxWidth: '90%', maxHeight: '90%', objectFit: 'contain', transition: 'transform 0.5s' }} loading="lazy" onError={(e) => { (e.target as HTMLImageElement).src = '/images/default.webp' }} />
                            {badges.length > 0 && <div style={{ position: 'absolute', top: '15px', right: '15px', display: 'flex', gap: '6px', flexDirection: 'column' }}>{badges}</div>}
                          </div>
                          <div style={{ padding: '20px', textAlign: 'center' }}>
                            <div style={{ fontSize: '11px', color: '#ff5a00', marginBottom: '8px', fontWeight: 500, textTransform: 'uppercase', letterSpacing: '1px' }}>طقم تنورة وبلوزة</div>
      ...
      {/* Size Chart for Skirt Sets */}
      <section style={{ background: 'white', padding: '60px 0', borderTop: '1px solid #f0e6dc', borderBottom: '1px solid #f0e6dc' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
          <div style={{ textAlign: 'center', marginBottom: '40px' }}>
            <h2 style={{ fontSize: '32px', color: '#2c2418', marginBottom: '15px', fontWeight: 700, fontFamily: 'Playfair Display, serif' }}>دليل مقاسات التنانير والبلوزات التركية</h2>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'center', minWidth: '650px' }}>
              <thead>
                <tr style={{ background: 'linear-gradient(135deg, #ff5a00 0%, #e04e00 100%)', color: 'white' }}>
                  ...
                  <th style={{ padding: '15px', fontSize: '16px', fontWeight: 600 }}>طول التنورة (سم)</th>
                  <th style={{ padding: '15px', fontSize: '16px', fontWeight: 600 }}>طول البلوزة (سم)</th>
                 </tr>
              </thead>
              <tbody>
                {[
                  { size: 'XS / 34', chest: '80-84', waist: '62-66', hip: '86-90', skirtLen: '85-90', topLen: '60-65' },
                  { size: 'S / 36', chest: '84-88', waist: '66-70', hip: '90-94', skirtLen: '85-90', topLen: '60-65' },
                  { size: 'M / 38', chest: '88-92', waist: '70-74', hip: '94-98', skirtLen: '90-95', topLen: '62-67' },
                  { size: 'L / 40', chest: '92-96', waist: '74-78', hip: '98-102', skirtLen: '90-95', topLen: '62-67' },
                  { size: 'XL / 42', chest: '96-100', waist: '78-82', hip: '102-106', skirtLen: '95-100', topLen: '65-70' },
                  { size: '2XL / 44', chest: '100-104', waist: '82-86', hip: '106-110', skirtLen: '95-100', topLen: '65-70' },
                  { size: '3XL / 46', chest: '104-108', waist: '86-90', hip: '110-114', skirtLen: '100-105', topLen: '68-73' },
                  { size: '4XL / 48', chest: '108-112', waist: '90-94', hip: '114-118', skirtLen: '100-105', topLen: '68-73' },
                ].map((row, index) => (
                  <tr key={row.size} style={{ background: index % 2 === 0 ? '#fef9f2' : 'white', borderBottom: '1px solid #f0e6dc' }}>
                    ...
                    <td style={{ padding: '12px 15px', color: '#4a3a2a' }}>{row.skirtLen}</td>
          ...
          <div style={{ marginTop: '30px', padding: '20px', background: '#fef9f2', borderRadius: '16px', border: '1px solid #f0e6dc' }}>
            <h3 style={{ fontSize: '18px', color: '#2c2418', marginBottom: '15px', fontWeight: 600, display: 'flex', alignItems: 'center', gap: '10px' }}>
              ...
              نصائح لاختيار مقاس الطقم المناسب
            </h3>
            <ul style={{ color: '#5a4a3a', lineHeight: '1.8', paddingRight: '20px' }}>
              <li>✓ قم بقياس الصدر والخصر والورك بدقة لاختيار المقاس المناسب لك.</li>
              <li>✓ التنانير التركية عادة ما تكون عالية الخصر، لذا قم بقياس محيط خصرك الطبيعي.</li>
      ...
      <section style={{ background: '#fef9f2', padding: '60px 0', borderTop: '1px solid #f0e6dc' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
          <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            <h2 style={{ fontSize: '32px', color: '#2c2418', marginBottom: '20px', fontWeight: 700, textAlign: 'center', fontFamily: 'Playfair Display, serif' }}>أطقم تنانير وبلوزات محتشمة تركية بالجملة</h2>
            <p style={{ fontSize: '16px', color: '#5a4a3a', lineHeight: '1.8', marginBottom: '25px', textAlign: 'justify' }}>
              هجاب فاشن مول يقدم <strong>أطقم التنانير والبلوزات المحتشمة التركية بالجملة</strong> بتصاميم متناسقة وأنيقة. مجموعتنا تضم أكثر من <strong>{totalProducts} طقم</strong> يجمع بين التنانير الطويلة والبلوزات الأنيقة. تناسب هذه الأطقم العمل، الخروجات اليومية، والمناسبات الخاصة.
            </p>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '15px', marginBottom: '35px' }}>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>طقم تنورة مطاطية:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>مريحة وعملية للاستخدام اليومي</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>طقم تنورة بلسر:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>تصميم أنيق للمناسبات الخاصة</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>طقم تنورة كتان:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>خامات طبيعية مناسبة للأجواء الحارة</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>طقم تنورة شيفون:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>قوام انسيابي وأنيق للمناسبات</p></div>
            </div>
            <h3 style={{ fontSize: '24px', color: '#2c2418', margin: '35px 0 20px', fontWeight: 600 }}>مميزات أطقم التنانير والبلوزات التركية</h3>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '15px', marginBottom: '35px' }}>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>جودة عالية:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>أقمشة تركية فاخرة وخياطة متقنة</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>تناسق الألوان:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>أطقم متناسقة الألوان لتنسيق سهل</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>مرونة في الاستخدام:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>يمكن ارتداء كل قطعة بمفردها مع قطع أخرى</p></div>

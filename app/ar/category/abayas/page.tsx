// app/ar/category/abayas/page.tsx
'use client'
...
export default function AbayasCategoryPageAr() {
  ...
  return (
    <>
      <Head>
        <title>عبايات تركية بالجملة | مجموعة مميزة من حرير المدينة والكريبي والجيرسي | هجاب فاشن مول</title>
        <meta name="description" content={`اكتشفوا ${totalProducts}+ عبايات تركية بالجملة. حرير المدينة الفاخر، كريبي أنيق، جيرسي ناعم، دانتيل راقي. تصاميم عصرية، مقاسات حتى 4XL. شحن عالمي للمحترفين.`} />
        <meta name="keywords" content="عبايات تركية بالجملة, مستورد عبايات, عباية حرير المدينة, عباية كريبي, عباية جيرسي, عباية دانتيل, عباية مفتوحة, عباية مغلقة, عبايات مقاسات كبيرة, عبايات عصرية, عبايات أنيقة, أزياء محتشمة تركية, حجاب تركي, مجموعة عبايات 2026, عبايات مهنية, عبايات مناسبات, عبايات يومية, قماش تركي عالي الجودة, استيراد عبايات من تركيا, تاجر عبايات, بيع بالجملة عبايات" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://hijabfashionmall.com/ar/category/abayas" />
        ...
        <meta property="og:title" content="مجموعة عبايات تركية بالجملة - حرير المدينة والكريبي" />
        <meta property="og:description" content={`${totalProducts}+ موديل عبايات فاخرة. أقمشة استثنائية: حرير المدينة، كريبي منسدل، جيرسي. للمحترفين في الأزياء المحتشمة.`} />
        <meta property="og:url" content="https://hijabfashionmall.com/ar/category/abayas" />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://hijabfashionmall.com/images/og-abayas-ar.jpg" />
        <meta property="og:locale" content="ar_AR" />
      </Head>

      {/* Back to Top Button - positioned on right side opposite to WhatsApp button which is usually on left */}
      <button
        onClick={scrollToTop}
        style={{
          position: 'fixed',
      ...
      <section style={{
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px', position: 'relative', zIndex: 1 }}>
          <div style={{ fontSize: '14px', color: '#7a6a5a', marginBottom: '20px' }}>
            ...
            <span style={{ color: '#7a6a5a', margin: '0 8px' }}>/</span>
            <span style={{ color: '#7a6a5a' }}>العبايات</span>
          </div>
          <h1 style={{ 
            fontSize: '48px', 
            color: '#2c2418', 
          ...
          <p style={{ fontSize: '18px', color: '#5a4a3a', maxWidth: '800px', margin: '0 auto', lineHeight: '1.6' }}>
            اكتشفوا مجموعتنا من العبايات التركية بالجملة. قطع راقية من حرير المدينة، 
            كريبي منسدل، جيرسي ناعم ودانتيل دقيق لإثراء عروضكم المهنية.
          </p>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>كريبي وجيرسي</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{
                width: '44px',
          ...
          <main>
              ...
              <div style={{ display: 'flex', gap: '15px', alignItems: 'center', flexWrap: 'wrap' }}>
                ...
                <div style={{ position: 'relative' }}>
                  <input 
                    ref={searchInputRef}
                    type="text" 
                    placeholder="ابحث بالاسم، الرمز، القماش..."
            ...
            {products.length === 0 ? (
              <div style={{
                ...
                <h3 style={{ fontSize: '24px', color: '#2c2418', marginBottom: '10px', fontWeight: 600 }}>لم يتم العثور على عبايات</h3>
              ...
              <>
                {loading && products.length > 0 ? (
                  ...
                  <div style={{
                    ...
                    {products.map((p: any) => {
                      const message = p['rss/not rss message_ar'] || p['rss/not rss message_en'] || ''
                      const code = p.product_code || ''
                      const hasRSSInCode = code.toLowerCase().includes('rss')
                      const isRSS = message.includes('قطعة واحدة') || message.includes('✅') || hasRSSInCode
                      ...
                      if (fabric.includes('حرير') || fabric.includes('مدينة')) {
                      ...
                      } else if (fabric.includes('دانتيل')) {
                        fabricBadge = <span style={{
                          background: '#c98a60',
                          color: 'white',
                          padding: '4px 12px',
                        ...
                        >
                          <div style={{
                            ...
                            <img 
                              ...
                              alt={p.name_ar || p.name_en || p.name_ar || 'عباية تركية'}
                              style={{ 
                                maxWidth: '90%', 
                                maxHeight: '90%', 
                                objectFit: 'contain', 
                          ...
                          <div style={{ padding: '20px', textAlign: 'center' }}>
                            ...
                            {p.color_ar || p.color_en ? (
                              <div style={{ marginBottom: '12px' }}>
                                <div style={{ 
                                  width: '24px', 
                                  height: '24px', 
                                  borderRadius: '50%', 
                                  background: getColorCode(p.color_en || p.color_ar || ''),
                                  margin: '0 auto',
                                  border: '2px solid #fff',
                                  boxShadow: '0 2px 5px rgba(0,0,0,0.1)'
                                }} title={p.color_ar || p.color_en} />
                              </div>
                            ) : null}
      ...
      {/* Size Chart Section - Standard International Sizes for Turkish Abayas */}
      <section style={{
        background: 'white',
        padding: '60px 0',
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
          <div style={{ textAlign: 'center', marginBottom: '40px' }}>
            <h2 style={{
              ...
              دليل المقاسات العالمي للعبايات التركية
            </h2>
            <p style={{ fontSize: '16px', color: '#5a4a3a', maxWidth: '700px', margin: '0 auto' }}>
              المقاسات التالية هي المقاسات القياسية المعتمدة في المصانع التركية. قد تختلف المقاسات قليلاً حسب الموديل ونوع القماش.
            </p>
          </div>
            ...
            <table style={{
              ...
              <thead>
                <tr style={{
                  ...
                  <th style={{ padding: '15px', fontSize: '16px', fontWeight: 600, borderBottom: 'none' }}>المقاس</th>
                  <th style={{ padding: '15px', fontSize: '16px', fontWeight: 600, borderBottom: 'none' }}>الصدر (سم)</th>
                  <th style={{ padding: '15px', fontSize: '16px', fontWeight: 600, borderBottom: 'none' }}>الخصر (سم)</th>
                  <th style={{ padding: '15px', fontSize: '16px', fontWeight: 600, borderBottom: 'none' }}>الورك (سم)</th>
                  <th style={{ padding: '15px', fontSize: '16px', fontWeight: 600, borderBottom: 'none' }}>طول العباية (سم)</th>
                  <th style={{ padding: '15px', fontSize: '16px', fontWeight: 600, borderBottom: 'none' }}>الطول المناسب (سم)</th>
                </tr>
              </thead>
              <tbody>
                {[
                  { size: 'XS / 34', chest: '80-84', waist: '62-66', hip: '86-90', length: '135-140', height: '150-158' },
                  { size: 'S / 36', chest: '84-88', waist: '66-70', hip: '90-94', length: '135-140', height: '158-162' },
                  { size: 'M / 38', chest: '88-92', waist: '70-74', hip: '94-98', length: '140-145', height: '162-166' },
                  { size: 'L / 40', chest: '92-96', waist: '74-78', hip: '98-102', length: '140-145', height: '166-170' },
                  { size: 'XL / 42', chest: '96-100', waist: '78-82', hip: '102-106', length: '145-150', height: '170-174' },
                  { size: '2XL / 44', chest: '100-104', waist: '82-86', hip: '106-110', length: '145-150', height: '174-178' },
                  { size: '3XL / 46', chest: '104-108', waist: '86-90', hip: '110-114', length: '150-155', height: '178-182' },
                  { size: '4XL / 48', chest: '108-112', waist: '90-94', hip: '114-118', length: '150-155', height: '182-186' },
                ].map((row, index) => (
                  <tr key={row.size} style={{
                    background: index % 2 === 0 ? '#fef9f2' : 'white',
                    borderBottom: '1px solid #f0e6dc'
                  }}>
                    ...
                    <td style={{ padding: '12px 15px', color: '#4a3a2a' }}>{row.height}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <div style={{
            ...
            <ul style={{ color: '#5a4a3a', lineHeight: '1.8', paddingRight: '20px' }}>
              <li>✓ قم بقياس صدرك وخصرك ووركك بدقة باستخدام شريط القياس للحصول على المقاس الأنسب.</li>
              <li>✓ إذا كنت بين مقاسين، ننصح باختيار المقاس الأكبر للحصول على راحة أفضل خاصة في الأقمشة غير المطاطية.</li>
              <li>✓ الأقمشة المطاطية مثل الجيرسي تعطي مرونة أكبر في المقاس.</li>
              <li>✓ العبايات التركية عادة ما تكون مصممة بطول يتراوح بين 135-155 سم حسب الموديل والماركة.</li>
              <li>✓ للمناسبات الخاصة مثل الأعراس، يمكن اختيار مقاس أكبر للحصول على إطلالة أكثر انسيابية.</li>
              <li>✓ للاستخدام اليومي، اختاري المقاس المريح الذي يسمح بالحركة بسهولة.</li>
            </ul>
          </div>
        </div>
      </section>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
          <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            <h2 style={{
              ...
              مجموعة كاملة من العبايات التركية بالجملة
            </h2>
            <p style={{
              fontSize: '16px',
              color: '#5a4a3a',
              ...
              مرحباً بكم في هجاب فاشن مول، <strong>موردكم الموثوق للعبايات التركية بالجملة</strong> منذ 2019. 
              مجموعتنا بالجملة تضم أكثر من <strong>{totalProducts} موديل عباية</strong> مناسبة لمتطلبات تجار التجزئة والمتاجر الإلكترونية 
              ومحترفي الأزياء المحتشمة. نختار بعناية أقمشة استثنائية: <strong>حرير المدينة المنسدل، كريبي أنيق، جيرسي ناعم ودانتيل راقي</strong>. 
              كل قطعة مصنوعة في مشاغل تركية متخصصة، تجمع بين التقاليد والحداثة.
            </p>
            ...
            <h3 style={{
              ...
              أنواع العبايات المتاحة للشراء بالجملة
            </h3>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
                ...
                <span style={{ color: '#4a3a2a' }}><strong>عباية حرير المدينة</strong> – قماش فاخر، سقوط ناعم، مثالي للمناسبات الخاصة</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
                </svg>
                <span style={{ color: '#4a3a2a' }}><strong>عباية كريبي</strong> – قماش مقاوم، لا يتجعد، مثالي للاستخدام اليومي</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
                </svg>
                <span style={{ color: '#4a3a2a' }}><strong>عباية جيرسي</strong> – قماش مطاطي، مريح، قصّة ملائمة</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
                </svg>
                <span style={{ color: '#4a3a2a' }}><strong>عباية دانتيل</strong> – تفاصيل دقيقة، مثالية للأعراس والمناسبات</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
                </svg>
                <span style={{ color: '#4a3a2a' }}><strong>عباية مفتوحة (كيمونو)</strong> – طبقات أنيقة، ترتدي فوق الملابس</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
                </svg>
                <span style={{ color: '#4a3a2a' }}><strong>عباية مغلقة</strong> – موديل كلاسيكي، تغطية كاملة</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
                </svg>
                <span style={{ color: '#4a3a2a' }}><strong>عباية فراشة</strong> – أكمام واسعة، قوام منسدل</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
                </svg>
                <span style={{ color: '#4a3a2a' }}><strong>عباية مقاسات كبيرة</strong> – مقاسات حتى 4XL (زائد المقاسات)</span>
              </div>
            </div>
            ...
            <h3 style={{
              ...
              المواصفات الفنية للعبايات التركية
            </h3>
            ...
            <div style={{
              ...
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <span style={{ fontWeight: 700, color: '#ff5a00' }}>تركيبة الأقمشة:</span>
                <p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>حرير المدينة 100% بوليستر فاخر، كريبي جورجيت، جيرسي فيسكوز، دانتيل فرنسي</p>
              </div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <span style={{ fontWeight: 700, color: '#ff5a00' }}>المقاسات المتوفرة:</span>
                <p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>S, M, L, XL, 2XL, 3XL, 4XL (حسب الموديلات)</p>
              </div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <span style={{ fontWeight: 700, color: '#ff5a00' }}>الألوان:</span>
                <p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>أسود، أبيض، بيج، كحلي، بورجوندي، أخضر زيتوني، رمادي، تاووب، وردي غبار، أزرق سماوي</p>
              </div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <span style={{ fontWeight: 700, color: '#ff5a00' }}>الطول:</span>
                <p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>135 سم إلى 155 سم حسب الموديلات (مقاس قياسي)</p>
              </div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <span style={{ fontWeight: 700, color: '#ff5a00' }}>العناية:</span>
                <p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>غسيل في الغسالة 30°C، تجفيف في الظل، كي بدرجة حرارة متوسطة</p>
              </div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <span style={{ fontWeight: 700, color: '#ff5a00' }}>التغليف:</span>
                <p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>قطعة واحدة أو حزمة كاملة (6/12 قطعة) حسب الموديلات</p>
              </div>
            </div>
            ...
            <h3 style={{
              ...
              مزايا العبايات التركية للمحترفين
            </h3>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                ...
                <span style={{ color: '#4a3a2a' }}>أقمشة عالية الجودة (معتمدة OEKO-TEX)</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
                </svg>
                <span style={{ color: '#4a3a2a' }}>تصاميم عصرية ومواكبة للموضة</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
                </svg>
                <span style={{ color: '#4a3a2a' }}>أسعار تنافسية لتجار التجزئة</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
                </svg>
                <span style={{ color: '#4a3a2a' }}>تشكيلة واسعة من الألوان المحايدة والعصرية</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
                </svg>
                <span style={{ color: '#4a3a2a' }}>إمكانية التخصيص (علامة تجارية خاصة)</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
                </svg>
                <span style={{ color: '#4a3a2a' }}>شحن سريع لأكثر من 50 دولة</span>
              </div>
            </div>
            ...
            <p style={{
              ...
              <strong>العبايات التركية</strong> معترف بها عالمياً لجودة تنفيذها، وغنى خاماتها، وعصرية قصّاتها. سواء كنتم تبحثون عن موديلات كلاسيكية سوداء، أو عبايات ملونة لفصل الربيع والصيف، أو قطع مطرزة للمناسبات الخاصة (الأعراس، رمضان، العيد)، فإن مجموعتنا بالجملة تلبي احتياجات التجار المميزين. نقدم أيضاً <strong>عبايات مقاسات كبيرة (زائد المقاسات)</strong> حتى 4XL، مما يتيح توسيع قاعدة عملائكم. تصفّحوا تشكيلتنا وأثروا عروضكم من الأزياء المحتشمة بعبايات تركية استثنائية. للطلبات بالجملة أو الاستفسارات، تواصلوا مع فريقنا عبر واتساب أو تيليغرام. شحن عالمي مضمون مع تتبع الطرود.
            </p>
          </div>
        </div>
      </section>

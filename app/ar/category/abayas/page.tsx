...
export default function AbayasCategoryPage() {
  ...
  const PAGE_CONFIG = {
    category: "عبايات",
    categoryName: "عبايات",
    pageTitle: "عبايات تركية بالجملة | تشكيلة واسعة من العبايات العصرية والمحتشمة | حجاب فاشون مول",
    pageDescription: "تسوق أفضل العبايات التركية بالجملة. تشكيلة واسعة من العبايات العصرية والتقليدية، عبايات سهرة، عبايات صيفية وشتوية. بدون حد أدنى للطلب، شحن عالمي سريع.",
    pageKeywords: "عبايات تركية بالجملة, عبايات عصرية, عبايات محتشمة, عبايات سهرة, عبايات صيفية, عبايات شتوية, عبايات مطرزة, عبايات فخمة, مشالح تركية",
    h1: "عبايات تركية بالجملة – فخامة وأناقة عصرية",
    subtitle: "اكتشفي مجموعتنا الرائعة من العبايات التركية الأصلية. من العبايات العصرية المطرزة إلى العبايات التقليدية الأنيقة، ستجدين التشكيلة المثالية لمتجرك بأسعار الجملة.",
    seoContent: {
      h2: "عبايات تركية بالجملة – فخامة وتصاميم عصرية",
      p1: "مرحباً بك في حجاب فاشون مول، مصدرك الأول للعبايات التركية الأصلية. تشكيلتنا تضم عبايات بمختلف التصاميم والألوان والأقمشة. من العبايات المطرزة الفاخرة إلى العبايات اليومية العملية، نوفر عبايات تناسب جميع الأذواق والمناسبات.",
      features: [
        "صناعة تركية 100% أصلية",
        "أقمشة فاخرة: كريب، جيرسي، نسيج، مخمل، شيفون",
        "مقاسات متعددة (XS إلى 4XL)",
        "تشكيلة واسعة من الألوان والتصاميم",
        "خيارات متنوعة: عبايات مطرزة، عبايات سادة، عبايات بقصات عصرية",
        "بدون حد أدنى للطلب",
        "شحن سريع عالمي (3-7 أيام)",
        "طرق دفع آمنة"
      ],
      popularStyles: "عبايات مطرزة، عبايات سادة، عبايات بقصات عصرية، عبايات سهرة، عبايات صيفية، عبايات شتوية، عبايات بكلف، عبايات بجيوب، مشالح تركية فخمة."
    }
  }
    ...
    <>
          ...
          <div className="stats-container">
            <div className="stats-info">
              <div className="stat-item">
                ...
                <span><strong>{totalProducts}</strong> عباية</span>
              </div>
              <div className="stat-item">
      ...
      <section className="products-section">
        <div className="container">
          <div className="products-header">
            <h2>تشكيلة <span>عبايات تركية</span></h2>
            ...
            <>
              <div className="products-grid">
                {products.map((product: any) => {
                  const name = product.name_ar || product.name_en || 'عباية'
      ...
      <section className="seo-content">
        <div className="container">
          ...
          <p>انضمي إلى أكثر من 5000+ تاجر تجزئة حول العالم يثقون بنا في مجموعات العبايات. من البوتيكات الصغيرة إلى كبار تجار التجزئة، نقدم جودة ثابتة وخدمة موثوقة. تصفحي مجموعتنا وقدمي استفسارك اليوم!</p>
          
          <p><strong>أنماط العبايات الشائعة:</strong> {PAGE_CONFIG.seoContent.popularStyles}</p>
        </div>
      </section>
    </>
  )

...
export default function AboutPageAr() {
  ...
  return (
    <>
      <Head>
        <title>من نحن - حجاب فاشون مول | جملة الأزياء التركية</title>
        <meta name="description" content="منذ عام 2019، حجاب فاشون مول يربط تجار التجزئة حول العالم بملابس الحجاب التركية الأصيلة. لا حد أدنى للطلب، شحن عالمي، أكثر من 5000 منتج." />
        <meta name="keywords" content="جملة حجاب تركي, أزياء تركية, مورد حجاب إسطنبول" />
        <link rel="canonical" href="https://hijabfashionmall.com/ar/about-us" />
      </Head>
      ...
      <div dir="rtl">
        ...
        <section className="page-header">
          <div className="container">
            <h1>عن حجاب فاشون مول</h1>
            <p>شريكك الموثوق لملابس الحجاب التركية الفاخرة منذ عام 2019. نربط تجار التجزئة حول العالم بالأزياء التركية الأصيلة.</p>
          </div>
        </section>
        ...
        <section className="about-section">
          <div className="container">
            <div className="about-content-full">
              <h2>من نحن</h2>
              <p>حجاب فاشون مول هي شركة جملة تركية مقرها في إسطنبول، متخصصة في ملابس الحجاب الفاخرة والأزياء التركية. منذ تأسيسنا في عام 2019، ونحن ملتزمون بمساعدة تجار التجزئة والمتاجر حول العالم في الحصول على منتجات تركية أصلية من أفضل المصنعين.</p>
              
              <p>نعمل مع أفضل المصنعين الأتراك لنقدم لك منتجات عالية الجودة بأسعار تنافسية، مع التركيز على راحة عملائنا وضمان حصولهم على أفضل قيمة مقابل أموالهم.</p>
              
              <div className="about-highlight">
                <p><FaQuoteRight /> "نحن لا نبيع المنتجات فقط؛ بل نبني شراكات طويلة الأمد مع عملائنا. نجاحكم هو نجاحنا."</p>
              </div>
              
              <p>مع أكثر من 5000 منتج في 9 فئات، نقدم كل شيء من العبايات الأنيقة إلى الملابس الرياضية العصرية، وكلها مصنوعة في تركيا بأفضل المواد والحرفية.</p>
            </div>
          </div>
        </section>
          ...
          <div className="container">
            <div className="stats-grid">
              ...
              <div className="stat-card">
                ...
                <div className="stat-label">تأسست</div>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="container">
            ...
            <div className="services-grid">
              <div className="service-card">
                ...
                <h3>خلط طلبك</h3>
                <p>اجمع منتجات مختلفة في شحنة واحدة. اطلب ما تحتاجه بالضبط من فئات متعددة.</p>
              </div>
              <div className="service-card">
                <div className="service-icon"><FaBan /></div>
                <h3>لا حد أدنى للطلب</h3>
                <p>ابدأ بأي كمية. مثالي للمتاجر الصغيرة وتجار التجزئة الكبار على حد سواء.</p>
              </div>
              <div className="service-card">
                <div className="service-icon"><FaCertificate /></div>
                <h3>صنع في تركيا 100% أصلي</h3>
              ...
              <div className="service-card">
                ...
                <h3>شحن عالمي</h3>
                <p>توصيل سريع إلى أكثر من 50 دولة عبر شركات شحن موثوقة مع توفير إمكانية التتبع.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mission-section">
          <div className="container">
            <div className="mission-content">
              <h2>مهمتنا</h2>
              <p>جعل الأزياء التركية الفاخرة في متناول تجار التجزئة حول العالم، دون تعقيدات التوريد الدولية. نحن هنا لنكون شريكك الموثوق، ونضمن الجودة والموثوقية والنجاح لعملك.</p>
            </div>
          </div>
        </section>
      ...
      <style>{`
        ...
        .about-highlight { background: #f5f5f5; padding: 30px; border-radius: 15px; margin: 30px 0; border-right: 4px solid #ff5a00; text-align: center; }

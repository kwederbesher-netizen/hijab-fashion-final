...
export default function HomePageEs() {
  ...
  const slides = [
    {
      ...
      description: 'Descubre nuestra exclusiva colección de Abayas, Vestidos y Moda Modesta',
      cta: { text: 'Comprar Ahora', link: '/es/catalog' }
    },
    {
      image: '/images/hero-slider-2.webp',
      title: 'Precios al por Mayor',
      description: 'Mejores precios para minoristas y tiendas de todo el mundo',
      cta: { text: 'Ver Catálogo', link: '/es/catalog' }
    },
    {
      image: '/images/hero-slider-3.webp',
      title: 'Envío Rápido Mundial',
      description: 'Entrega a más de 50 países con transportistas fiables',
      cta: { text: 'Comprar Ahora', link: '/es/catalog' }
    }
  ]
  ...
  const getProductUrl = useCallback((product: any) => {
    ...
    else if (product.slug_ar) return `/es/product/${product.slug_ar}`
    else return `/es/product/${product._id || 'product'}`
  }, [])

  return (
    <>
      <Head>
        <title>Hijab Fashion Mall | Mayorista Hijab Turco - Moda Modesta de Turquía</title>
        <meta name="description" content="Mayorista hijab turco premium desde 2019. 5000+ productos: Abayas, Vestidos Modestos, Sets, Ropa Deportiva. Sin pedido mínimo, envío mundial, soporte 24/7." />
        <meta name="keywords" content="mayorista hijab turco, moda modesta al por mayor, hijab al por mayor" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://hijabfashionmall.com/es" />
      </Head>
      ...
      <main id="main-content">
        ...
        <section className="hero-slider" style={{ position: 'relative', width: '100%', overflow: 'hidden', height: 'auto', maxHeight: '600px' }}>
          <div style={{ position: 'relative', width: '100%' }}>
            ...
            <div className="hero-dots" style={{ position: 'absolute', bottom: '25px', left: '50%', transform: 'translateX(-50%)', display: 'flex', gap: '12px', zIndex: 3 }}>
              {slides.map((_, index) => (
                <button key={index} onClick={() => setCurrentSlide(index)} style={{ width: '12px', height: '12px', borderRadius: '50%', background: currentSlide === index ? '#ff5a00' : 'rgba(255,255,255,0.6)', border: 'none', cursor: 'pointer', padding: 0, transition: 'all 0.3s' }} aria-label={`Ir a la diapositiva ${index + 1}`} />
              ))}
            </div>
          </div>
        </section>
        ...
        <section className="ranked-section">
          <div className="container">
            <span className="badge">🏆 Líder Global</span>
            <h3>Estamos clasificados #1 en Google para:</h3>
            <div className="ranked-horizontal">
              <div className="ranked-h-item"><span className="simple-icon" style={{ color: '#ff5a00' }}>👗</span><span><strong>Mayorista Moda Modesta</strong> #1</span></div>
              <div className="ranked-h-item"><span className="simple-icon" style={{ color: '#4facfe' }}>🧕</span><span><strong>Mayorista Moda Hijab</strong> #1</span></div>
              <div className="ranked-h-item"><span className="simple-icon" style={{ color: '#f093fb' }}>👚</span><span><strong>Mayorista Conjuntos Modestos</strong> #1</span></div>
            </div>
            <Link href="/es/why-were-number-one" className="ranked-btn">Vea por qué somos #1 →</Link>
          </div>
        </section>

        <section className="channels-section">
          <div className="container">
            <h2 className="section-title">Únete a Nuestros Canales</h2>
            <p className="section-subtitle">Síguenos en WhatsApp y Telegram para las últimas actualizaciones y ofertas exclusivas</p>
            <div className="channels-grid">
              <div className="channel-card whatsapp-card">
                <div className="channel-icon"><FaWhatsapp size={40} /></div>
                <h3>Canal de WhatsApp</h3>
                <p>Únete a nuestro canal de WhatsApp para novedades diarias, descuentos especiales y acceso anticipado a colecciones.</p>
                <div className="channel-stats"><span><FaUsers size={14} /> 1.500+ miembros</span><span><FaImage size={14} /> Actualizaciones diarias</span></div>
                <a href="https://whatsapp.com/channel/0029VatIrfWId7nGgsYAFQ1G" className="channel-btn whatsapp-btn" target="_blank" rel="noopener noreferrer"><FaWhatsapp size={18} /> Unirse a WhatsApp</a>
              </div>
              <div className="channel-card telegram-card">
                <div className="channel-icon"><FaTelegramPlane size={40} /></div>
                <h3>Canal de Telegram</h3>
                <p>Únete a nuestro canal de Telegram para contenido exclusivo, consejos de estilo y ofertas especiales.</p>
                <div className="channel-stats"><span><FaUsers size={14} /> 11.000+ miembros</span><span><FaVideo size={14} /> Tutoriales en video</span></div>
                <a href="https://t.me/hijabfashionmall" className="channel-btn telegram-btn" target="_blank" rel="noopener noreferrer"><FaTelegramPlane size={18} /> Unirse a Telegram</a>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="features-section">
          <div className="container">
            ...
            <p className="section-subtitle">Tu satisfacción es nuestra prioridad</p>
            <div className="features-grid">
              <div className="feature-card"><div className="feature-icon"><Image src="/images/mix-icon.webp" alt="Mezclar productos" width={100} height={100} loading="lazy" /></div><h3>Mezcla y Combina</h3><p>Todas tus colecciones en un solo pedido. Pide la cantidad que desees al costo adecuado.</p></div>
              <div className="feature-card"><div className="feature-icon"><Image src="/images/no-minimum-icon.webp" alt="Sin pedido mínimo" width={100} height={100} loading="lazy" /></div><h3>Sin Mínimo</h3><p>Sin cantidad mínima de pedido gracias a nuestro servicio de consolidación. Pide lo que necesitas.</p></div>
              <div className="feature-card"><div className="feature-icon"><Image src="/images/original-icon.webp" alt="100% original turco" width={100} height={100} loading="lazy" /></div><h3>100% Original Turco</h3><p>No vendemos imitaciones. Solo auténtica calidad turca.</p></div>
              <div className="feature-card"><div className="feature-icon"><Image src="/images/service-icon.webp" alt="Soporte 24/7" width={100} height={100} loading="lazy" /></div><h3>Soporte 24/7</h3><p>Servicio al cliente a tu disposición para ayudar con pedidos y brindar asistencia personalizada.</p></div>
            </div>
          </div>
        </section>
        ...
        <section className="privatelabel-section">
          <div className="container">
            <div className="privatelabel-wrapper">
              <div className="privatelabel-image"><Image src="/images/private-label.webp" alt="Servicio de marca privada" width={800} height={800} loading="lazy" /></div>
              <div className="privatelabel-content">
                <span className="privatelabel-badge">Servicio Premium</span>
                <h2 className="privatelabel-title">Tu Marca,<br />Tu Identidad</h2>
                <p className="privatelabel-description">Ofrece a tus clientes diseños exclusivos con nuestro <strong>servicio de marca privada</strong>. Personalizamos productos con tu logo, empaque y especificaciones para pedidos regulares.</p>
                <ul className="privatelabel-features"><li><FaCheckCircle /> Empaque personalizado con tu logo</li><li><FaCheckCircle /> Diseños exclusivos para tu marca</li><li><FaCheckCircle /> Mínimo flexible para pedidos regulares</li><li><FaCheckCircle /> Control de calidad y envío rápido</li></ul>
                <div style={{ display: 'flex', gap: '15px', flexWrap: 'wrap' }}>
                  <Link href="/es/private-label-service" className="privatelabel-btn" style={{ background: 'transparent', color: 'var(--primary)', border: '2px solid var(--primary)', boxShadow: 'none' }}><FaNewspaper /> Leer Guía</Link>
                  <a href="https://wa.me/905519522448?text=Hola%2C%20estoy%20interesado%20en%20su%20servicio%20de%20marca%20privada" className="privatelabel-btn" target="_blank" rel="noopener noreferrer"><FaWhatsapp /> Consultar</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="categories-section">
          <div className="container">
            <h2 className="section-title">Explora Nuestras Colecciones</h2>
            <p className="section-subtitle">Encuentra el estilo perfecto para cada ocasión</p>
            <div className="categories-grid">
              <Link href="/es/category/abayas" className="category-card"><Image src="/images/category-abayas.webp" alt="Abayas" width={600} height={800} loading="lazy" /><div className="category-info"><h3>Abayas</h3><p>Seda de Medina, crepé y más</p></div></Link>
              <Link href="/es/category/modest-dresses" className="category-card"><Image src="/images/category-dresses.webp" alt="Vestidos modestos" width={600} height={800} loading="lazy" /><div className="category-info"><h3>Vestidos Modestos</h3><p>Casual y formal</p></div></Link>
              <Link href="/es/category/modest-skirt-sets" className="category-card"><Image src="/images/category-skirt-sets.webp" alt="Conjuntos de falda" width={600} height={800} loading="lazy" /><div className="category-info"><h3>Conjuntos de Falda</h3><p>Conjuntos de 2 piezas con falda</p></div></Link>
              <Link href="/es/category/modest-evening-dresses" className="category-card"><Image src="/images/category-evening-dresses.webp" alt="Vestidos de noche" width={600} height={800} loading="lazy" /><div className="category-info"><h3>Vestidos de Noche</h3><p>Para ocasiones especiales</p></div></Link>
              <Link href="/es/category/modest-pants-sets" className="category-card"><Image src="/images/178.webp" alt="Conjuntos de pantalón" width={600} height={800} loading="lazy" /><div className="category-info"><h3>Conjuntos de Pantalón</h3><p>Conjuntos de 2 piezas con pantalón</p></div></Link>
              <Link href="/es/category/hijabs" className="category-card"><Image src="/images/category-hijabs.webp" alt="Hiyabs" width={600} height={800} loading="lazy" /><div className="category-info"><h3>Hiyabs</h3><p>Seda, gasa, algodón</p></div></Link>
              <Link href="/es/category/prayer-clothes" className="category-card"><Image src="/images/53.webp" alt="Ropa de oración" width={600} height={800} loading="lazy" /><div className="category-info"><h3>Ropa de Oración</h3><p>Conjuntos y vestidos para oración</p></div></Link>
              <Link href="/es/category/modest-sportswear" className="category-card"><Image src="/images/category-sportswear.webp" alt="Ropa deportiva" width={600} height={800} loading="lazy" /><div className="category-info"><h3>Ropa Deportiva</h3><p>Para actividades y deportes</p></div></Link>
              <Link href="/es/category/burkini" className="category-card"><Image src="/images/category-swimwear.webp" alt="Burkini" width={600} height={800} loading="lazy" /><div className="category-info"><h3>Burkini</h3><p>Ropa de baño modesta</p></div></Link>
            </div>
          </div>
        </section>
        ...
        <section className="products-section">
          <div className="container">
            ...
            <p className="section-subtitle">Explora nuestras últimas novedades</p>
            {loading ? (<div style={{ textAlign: 'center', padding: '60px', fontSize: '18px', color: '#555' }}>Cargando productos...</div>) : products.length === 0 ? (<div style={{ textAlign: 'center', padding: '60px', fontSize: '18px', color: '#555' }}>No se encontraron productos</div>) : (
              <>
                <div className="products-grid">
                  {products.slice(0, 8).map((product: any) => {
                    const productName = product.name_en || product.name_ar || 'Producto';
                    ...
                    return (
                      <Link href={productUrl} key={product._id} className="product-card" style={{ textDecoration: 'none', color: 'inherit' }}>
                        ...
                        <div className="product-info"><h3>{productName}</h3><div className="product-price">{formatPrice(productPrice)}</div><button className="add-to-cart" onClick={(e) => addToCart(product, e)}><FaShoppingCart /> Agregar</button></div>
                      </Link>
                    );
                  })}
                </div>
                <div className="view-all-container"><Link href="/es/catalog" className="btn-view-all">Ver Todos</Link></div>
              </>
            )}
          </div>
        </section>
        ...
        <section className="faq-section">
          <div className="container">
            ...
            <p className="section-subtitle">Encuentra respuestas a preguntas comunes sobre nuestros servicios</p>
            <div className="faq-grid-cards">
              <div className="faq-card"><div className="faq-card-icon"><FaStore size={36} /></div><h3>¿Quiénes somos?</h3><p>Hijab Fashion Mall es el principal mercado turco que conecta mayoristas con minoristas de moda modesta en todo el mundo.</p></div>
              <div className="faq-card"><div className="faq-card-icon"><FaShoppingCart size={36} /></div><h3>¿Cómo pedir?</h3><p>Explora el catálogo, selecciona productos, agrega al carrito de consulta y envía por WhatsApp. Nuestro equipo confirmará en 24 horas.</p></div>
              <div className="faq-card"><div className="faq-card-icon"><FaGlobe size={36} /></div><h3>¿Envían a todo el mundo?</h3><p>¡Sí! Enviamos a más de 50 países con transportistas confiables. Entrega rápida puerta a puerta con número de seguimiento.</p></div>
              <div className="faq-card"><div className="faq-card-icon"><FaCreditCard size={36} /></div><h3>¿Métodos de pago?</h3><p>Aceptamos transferencia bancaria, Western Union y tarjetas de crédito principales.</p></div>
              <div className="faq-card"><div className="faq-card-icon"><FaBoxes size={36} /></div><h3>¿Pedido mínimo?</h3><p>¡Sin cantidad mínima! Pide lo que necesites.</p></div>
              <div className="faq-card"><div className="faq-card-icon"><FaTruck size={36} /></div><h3>¿Seguimiento de pedido?</h3><p>Una vez enviado, recibirás el nombre del transportista y el número de seguimiento.</p></div>
            </div>
          </div>
        </section>
        ...
        <section className="blogs-section">
          <div className="container">
            <h2 className="section-title">Blogs Útiles</h2>
            <p className="section-subtitle">Guías prácticas para ayudarte a tomar decisiones comerciales informadas.</p>
            <div className="blogs-grid">
              <div className="blog-card"><div className="blog-image"><Image src="/images/blog-1.webp" alt="Guía tienda online" width={400} height={225} loading="lazy" /></div><div className="blog-content"><span className="blog-category">Guía de Compra</span><h3>Tienda en Línea</h3><p>Cómo crear una tienda en línea exitosa para vender moda modesta.</p><Link href="/es/online-store-guide" className="blog-link">Leer más →</Link></div></div>
              <div className="blog-card"><div className="blog-image"><Image src="/images/blog-2.webp" alt="Guía tienda física" width={400} height={225} loading="lazy" /></div><div className="blog-content"><span className="blog-category">Guía de Compra</span><h3>Tienda Física</h3><p>Cómo iniciar una boutique de moda modesta en 2026: Importando desde Turquía.</p><Link href="/es/physical-store-guide" className="blog-link">Leer más →</Link></div></div>
              <div className="blog-card"><div className="blog-image"><Image src="/images/blog-3.webp" alt="Tendencias de moda" width={400} height={225} loading="lazy" /></div><div className="blog-content"><span className="blog-category">Guía de Mercado</span><h3>Tendencias de Moda</h3><p>Adoptando estilos hijab en Europa: Tendencias y oportunidades para minoristas.</p><Link href="/es/modest-fashion-trends" className="blog-link">Leer más →</Link></div></div>
            </div>
          </div>
        </section>

        <a href="https://wa.me/905519522448?text=Hola%2C%20tengo%20una%20pregunta" className="whatsapp-float" target="_blank" rel="noopener noreferrer" style={{ position: 'fixed', bottom: '30px', left: '30px', background: '#25d366', color: 'white', width: '50px', height: '50px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '30px', boxShadow: '0 4px 20px rgba(37,211,102,0.3)', zIndex: 999, transition: 'all 0.3s', textDecoration: 'none' }} onMouseEnter={(e) => { e.currentTarget.style.background = '#128C7E'; e.currentTarget.style.transform = 'scale(1.05)' }} onMouseLeave={(e) => { e.currentTarget.style.background = '#25d366'; e.currentTarget.style.transform = 'scale(1)' }}><FaWhatsapp size={28} /></a>

        <button onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} style={{ position: 'fixed', bottom: '30px', right: '30px', width: '50px', height: '50px', borderRadius: '50%', background: '#ff5a00', color: 'white', border: 'none', cursor: 'pointer', display: showBackToTop ? 'flex' : 'none', alignItems: 'center', justifyContent: 'center', fontSize: '24px', boxShadow: '0 4px 15px rgba(255,90,0,0.3)', zIndex: 999, transition: 'all 0.3s' }} onMouseEnter={(e) => { e.currentTarget.style.background = '#e04e00'; e.currentTarget.style.transform = 'translateY(-2px)' }} onMouseLeave={(e) => { e.currentTarget.style.background = '#ff5a00'; e.currentTarget.style.transform = 'translateY(0)' }} aria-label="Volver arriba"><FaArrowUp /></button>
      </main>
    </>
  )
}
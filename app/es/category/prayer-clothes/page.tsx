// app/es/category/prayer-clothes/page.tsx
'use client'
...
export default function PrayerClothesCategoryPageEs() {
  ...
  return (
    <>
      <Head>
        <title>Conjuntos de Oración Turcos al por Mayor | Ropa para Rezar | Hijab Fashion Mall</title>
        <meta name="description" content={`Descubre ${totalProducts}+ conjuntos de oración turcos al por mayor. Khimar largo + falda amplia. Telas suaves de algodón y modal. Colores neutros, tallas hasta 4XL.`} />
        <meta name="keywords" content="conjuntos de oración turcos, ropa para rezar, khimar largo, falda de oración, conjunto de namaz, prendas para rezar al por mayor, moda islámica práctica, ropa cómoda para oración" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://hijabfashionmall.com/es/category/prayer-clothes" />
        ...
        <link rel="alternate" href="https://hijabfashionmall.com/es/category/prayer-clothes" hrefLang="es" />
        <meta property="og:title" content="Conjuntos de Oración Turcos al por Mayor" />
        <meta property="og:description" content={`${totalProducts}+ conjuntos de khimar y falda.`} />
        ...
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(0,0,0,0.7)', zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }} onClick={() => setShowSizeChart(false)}>
          <div style={{ background: 'white', borderRadius: '24px', maxWidth: '650px', width: '100%', padding: '30px' }} onClick={(e) => e.stopPropagation()}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
              <h3 style={{ fontSize: '24px', color: '#2c2418', fontFamily: 'Playfair Display, serif' }}>📏 Guía de Tallas - Ropa de Oración</h3>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '20px' }}>
              ...
              <tbody>
                <tr><td style={{ padding: '10px', textAlign: 'center', fontWeight: 600, color: '#ff5a00' }}>S</td><td style={{ textAlign: 'center' }}>84-88</td><td style={{ textAlign: 'center' }}>66-70</td><td style={{ textAlign: 'center' }}>90-94</td><td style={{ textAlign: 'center' }}>140-145</td></tr>
                <tr style={{ background: '#fef9f2' }}><td style={{ padding: '10px', textAlign: 'center', fontWeight: 600, color: '#ff5a00' }}>M</td><td style={{ textAlign: 'center' }}>88-92</td><td style={{ textAlign: 'center' }}>70-74</td><td style={{ textAlign: 'center' }}>94-98</td><td style={{ textAlign: 'center' }}>142-147</td></tr>
                <tr><td style={{ padding: '10px', textAlign: 'center', fontWeight: 600, color: '#ff5a00' }}>L</td><td style={{ textAlign: 'center' }}>92-96</td><td style={{ textAlign: 'center' }}>74-78</td><td style={{ textAlign: 'center' }}>98-102</td><td style={{ textAlign: 'center' }}>144-149</td></tr>
                <tr style={{ background: '#fef9f2' }}><td style={{ padding: '10px', textAlign: 'center', fontWeight: 600, color: '#ff5a00' }}>XL</td><td style={{ textAlign: 'center' }}>96-100</td><td style={{ textAlign: 'center' }}>78-82</td><td style={{ textAlign: 'center' }}>102-106</td><td style={{ textAlign: 'center' }}>146-151</td></tr>
                <tr><td style={{ padding: '10px', textAlign: 'center', fontWeight: 600, color: '#ff5a00' }}>2XL</td><td style={{ textAlign: 'center' }}>100-104</td><td style={{ textAlign: 'center' }}>82-86</td><td style={{ textAlign: 'center' }}>106-110</td><td style={{ textAlign: 'center' }}>148-153</td></tr>
                <tr style={{ background: '#fef9f2' }}><td style={{ padding: '10px', textAlign: 'center', fontWeight: 600, color: '#ff5a00' }}>3XL</td><td style={{ textAlign: 'center' }}>104-108</td><td style={{ textAlign: 'center' }}>86-90</td><td style={{ textAlign: 'center' }}>110-114</td><td style={{ textAlign: 'center' }}>150-155</td></tr>
                <tr><td style={{ padding: '10px', textAlign: 'center', fontWeight: 600, color: '#ff5a00' }}>4XL</td><td style={{ textAlign: 'center' }}>108-112</td><td style={{ textAlign: 'center' }}>90-94</td><td style={{ textAlign: 'center' }}>114-118</td><td style={{ textAlign: 'center' }}>152-157</td></tr>
              </tbody>
            </table>
            <p style={{ fontSize: '12px', color: '#a08c7a', textAlign: 'center' }}>Los conjuntos de oración suelen tener un corte amplio y cómodo. Los largos son aproximados.</p>
          </div>
        </div>
      )}
      ...
      <section style={{ background: 'linear-gradient(135deg, #fdf8f2 0%, #ffffff 100%)', padding: '60px 0 40px', textAlign: 'center', borderBottom: '1px solid #f0e6dc', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px', position: 'relative', zIndex: 1 }}>
          ...
          <p style={{ fontSize: '18px', color: '#5a4a3a', maxWidth: '800px', margin: '0 auto', lineHeight: '1.6' }}>Khimar largo con falda amplia o vestido. Telas suaves y cómodas para momentos de tranquilidad. Diseños prácticos y elegantes.</p>
                  ...
                  return (
                    <Link href={getProductUrl(p)} key={p._id} style={{ background: 'white', borderRadius: '16px', overflow: 'hidden', textDecoration: 'none', color: 'inherit', border: '1px solid #f0e6dc', transition: 'all 0.3s' }} onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-8px)'; e.currentTarget.style.boxShadow = '0 15px 30px rgba(255,90,0,0.12)'; e.currentTarget.style.borderColor = '#ff5a00'; }} onMouseLeave={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 5px 20px rgba(0,0,0,0.05)'; e.currentTarget.style.borderColor = '#f0e6dc'; }}>
                      <div style={{ position: 'relative', height: '280px', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, #fef9f2 0%, #faf5ed 100%)' }}>
                        <img src={p.imageUrl || '/images/default.webp'} alt={p.name_es || p.name_en || 'Conjunto de oración'} style={{ maxWidth: '90%', maxHeight: '90%', objectFit: 'contain' }} loading="lazy" onError={(e) => { (e.target as HTMLImageElement).src = '/images/default.webp' }} />
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
          <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '15px', marginBottom: '35px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ color: '#ff5a00' }}>✓</span><span><strong>Khimar + falda</strong> – El conjunto clásico de dos piezas</span></div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ color: '#ff5a00' }}>✓</span><span><strong>Vestido de oración</strong> – Pieza única, fácil de poner</span></div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ color: '#ff5a00' }}>✓</span><span><strong>Conjunto con pañuelo</strong> – Incluye hijab a juego</span></div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ color: '#ff5a00' }}>✓</span><span><strong>Khimar largo hasta los pies</strong> – Cobertura completa</span></div>
            </div>
            <h3 style={{ fontSize: '24px', color: '#2c2418', margin: '35px 0 20px', fontWeight: 600 }}>Características de los Conjuntos Turcos</h3>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '15px', marginBottom: '35px' }}>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>Tejidos:</span> Algodón, modal, poliéster suave, mezclas transpirables</div>
              ...
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>Colores:</span> Blanco, beige, crema, gris claro, negro, rosa empolvado</div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>Largo:</span> Khimar 70-80cm, Falda 100-110cm</div>
            </div>
            <p style={{ fontSize: '16px', color: '#5a4a3a', lineHeight: '1.8', textAlign: 'justify' }}>
              Los conjuntos de oración son productos de alta demanda, especialmente durante el mes de Ramadán. Ofrecemos precios competitivos para revendedores y la posibilidad de pedidos personalizados. Para consultas al por mayor, contáctanos vía WhatsApp o Telegram.
            </p>
          </div>
        </div>
      </section>

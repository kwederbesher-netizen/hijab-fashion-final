// app/es/category/modest-sportswear/page.tsx
'use client'
...
export default function ModestSportswearCategoryPageEs() {
  ...
  const getColorCode = useCallback((color: string) => {
    const colors: any = {
      'Black': '#1a1a1a', 'Navy': '#0a192f', 'Gray': '#6b6b6b', 'Dark Blue': '#1e40af',
      'Burgundy': '#6e2c2c', 'Green': '#2d6a4f', 'Charcoal': '#36454F', 'Dark Gray': '#4a4a4a'
    }
  ...
  if (loading && products.length === 0) return (
    <div style={{ padding: '100px 20px', textAlign: 'center', minHeight: '60vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <p style={{ marginTop: '20px', color: '#555', fontSize: '16px' }}>Cargando ropa deportiva modesta...</p>
    </div>
  )
  ...
  return (
    <>
      <Head>
        <title>Ropa Deportiva Modesta Turca al por Mayor | Activewear Recatado | Hijab Fashion Mall</title>
        <meta name="description" content={`Descubre ${totalProducts}+ conjuntos de ropa deportiva modesta turca al por mayor. Sudaderas, leggings anchos, conjuntos de entrenamiento. Telas transpirables, tallas hasta 4XL.`} />
        <meta name="keywords" content="ropa deportiva modesta turca, activewear recatado, conjuntos de gimnasio modestos, sudaderas largas, leggings deportivos anchos, ropa de entrenamiento musulmana, chándal modesto, ropa de yoga recatada" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://hijabfashionmall.com/es/category/modest-sportswear" />
        ...
        <link rel="alternate" href="https://hijabfashionmall.com/es/category/modest-sportswear" hrefLang="es" />
        <meta property="og:title" content="Ropa Deportiva Modesta Turca al por Mayor" />
        <meta property="og:description" content={`${totalProducts}+ conjuntos de activewear recatado.`} />
      ...
      {showSizeChart && (
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(0,0,0,0.7)', zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }} onClick={() => setShowSizeChart(false)}>
          <div style={{ background: 'white', borderRadius: '24px', maxWidth: '650px', width: '100%', padding: '30px' }} onClick={(e) => e.stopPropagation()}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
              <h3 style={{ fontSize: '24px', color: '#2c2418', fontFamily: 'Playfair Display, serif' }}>📏 Guía de Tallas - Ropa Deportiva</h3>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '20px' }}>
              ...
              <tbody>
                <tr><td style={{ padding: '10px', textAlign: 'center', fontWeight: 600, color: '#ff5a00' }}>S</td><td style={{ padding: '10px', textAlign: 'center' }}>84-88</td><td style={{ padding: '10px', textAlign: 'center' }}>66-70</td><td style={{ padding: '10px', textAlign: 'center' }}>90-94</td></tr>
                <tr style={{ background: '#fef9f2' }}><td style={{ padding: '10px', textAlign: 'center', fontWeight: 600, color: '#ff5a00' }}>M</td><td style={{ padding: '10px', textAlign: 'center' }}>88-92</td><td style={{ padding: '10px', textAlign: 'center' }}>70-74</td><td style={{ padding: '10px', textAlign: 'center' }}>94-98</td></tr>
                <tr><td style={{ padding: '10px', textAlign: 'center', fontWeight: 600, color: '#ff5a00' }}>L</td><td style={{ padding: '10px', textAlign: 'center' }}>92-96</td><td style={{ padding: '10px', textAlign: 'center' }}>74-78</td><td style={{ padding: '10px', textAlign: 'center' }}>98-102</td></tr>
                <tr style={{ background: '#fef9f2' }}><td style={{ padding: '10px', textAlign: 'center', fontWeight: 600, color: '#ff5a00' }}>XL</td><td style={{ padding: '10px', textAlign: 'center' }}>96-100</td><td style={{ padding: '10px', textAlign: 'center' }}>78-82</td><td style={{ padding: '10px', textAlign: 'center' }}>102-106</td></tr>
                <tr><td style={{ padding: '10px', textAlign: 'center', fontWeight: 600, color: '#ff5a00' }}>2XL</td><td style={{ padding: '10px', textAlign: 'center' }}>100-104</td><td style={{ padding: '10px', textAlign: 'center' }}>82-86</td><td style={{ padding: '10px', textAlign: 'center' }}>106-110</td></tr>
                <tr style={{ background: '#fef9f2' }}><td style={{ padding: '10px', textAlign: 'center', fontWeight: 600, color: '#ff5a00' }}>3XL</td><td style={{ padding: '10px', textAlign: 'center' }}>104-108</td><td style={{ padding: '10px', textAlign: 'center' }}>86-90</td><td style={{ padding: '10px', textAlign: 'center' }}>110-114</td></tr>
                <tr><td style={{ padding: '10px', textAlign: 'center', fontWeight: 600, color: '#ff5a00' }}>4XL</td><td style={{ padding: '10px', textAlign: 'center' }}>108-112</td><td style={{ padding: '10px', textAlign: 'center' }}>90-94</td><td style={{ padding: '10px', textAlign: 'center' }}>114-118</td></tr>
              </tbody>
            </table>
            <p style={{ fontSize: '12px', color: '#a08c7a', textAlign: 'center' }}>Telas con elastano para mayor comodidad durante el ejercicio.</p>
          </div>
        </div>
      )}
      ...
      <section style={{ background: 'linear-gradient(135deg, #fdf8f2 0%, #ffffff 100%)', padding: '60px 0 40px', textAlign: 'center', borderBottom: '1px solid #f0e6dc', position: 'relative', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', fontSize: '160px', fontWeight: 800, color: 'rgba(255,90,0,0.03)', whiteSpace: 'nowrap', fontFamily: 'Playfair Display, serif' }}>SPORT</div>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px', position: 'relative', zIndex: 1 }}>
          <div style={{ fontSize: '14px', color: '#7a6a5a', marginBottom: '20px' }}>
            ...
            <span style={{ margin: '0 8px' }}>/</span>
            <span style={{ color: '#7a6a5a' }}>Ropa Deportiva Modesta</span>
          </div>
          <h1 style={{ fontSize: '48px', color: '#2c2418', marginBottom: '15px', fontWeight: 800, fontFamily: 'Playfair Display, serif' }}>Ropa Deportiva <span style={{ color: '#ff5a00' }}>Modesta</span></h1>
          <p style={{ fontSize: '18px', color: '#5a4a3a', maxWidth: '800px', margin: '0 auto', lineHeight: '1.6' }}>Activewear cómodo y funcional para entrenamiento. Telas transpirables, cortes amplios y diseños pensados para el movimiento.</p>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '40px', marginTop: '40px', flexWrap: 'wrap' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="1.8"><path d="M12 2v4M12 18v4M4.93 4.93l2.83 2.83M16.24 16.24l2.83 2.83"/></svg>
              </div>
              <span style={{ color: '#4a3a2a' }}>Telas transpirables</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <span style={{ color: '#4a3a2a' }}>Cortes amplios</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <span style={{ color: '#4a3a2a' }}>Conjuntos completos</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '40px 20px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '30px', flexWrap: 'wrap', gap: '15px', background: 'white', padding: '15px 25px', borderRadius: '20px', border: '1px solid #f0e6dc' }}>
          <div style={{ color: '#5a4a3a', display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <span><span style={{ fontWeight: 600, color: '#ff5a00' }}>{totalProducts}</span> prendas deportivas</span>
        ...
        {products.length === 0 ? (
          <div style={{ textAlign: 'center', padding: '80px 20px', background: 'white', borderRadius: '20px', border: '1px solid #f0e6dc' }}>
            ...
            <h3 style={{ fontSize: '24px', color: '#2c2418', marginBottom: '10px' }}>No se encontraron productos</h3>
                  ...
                  return (
                    <Link href={getProductUrl(p)} key={p._id} style={{ background: 'white', borderRadius: '16px', overflow: 'hidden', textDecoration: 'none', color: 'inherit', border: '1px solid #f0e6dc', transition: 'all 0.3s' }} onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-8px)'; e.currentTarget.style.boxShadow = '0 15px 30px rgba(255,90,0,0.12)'; e.currentTarget.style.borderColor = '#ff5a00'; }} onMouseLeave={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 5px 20px rgba(0,0,0,0.05)'; e.currentTarget.style.borderColor = '#f0e6dc'; }}>
                      <div style={{ position: 'relative', height: '280px', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, #fef9f2 0%, #faf5ed 100%)' }}>
                        <img src={p.imageUrl || '/images/default.webp'} alt={p.name_es || p.name_en || 'Ropa deportiva'} style={{ maxWidth: '90%', maxHeight: '90%', objectFit: 'contain' }} loading="lazy" onError={(e) => { (e.target as HTMLImageElement).src = '/images/default.webp' }} />
                        {badges.length > 0 && <div style={{ position: 'absolute', top: '15px', right: '15px', display: 'flex', gap: '6px', flexDirection: 'column' }}>{badges}</div>}
                      </div>
                      <div style={{ padding: '20px', textAlign: 'center' }}>
                        <div style={{ fontSize: '11px', color: '#ff5a00', marginBottom: '8px', fontWeight: 500, letterSpacing: '1px' }}>SPORTSWEAR</div>
      ...
      <section style={{ background: '#fef9f2', padding: '60px 0', borderTop: '1px solid #f0e6dc', marginTop: '40px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
          <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            <h2 style={{ fontSize: '32px', color: '#2c2418', marginBottom: '20px', fontWeight: 700, textAlign: 'center', fontFamily: 'Playfair Display, serif' }}>Ropa Deportiva Modesta Turca al por Mayor</h2>
            <p style={{ fontSize: '16px', color: '#5a4a3a', lineHeight: '1.8', marginBottom: '25px', textAlign: 'justify' }}>
              La <strong>ropa deportiva modesta turca</strong> combina funcionalidad y estilo. Nuestros conjuntos están diseñados con telas técnicas que absorben la humedad y permiten libertad de movimiento. Incluyen sudaderas con capucha, leggings anchos, pantalones de jogger y conjuntos completos de entrenamiento.
            </p>
            <h3 style={{ fontSize: '24px', color: '#2c2418', margin: '35px 0 20px', fontWeight: 600 }}>Tipos de Ropa Deportiva Disponible</h3>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '15px', marginBottom: '35px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ color: '#ff5a00' }}>✓</span><span><strong>Conjuntos de chándal</strong> – Sudadera + pantalón ancho</span></div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ color: '#ff5a00' }}>✓</span><span><strong>Leggings anchos</strong> – Para entrenamiento y yoga</span></div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ color: '#ff5a00' }}>✓</span><span><strong>Sudaderas largas</strong> – Cubren cadera, con capucha</span></div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ color: '#ff5a00' }}>✓</span><span><strong>Camisetas deportivas</strong> – Mangas largas, telas ligeras</span></div>
            </div>
            <h3 style={{ fontSize: '24px', color: '#2c2418', margin: '35px 0 20px', fontWeight: 600 }}>Características Técnicas</h3>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '15px', marginBottom: '35px' }}>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>Tejidos:</span> Poliéster deportivo, algodón French Terry, mezclas con elastano</div>
              ...
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>Colores:</span> Negro, gris, azul marino, burdeos, oliva</div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>Cuidado:</span> Lavado a máquina 30°C, no secadora</div>
            </div>
          </div>
        </div>
      </section>

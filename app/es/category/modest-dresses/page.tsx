// app/es/category/modest-dresses/page.tsx
'use client'
...
export default function ModestDressesCategoryPageEs() {
  ...
  const getColorCode = useCallback((color: string) => {
    const colors: any = {
      ...
      'Sky Blue': '#7bc5e8', 'Light Brown': '#b8855a', 'Yellow': '#eab308', 'Rose': '#e88c9a'
    }
  ...
  if (loading && products.length === 0) return (
    <div style={{ padding: '100px 20px', textAlign: 'center', minHeight: '60vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <p style={{ marginTop: '20px', color: '#555', fontSize: '16px' }}>Cargando vestidos modestos...</p>
    </div>
  )
  ...
  // Size Chart Data for Turkish Modest Dresses
  const sizeChartData = {
    title: 'Guía de Tallas - Vestidos Modestos Turcos',
  ...
  return (
    <>
      <Head>
        <title>Vestidos Modestos Turcos al por Mayor | Moda Recatada Elegante | Hijab Fashion Mall</title>
        <meta name="description" content={`Descubre ${totalProducts}+ vestidos modestos turcos al por mayor. Largos, mangas largas, telas fluidas: crepe, jersey, seda. Tallas hasta 4XL. Envío mundial.`} />
        <meta name="keywords" content="vestidos modestos turcos al por mayor, vestidos recatados, vestidos largos musulmanes, vestidos turcos elegantes, moda modesta profesional, vestidos de trabajo recatados, vestidos de ceremonia modestos, vestidos maxi turcos, vestidos midi modestos, vestidos de invitada recatados, vestidos turcos de calidad, importar vestidos turquía, vestidos modestos al por mayor" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://hijabfashionmall.com/es/category/modest-dresses" />
        ...
        <link rel="alternate" href="https://hijabfashionmall.com/es/category/modest-dresses" hrefLang="es" />
        <meta property="og:title" content="Vestidos Modestos Turcos al por Mayor" />
        <meta property="og:description" content={`${totalProducts}+ modelos de vestidos recatados. Telas de calidad, cortes modernos.`} />
        <meta property="og:url" content="https://hijabfashionmall.com/es/category/modest-dresses" />
      ...
      {showSizeChart && (
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(0,0,0,0.7)', zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }} onClick={() => setShowSizeChart(false)}>
          <div style={{ background: 'white', borderRadius: '24px', maxWidth: '800px', width: '100%', maxHeight: '80vh', overflow: 'auto', padding: '30px' }} onClick={(e) => e.stopPropagation()}>
            ...
            <p style={{ fontSize: '12px', color: '#a08c7a', marginTop: '15px', textAlign: 'center' }}>Las medidas son aproximadas. Recomendamos consultar la tabla de cada producto.</p>
          </div>
        </div>
      )}
      ...
      <section style={{ background: 'linear-gradient(135deg, #fdf8f2 0%, #ffffff 100%)', padding: '60px 0 40px', textAlign: 'center', borderBottom: '1px solid #f0e6dc', position: 'relative', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', fontSize: '200px', fontWeight: 800, color: 'rgba(255,90,0,0.03)', whiteSpace: 'nowrap', zIndex: 0, fontFamily: 'Playfair Display, serif' }}>MODEST</div>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px', position: 'relative', zIndex: 1 }}>
          <div style={{ fontSize: '14px', color: '#7a6a5a', marginBottom: '20px' }}>
            ...
            <span style={{ margin: '0 8px' }}>/</span>
            <span style={{ color: '#7a6a5a' }}>Vestidos Modestos</span>
          </div>
          <h1 style={{ fontSize: '48px', color: '#2c2418', marginBottom: '15px', fontWeight: 800, lineHeight: '1.2', fontFamily: 'Playfair Display, serif' }}>
            Vestidos Modestos <span style={{ color: '#ff5a00' }}>Turcos</span>
          </h1>
          <p style={{ fontSize: '18px', color: '#5a4a3a', maxWidth: '800px', margin: '0 auto', lineHeight: '1.6' }}>
            Colección de vestidos recatados con mangas largas y cortes amplios. Telas fluidas de alta calidad para el día a día y ocasiones especiales.
          </p>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '40px', marginTop: '40px', flexWrap: 'wrap' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="1.8"><rect x="4" y="8" width="16" height="12" rx="1" stroke="currentColor"/><path d="M8 6V4h8v2" stroke="currentColor"/></svg>
              </div>
              <span style={{ color: '#4a3a2a' }}>Largos hasta el tobillo</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <span style={{ color: '#4a3a2a' }}>Crepe, Jersey, Seda</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          ...
          <main>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '30px', flexWrap: 'wrap', gap: '15px', background: 'white', padding: '15px 25px', borderRadius: '20px', boxShadow: '0 5px 15px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
              <div style={{ color: '#5a4a3a', fontSize: '15px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                ...
                <span><span style={{ fontWeight: 600, color: '#ff5a00' }}>{totalProducts}</span> vestidos modestos</span>
            ...
            {products.length === 0 ? (
              <div style={{ textAlign: 'center', padding: '80px 20px', background: 'white', borderRadius: '20px', boxShadow: '0 10px 30px rgba(0,0,0,0.05)', border: '1px solid #f0e6dc' }}>
                ...
                <h3 style={{ fontSize: '24px', color: '#2c2418', marginBottom: '10px', fontWeight: 600 }}>No se encontraron vestidos</h3>
                ...
                {loading && products.length > 0 ? <LoadingSkeleton /> : (
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '25px', marginBottom: '50px' }}>
                    {products.map((p: any) => {
                      ...
                      if (fabric.includes('crepe')) fabricBadge = <span style={{ background: '#b87c4f', color: 'white', padding: '4px 12px', borderRadius: '20px', fontSize: '11px', fontWeight: 600 }}>CREPE</span>
                      ...
                      else if (fabric.includes('silk')) fabricBadge = <span style={{ background: '#d48c54', color: 'white', padding: '4px 12px', borderRadius: '20px', fontSize: '11px', fontWeight: 600 }}>SEDA</span>
                      ...
                      return (
                        <Link href={getProductUrl(p)} key={p._id} style={{ background: 'white', borderRadius: '16px', overflow: 'hidden', boxShadow: '0 5px 20px rgba(0,0,0,0.05)', transition: 'all 0.3s', textDecoration: 'none', color: 'inherit', border: '1px solid #f0e6dc', display: 'block' }} onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-8px)'; e.currentTarget.style.boxShadow = '0 15px 30px rgba(255,90,0,0.12)'; e.currentTarget.style.borderColor = '#ff5a00'; }} onMouseLeave={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 5px 20px rgba(0,0,0,0.05)'; e.currentTarget.style.borderColor = '#f0e6dc'; }}>
                          <div style={{ position: 'relative', height: '280px', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, #fef9f2 0%, #faf5ed 100%)' }}>
                            <img src={p.imageUrl || '/images/default.webp'} alt={p.name_es || p.name_en || 'Vestido modesto'} style={{ maxWidth: '90%', maxHeight: '90%', objectFit: 'contain', transition: 'transform 0.5s' }} loading="lazy" onError={(e) => { (e.target as HTMLImageElement).src = '/images/default.webp' }} />
                          ...
                          <div style={{ padding: '20px', textAlign: 'center' }}>
                            <div style={{ fontSize: '11px', color: '#ff5a00', marginBottom: '8px', fontWeight: 500, textTransform: 'uppercase', letterSpacing: '1px' }}>Vestido</div>
      ...
      <section style={{ background: '#fef9f2', padding: '60px 0', borderTop: '1px solid #f0e6dc', marginTop: '40px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
          <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            <h2 style={{ fontSize: '32px', color: '#2c2418', marginBottom: '20px', fontWeight: 700, textAlign: 'center', fontFamily: 'Playfair Display, serif' }}>Vestidos Modestos Turcos al por Mayor</h2>
            <p style={{ fontSize: '16px', color: '#5a4a3a', lineHeight: '1.8', marginBottom: '25px', textAlign: 'justify' }}>
              Nuestra colección de <strong>vestidos modestos turcos al por mayor</strong> ofrece diseños contemporáneos que respetan los principios de la moda recatada: mangas largas, largos por debajo de la rodilla o hasta el tobillo, y cortes que no se ajustan al cuerpo. Los vestidos están confeccionados con telas de calidad como crepe, jersey y seda, garantizando comodidad y durabilidad.
            </p>
            <h3 style={{ fontSize: '24px', color: '#2c2418', margin: '35px 0 20px', fontWeight: 600 }}>Tipos de Vestidos Modestos Disponibles</h3>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '15px', marginBottom: '35px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5"/></svg><span><strong>Vestido largo maxi</strong> – Hasta los tobillos, silueta fluida</span></div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5"/></svg><span><strong>Vestido midi</strong> – Largo por debajo de la rodilla, versátil</span></div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5"/></svg><span><strong>Vestido de trabajo</strong> – Cortes profesionales, colores neutros</span></div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5"/></svg><span><strong>Vestido de ceremonia</strong> – Detalles de pedrería, telas brillantes</span></div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5"/></svg><span><strong>Vestido con cinturón</strong> – Ajuste opcional en la cintura</span></div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5"/></svg><span><strong>Vestido kimono</strong> – Abierto por delante, superposición elegante</span></div>
            </div>
            <h3 style={{ fontSize: '24px', color: '#2c2418', margin: '35px 0 20px', fontWeight: 600 }}>Guía de Tallas Turca</h3>
            <div style={{ background: 'white', borderRadius: '16px', padding: '20px', marginBottom: '35px', border: '1px solid #f0e6dc' }}>
              <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                <thead><tr style={{ background: '#f5efe8' }}><th style={{ padding: '10px', textAlign: 'center' }}>Talla</th><th style={{ padding: '10px', textAlign: 'center' }}>Busto (cm)</th><th style={{ padding: '10px', textAlign: 'center' }}>Cintura (cm)</th><th style={{ padding: '10px', textAlign: 'center' }}>Cadera (cm)</th><th style={{ padding: '10px', textAlign: 'center' }}>Largo (cm)</th></tr></thead>
                <tbody>
                  <tr><td style={{ padding: '8px', textAlign: 'center', fontWeight: 600, color: '#ff5a00' }}>S</td><td style={{ padding: '8px', textAlign: 'center' }}>84-88</td><td style={{ padding: '8px', textAlign: 'center' }}>66-70</td><td style={{ padding: '8px', textAlign: 'center' }}>90-94</td><td style={{ padding: '8px', textAlign: 'center' }}>135-140</td></tr>
                  <tr style={{ background: '#fef9f2' }}><td style={{ padding: '8px', textAlign: 'center', fontWeight: 600, color: '#ff5a00' }}>M</td><td style={{ padding: '8px', textAlign: 'center' }}>88-92</td><td style={{ padding: '8px', textAlign: 'center' }}>70-74</td><td style={{ padding: '8px', textAlign: 'center' }}>94-98</td><td style={{ padding: '8px', textAlign: 'center' }}>137-142</td></tr>
                  <tr><td style={{ padding: '8px', textAlign: 'center', fontWeight: 600, color: '#ff5a00' }}>L</td><td style={{ padding: '8px', textAlign: 'center' }}>92-96</td><td style={{ padding: '8px', textAlign: 'center' }}>74-78</td><td style={{ padding: '8px', textAlign: 'center' }}>98-102</td><td style={{ padding: '8px', textAlign: 'center' }}>139-144</td></tr>
                  <tr style={{ background: '#fef9f2' }}><td style={{ padding: '8px', textAlign: 'center', fontWeight: 600, color: '#ff5a00' }}>XL</td><td style={{ padding: '8px', textAlign: 'center' }}>96-100</td><td style={{ padding: '8px', textAlign: 'center' }}>78-82</td><td style={{ padding: '8px', textAlign: 'center' }}>102-106</td><td style={{ padding: '8px', textAlign: 'center' }}>141-146</td></tr>
                  <tr><td style={{ padding: '8px', textAlign: 'center', fontWeight: 600, color: '#ff5a00' }}>2XL</td><td style={{ padding: '8px', textAlign: 'center' }}>100-104</td><td style={{ padding: '8px', textAlign: 'center' }}>82-86</td><td style={{ padding: '8px', textAlign: 'center' }}>106-110</td><td style={{ padding: '8px', textAlign: 'center' }}>143-148</td></tr>
                  <tr style={{ background: '#fef9f2' }}><td style={{ padding: '8px', textAlign: 'center', fontWeight: 600, color: '#ff5a00' }}>3XL</td><td style={{ padding: '8px', textAlign: 'center' }}>104-108</td><td style={{ padding: '8px', textAlign: 'center' }}>86-90</td><td style={{ padding: '8px', textAlign: 'center' }}>110-114</td><td style={{ padding: '8px', textAlign: 'center' }}>145-150</td></tr>
                  <tr><td style={{ padding: '8px', textAlign: 'center', fontWeight: 600, color: '#ff5a00' }}>4XL</td><td style={{ padding: '8px', textAlign: 'center' }}>108-112</td><td style={{ padding: '8px', textAlign: 'center' }}>90-94</td><td style={{ padding: '8px', textAlign: 'center' }}>114-118</td><td style={{ padding: '8px', textAlign: 'center' }}>147-152</td></tr>
                </tbody>
               </table>
            </div>
            <p style={{ fontSize: '16px', color: '#5a4a3a', lineHeight: '1.8', textAlign: 'justify' }}>
              Los <strong>vestidos modestos turcos</strong> se caracterizan por la calidad de sus telas y la atención al detalle. Ofrecemos vestidos para ocasiones de día (trabajo, compras, reuniones) y eventos especiales (bodas, cenas, celebraciones). La colección se actualiza periódicamente con las tendencias de la temporada. Para pedidos al por mayor, contáctanos vía WhatsApp o Telegram. Envíos a todo el mundo con seguimiento.
            </p>
          </div>
        </div>
      </section>

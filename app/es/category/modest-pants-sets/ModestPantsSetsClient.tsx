...
export default function ModestPantsSetsClient({ searchParams }: { searchParams?: { search?: string; page?: string; sort?: string } }) {
  ...
  const sizeChartData = {
    title: 'Guía de Tallas - Conjuntos de Pantalón Turcos',
    columns: ['Talla', 'Cintura (cm)', 'Cadera (cm)', 'Largo pierna (cm)', 'Largo túnica (cm)'],
    rows: [
      { size: 'S', waist: '66-70', hip: '90-94', legLength: '100-102', tunicLength: '75-80' },
      { size: 'M', waist: '70-74', hip: '94-98', legLength: '101-103', tunicLength: '77-82' },
      { size: 'L', waist: '74-78', hip: '98-102', legLength: '102-104', tunicLength: '79-84' },
      { size: 'XL', waist: '78-82', hip: '102-106', legLength: '103-105', tunicLength: '81-86' },
      { size: '2XL', waist: '82-86', hip: '106-110', legLength: '104-106', tunicLength: '83-88' },
      { size: '3XL', waist: '86-90', hip: '110-114', legLength: '105-107', tunicLength: '85-90' },
      { size: '4XL', waist: '90-94', hip: '114-118', legLength: '106-108', tunicLength: '87-92' }
    ]
  }
              ...
              <tbody>
                {sizeChartData.rows.map((row, i) => (
                  <tr key={i} style={{ background: i % 2 === 0 ? '#fef9f2' : 'white' }}>
                    ...
                    <td style={{ padding: '10px', textAlign: 'center' }}>{row.legLength}</td>
                    <td style={{ padding: '10px', textAlign: 'center' }}>{row.tunicLength}</td>
                  </tr>
                ))}
              </tbody>
            </table>
            <p style={{ fontSize: '12px', color: '#a08c7a', marginTop: '15px', textAlign: 'center' }}>Los pantalones turcos suelen tener tiro alto y corte amplio. Las túnicas son de corte recto o ligeramente entallado.</p>
          </div>
        </div>
      )}
      ...
      <section style={{ background: 'linear-gradient(135deg, #fdf8f2 0%, #ffffff 100%)', padding: '60px 0 40px', textAlign: 'center', borderBottom: '1px solid #f0e6dc', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px', position: 'relative', zIndex: 1 }}>
          ...
          <p style={{ fontSize: '18px', color: '#5a4a3a', maxWidth: '800px', margin: '0 auto', lineHeight: '1.6' }}>
            Pantalones anchos combinados con túnicas largas. La opción más cómoda y práctica para el día a día con estilo recatado.
          </p>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
          <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            ...
            <p style={{ fontSize: '16px', color: '#5a4a3a', lineHeight: '1.8', textAlign: 'justify' }}>
              Los conjuntos de pantalón son una categoría con alta demanda en el mercado de moda modesta. Ofrecen una alternativa práctica a los vestidos largos. Nuestros conjuntos se actualizan cada temporada con las tendencias de colores y telas. Para pedidos al por mayor, contáctanos vía WhatsApp o Telegram.
            </p>
          </div>
        </div>
      </section>

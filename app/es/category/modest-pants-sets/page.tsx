// app/es/category/modest-pants-sets/page.tsx
'use client'
...
export default function ModestPantsSetsCategoryPageEs() {
  ...
  if (loading && products.length === 0) return (
    <div style={{ padding: '100px 20px', textAlign: 'center', minHeight: '60vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <p style={{ marginTop: '20px', color: '#555', fontSize: '16px' }}>Cargando conjuntos de pantalón...</p>
    </div>
  )
  ...
  return (
    <>
      <Head>
        <title>Conjuntos de Pantalón Modestos Turcos al por Mayor | Moda Recatada | Hijab Fashion Mall</title>
        <meta name="description" content={`Descubre ${totalProducts}+ conjuntos de pantalón modestos turcos al por mayor. Pantalones anchos + túnicas largas. Telas fluidas, tallas hasta 4XL. Envío mundial.`} />
        <meta name="keywords" content="conjuntos de pantalón modestos turcos, pantalones anchos musulmanes, túnica y pantalón, moda recatada profesional, conjuntos de trabajo modestos, pantalones palazzo, moda turca al por mayor, dos piezas modestas, conjunto de pantalón largo, ropa modesta para mujer" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://hijabfashionmall.com/es/category/modest-pants-sets" />
        ...
        <link rel="alternate" href="https://hijabfashionmall.com/es/category/modest-pants-sets" hrefLang="es" />
        <meta property="og:title" content="Conjuntos de Pantalón Modestos Turcos al por Mayor" />
        <meta property="og:description" content={`${totalProducts}+ conjuntos de pantalón y túnica.`} />
      ...
      {showSizeChart && (
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(0,0,0,0.7)', zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }} onClick={() => setShowSizeChart(false)}>
          <div style={{ background: 'white', borderRadius: '24px', maxWidth: '750px', width: '100%', maxHeight: '80vh', overflow: 'auto', padding: '30px' }} onClick={(e) => e.stopPropagation()}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
              <h3 style={{ fontSize: '24px', color: '#2c2418', fontFamily: 'Playfair Display, serif' }}>📏 Guía de Tallas - Pantalones Turcos</h3>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '20px' }}>
              <thead>
                <tr style={{ background: '#f5efe8' }}>
                  ...
                  <th style={{ padding: '12px', textAlign: 'center', border: '1px solid #e0d5c8' }}>Largo pierna (cm)</th>
                  <th style={{ padding: '12px', textAlign: 'center', border: '1px solid #e0d5c8' }}>Largo túnica (cm)</th>
                </tr>
              </thead>
              <tbody>
                <tr><td style={{ padding: '10px', textAlign: 'center', fontWeight: 600, color: '#ff5a00', border: '1px solid #e0d5c8' }}>S</td><td style={{ padding: '10px', textAlign: 'center', border: '1px solid #e0d5c8' }}>66-70</td><td style={{ padding: '10px', textAlign: 'center', border: '1px solid #e0d5c8' }}>90-94</td><td style={{ padding: '10px', textAlign: 'center', border: '1px solid #e0d5c8' }}>100-102</td><td style={{ padding: '10px', textAlign: 'center', border: '1px solid #e0d5c8' }}>75-80</td></tr>
                <tr style={{ background: '#fef9f2' }}><td style={{ padding: '10px', textAlign: 'center', fontWeight: 600, color: '#ff5a00', border: '1px solid #e0d5c8' }}>M</td><td style={{ padding: '10px', textAlign: 'center', border: '1px solid #e0d5c8' }}>70-74</td><td style={{ padding: '10px', textAlign: 'center', border: '1px solid #e0d5c8' }}>94-98</td><td style={{ padding: '10px', textAlign: 'center', border: '1px solid #e0d5c8' }}>101-103</td><td style={{ padding: '10px', textAlign: 'center', border: '1px solid #e0d5c8' }}>77-82</td></tr>
                <tr><td style={{ padding: '10px', textAlign: 'center', fontWeight: 600, color: '#ff5a00', border: '1px solid #e0d5c8' }}>L</td><td style={{ padding: '10px', textAlign: 'center', border: '1px solid #e0d5c8' }}>74-78</td><td style={{ padding: '10px', textAlign: 'center', border: '1px solid #e0d5c8' }}>98-102</td><td style={{ padding: '10px', textAlign: 'center', border: '1px solid #e0d5c8' }}>102-104</td><td style={{ padding: '10px', textAlign: 'center', border: '1px solid #e0d5c8' }}>79-84</td></tr>
                <tr style={{ background: '#fef9f2' }}><td style={{ padding: '10px', textAlign: 'center', fontWeight: 600, color: '#ff5a00', border: '1px solid #e0d5c8' }}>XL</td><td style={{ padding: '10px', textAlign: 'center', border: '1px solid #e0d5c8' }}>78-82</td><td style={{ padding: '10px', textAlign: 'center', border: '1px solid #e0d5c8' }}>102-106</td><td style={{ padding: '10px', textAlign: 'center', border: '1px solid #e0d5c8' }}>103-105</td><td style={{ padding: '10px', textAlign: 'center', border: '1px solid #e0d5c8' }}>81-86</td></tr>
                <tr><td style={{ padding: '10px', textAlign: 'center', fontWeight: 600, color: '#ff5a00', border: '1px solid #e0d5c8' }}>2XL</td><td style={{ padding: '10px', textAlign: 'center', border: '1px solid #e0d5c8' }}>82-86</td><td style={{ padding: '10px', textAlign: 'center', border: '1px solid #e0d5c8' }}>106-110</td><td style={{ padding: '10px', textAlign: 'center', border: '1px solid #e0d5c8' }}>104-106</td><td style={{ padding: '10px', textAlign: 'center', border: '1px solid #e0d5c8' }}>83-88</td></tr>
                <tr style={{ background: '#fef9f2' }}><td style={{ padding: '10px', textAlign: 'center', fontWeight: 600, color: '#ff5a00', border: '1px solid #e0d5c8' }}>3XL</td><td style={{ padding: '10px', textAlign: 'center', border: '1px solid #e0d5c8' }}>86-90</td><td style={{ padding: '10px', textAlign: 'center', border: '1px solid #e0d5c8' }}>110-114</td><td style={{ padding: '10px', textAlign: 'center', border: '1px solid #e0d5c8' }}>105-107</td><td style={{ padding: '10px', textAlign: 'center', border: '1px solid #e0d5c8' }}>85-90</td></tr>
                <tr><td style={{ padding: '10px', textAlign: 'center', fontWeight: 600, color: '#ff5a00', border: '1px solid #e0d5c8' }}>4XL</td><td style={{ padding: '10px', textAlign: 'center', border: '1px solid #e0d5c8' }}>90-94</td><td style={{ padding: '10px', textAlign: 'center', border: '1px solid #e0d5c8' }}>114-118</td><td style={{ padding: '10px', textAlign: 'center', border: '1px solid #e0d5c8' }}>106-108</td><td style={{ padding: '10px', textAlign: 'center', border: '1px solid #e0d5c8' }}>87-92</td></tr>
              </tbody>
            </table>
            <p style={{ fontSize: '12px', color: '#a08c7a', textAlign: 'center' }}>Los pantalones turcos suelen tener tiro alto y corte amplio. Las túnicas son de corte recto o ligeramente entallado.</p>
          </div>
        </div>
      )}
      ...
      <section style={{ background: 'linear-gradient(135deg, #fdf8f2 0%, #ffffff 100%)', padding: '60px 0 40px', textAlign: 'center', borderBottom: '1px solid #f0e6dc', position: 'relative', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', fontSize: '180px', fontWeight: 800, color: 'rgba(255,90,0,0.03)', whiteSpace: 'nowrap', fontFamily: 'Playfair Display, serif' }}>PANTS</div>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px', position: 'relative', zIndex: 1 }}>
          <div style={{ fontSize: '14px', color: '#7a6a5a', marginBottom: '20px' }}>
            ...
            <span style={{ margin: '0 8px' }}>/</span>
            <span style={{ color: '#7a6a5a' }}>Conjuntos de Pantalón</span>
          </div>
          <h1 style={{ fontSize: '48px', color: '#2c2418', marginBottom: '15px', fontWeight: 800, fontFamily: 'Playfair Display, serif' }}>Conjuntos de <span style={{ color: '#ff5a00' }}>Pantalón Modestos</span></h1>
          <p style={{ fontSize: '18px', color: '#5a4a3a', maxWidth: '800px', margin: '0 auto', lineHeight: '1.6' }}>Pantalones anchos combinados con túnicas largas. La opción más cómoda y práctica para el día a día con estilo recatado.</p>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '40px', marginTop: '40px', flexWrap: 'wrap' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="1.8"><path d="M3 6h18v12H3z" stroke="currentColor"/><path d="M8 10h8" stroke="currentColor"/></svg>
              </div>
              <span style={{ color: '#4a3a2a' }}>Pantalones anchos</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <span style={{ color: '#4a3a2a' }}>Túnicas largas</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <span style={{ color: '#4a3a2a' }}>Telas fluidas</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '40px 20px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '30px', flexWrap: 'wrap', gap: '15px', background: 'white', padding: '15px 25px', borderRadius: '20px', border: '1px solid #f0e6dc' }}>
          <div style={{ color: '#5a4a3a', display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <span><span style={{ fontWeight: 600, color: '#ff5a00' }}>{totalProducts}</span> conjuntos de pantalón</span>
          ...
          <>
                ...
                {products.map((p: any) => {
                  ...
                  return (
                    <Link href={getProductUrl(p)} key={p._id} style={{ background: 'white', borderRadius: '16px', overflow: 'hidden', textDecoration: 'none', color: 'inherit', border: '1px solid #f0e6dc', transition: 'all 0.3s' }} onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-8px)'; e.currentTarget.style.boxShadow = '0 15px 30px rgba(255,90,0,0.12)'; e.currentTarget.style.borderColor = '#ff5a00'; }} onMouseLeave={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 5px 20px rgba(0,0,0,0.05)'; e.currentTarget.style.borderColor = '#f0e6dc'; }}>
                      ...
                      <div style={{ padding: '20px', textAlign: 'center' }}>
                        <div style={{ fontSize: '11px', color: '#ff5a00', marginBottom: '8px', fontWeight: 500, letterSpacing: '1px' }}>CONJUNTO</div>
            ...
            {totalPages > 1 && (
              <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '8px', marginTop: '30px', flexWrap: 'wrap' }}>
                <button onClick={() => setCurrentPage(p => Math.max(1, p - 1))} disabled={currentPage === 1} style={{ width: '45px', height: '45px', border: currentPage === 1 ? '1px solid #f0e6dc' : 'none', background: currentPage === 1 ? '#f5efe8' : '#ff5a00', borderRadius: '12px', cursor: currentPage === 1 ? 'not-allowed' : 'pointer', color: currentPage === 1 ? '#c0b0a0' : 'white' }}>‹</button>
                {Array.from({ length: totalPages }, (_, i) => i + 1).filter(p => p === 1 || p === totalPages || (p >= currentPage - 2 && p <= currentPage + 2)).map((p, i, arr) => {
                  if (i > 0 && p - arr[i-1] > 1) return <span key={`dots-${p}`} style={{ color: '#c0b0a0' }}>...</span>
                  return <button key={p} onClick={() => setCurrentPage(p)} style={{ width: '45px', height: '45px', border: 'none', background: p === currentPage ? '#ff5a00' : '#f5efe8', borderRadius: '12px', cursor: 'pointer', color: p === currentPage ? 'white' : '#4a3a2a', fontWeight: p === currentPage ? 700 : 500 }}>{p}</button>
                })}
      ...
      <section style={{ background: '#fef9f2', padding: '60px 0', borderTop: '1px solid #f0e6dc', marginTop: '40px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
          <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            <h2 style={{ fontSize: '32px', color: '#2c2418', marginBottom: '20px', fontWeight: 700, textAlign: 'center', fontFamily: 'Playfair Display, serif' }}>Conjuntos de Pantalón Modestos Turcos al por Mayor</h2>
            <p style={{ fontSize: '16px', color: '#5a4a3a', lineHeight: '1.8', marginBottom: '25px', textAlign: 'justify' }}>
              Los <strong>conjuntos de pantalón modestos turcos</strong> son una opción versátil y cómoda para el día a día. Nuestra colección incluye pantalones de corte ancho (palazzo) combinados con túnicas largas que cubren hasta la cadera o más. Estas prendas son ideales para entornos profesionales, viajes o uso diario, ofreciendo libertad de movimiento sin sacrificar el estilo.
            </p>
            <h3 style={{ fontSize: '24px', color: '#2c2418', margin: '35px 0 20px', fontWeight: 600 }}>Tipos de Conjuntos Disponibles</h3>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '15px', marginBottom: '35px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ color: '#ff5a00' }}>✓</span><span><strong>Pantalón palazzo + túnica corta</strong> – Ideal para climas cálidos</span></div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ color: '#ff5a00' }}>✓</span><span><strong>Pantalón recto + túnica larga</strong> – Estilo profesional</span></div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ color: '#ff5a00' }}>✓</span><span><strong>Pantalón culotte + blusa larga</strong> – Tendencia moderna</span></div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ color: '#ff5a00' }}>✓</span><span><strong>Pantalón de vestir + túnica de seda</strong> – Ocasiones especiales</span></div>
            </div>
            <h3 style={{ fontSize: '24px', color: '#2c2418', margin: '35px 0 20px', fontWeight: 600 }}>Características de los Conjuntos Turcos</h3>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '15px', marginBottom: '35px' }}>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>Tejidos:</span> Crepe, jersey, viscosa, poliéster de alta calidad</div>
              ...
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>Colores:</span> Negro, beige, marino, oliva, burdeos, gris</div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>Cuidado:</span> Lavado a máquina 30°C, no usar blanqueador</div>
            </div>
            <p style={{ fontSize: '16px', color: '#5a4a3a', lineHeight: '1.8', textAlign: 'justify' }}>
              Los conjuntos de pantalón son una categoría con alta demanda en el mercado de moda modesta. Ofrecen una alternativa práctica a los vestidos largos, manteniendo los estándares de recato con mangas largas y cortes amplios. Nuestros conjuntos se actualizan cada temporada con las tendencias de colores y telas. Para pedidos al por mayor, contáctanos vía WhatsApp o Telegram.
            </p>
          </div>
        </div>
      </section>

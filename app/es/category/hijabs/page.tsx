// app/es/category/hijabs/page.tsx
'use client'
...
export default function HijabsCategoryPageEs() {
  ...
  if (loading && products.length === 0) return (
    <div style={{ 
      ...
      `}</style>
      <p style={{ marginTop: '20px', color: '#555', fontSize: '16px' }}>Cargando hijabs...</p>
    </div>
  )
  ...
  return (
    <>
      <Head>
        <title>Hijabs Turcos al por Mayor | Velo Musulmán Modal, Seda, Jersey, Algodón | Hijab Fashion Mall</title>
        <meta name="description" content={`Descubre ${totalProducts}+ hijabs turcos al por mayor. Modal premium, seda líquida, jersey suave, gasa de seda, algodón. Colores variados, calidad excepcional. Envío mundial para profesionales.`} />
        <meta name="keywords" content="hijabs turcos al por mayor, mayorista hijabs, velo musulmán, hijab modal, hijab seda, hijab jersey, hijab gasa, pañuelo árabe, velo islámico, moda modesta turca, hijab profesional, hijab diáfano, hijab opaco, colección hijab 2026, hijab para mujer, hijab de trabajo, hijab de ceremonia, tela turca calidad, importar hijab turquía, hijab minorista, venta al por mayor hijab" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://hijabfashionmall.com/es/category/hijabs" />
        ...
        <link rel="alternate" href="https://hijabfashionmall.com/es/category/hijabs" hrefLang="es" />
        
        <meta property="og:title" content="Colección Hijabs Turcos al por Mayor - Modal & Seda" />
        <meta property="og:description" content={`${totalProducts}+ modelos de hijabs premium. Tejidos excepcionales: modal suave, seda líquida, jersey. Para profesionales de la moda modesta.`} />
        <meta property="og:url" content="https://hijabfashionmall.com/es/category/hijabs" />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://hijabfashionmall.com/images/og-hijabs-es.jpg" />
      ...
      <section style={{
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px', position: 'relative', zIndex: 1 }}>
          ...
          <h1 style={{ 
            ...
            Hijabs Turcos <span style={{ color: '#ff5a00' }}>de Calidad Premium</span>
          </h1>
          <p style={{ fontSize: '18px', color: '#5a4a3a', maxWidth: '800px', margin: '0 auto', lineHeight: '1.6' }}>
            Descubre nuestra colección de hijabs turcos al por mayor. Telas suaves y fluidas: modal premium, 
            seda líquida, jersey cómodo y gasa ligera para todos los estilos y ocasiones.
          </p>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>Modal Premium</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{
                width: '44px',
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>Seda Líquida</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{
                width: '44px',
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>Jersey Suave</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{
                width: '44px',
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>+50 Colores</span>
            </div>
          </div>
        </div>
      </section>
          ...
          <main>
            ...
            <div style={{
              ...
              <div style={{ color: '#5a4a3a', fontSize: '15px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                ...
                <span><span style={{ fontWeight: 600, color: '#ff5a00' }}>{totalProducts}</span> hijabs referenciados</span>
                {totalProducts > 0 && (
            ...
            {products.length === 0 ? (
              <div style={{
                ...
                <h3 style={{ fontSize: '24px', color: '#2c2418', marginBottom: '10px', fontWeight: 600 }}>No se encontraron hijabs</h3>
                ...
                {loading && products.length > 0 ? (
                  ...
                  <div style={{
                    ...
                    {products.map((p: any) => {
                      ...
                      } else if (fabric.includes('silk') || fabric.includes('seda')) {
                        fabricBadge = <span style={{
                          background: '#d48c54',
                          color: 'white',
                          padding: '4px 12px',
                      ...
                      } else if (fabric.includes('chiffon') || fabric.includes('gasa')) {
                        fabricBadge = <span style={{
                          background: '#c98a60',
                          color: 'white',
                          padding: '4px 12px',
                      ...
                      } else if (fabric.includes('cotton') || fabric.includes('algodón')) {
                        fabricBadge = <span style={{
                          background: '#8b6b4a',
                          color: 'white',
                          padding: '4px 12px',
                        ...
                        >
                          <div style={{
                            ...
                            <img 
                              ...
                              alt={p.name_es || p.name_en || p.name_ar || 'Hijab turco'}
                              style={{ 
                                maxWidth: '90%', 
                                maxHeight: '90%', 
                                objectFit: 'contain', 
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
          <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            <h2 style={{
              ...
              Colección Completa de Hijabs Turcos al por Mayor
            </h2>
            <p style={{
              fontSize: '16px',
              color: '#5a4a3a',
              ...
              Bienvenido a Hijab Fashion Mall, su <strong>mayorista de confianza para hijabs turcos</strong> desde 2019. 
              Nuestra colección al por mayor ofrece más de <strong>{totalProducts} modelos de hijabs</strong> adaptados a las necesidades 
              de minoristas, tiendas online y profesionales de la moda modesta. Seleccionamos cuidadosamente tejidos 
              excepcionales: <strong>modal premium, seda líquida, jersey suave, gasa ligera y algodón</strong>. Cada pieza 
              está confeccionada en talleres turcos especializados, garantizando la máxima calidad y durabilidad.
            </p>
            ...
            <h3 style={{
              ...
              Tipos de Hijabs Disponibles para Compra al por Mayor
            </h3>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
                ...
                <span style={{ color: '#4a3a2a' }}><strong>Hijab Modal Premium</strong> – Suave como la seda, caída perfecta, ideal para uso diario</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
                </svg>
                <span style={{ color: '#4a3a2a' }}><strong>Hijab Seda Líquida</strong> – Brillo elegante, para ocasiones especiales</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
                </svg>
                <span style={{ color: '#4a3a2a' }}><strong>Hijab Jersey</strong> – Tela elástica, no resbala, fácil de colocar</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
                </svg>
                <span style={{ color: '#4a3a2a' }}><strong>Hijab Gasa (Chiffon)</strong> – Ligero y transparente, perfecto para looks etéreos</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
                </svg>
                <span style={{ color: '#4a3a2a' }}><strong>Hijab Algodón</strong> – Transpirable, ideal para climas cálidos</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
                </svg>
                <span style={{ color: '#4a3a2a' }}><strong>Hijab Viscosa</strong> – Caída fluida, acabado mate elegante</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
                </svg>
                <span style={{ color: '#4a3a2a' }}><strong>Hijab Lino</strong> – Textura natural, estilo casual chic</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
                </svg>
                <span style={{ color: '#4a3a2a' }}><strong>Hijab Estampado</strong> – Diseños florales, geométricos y abstractos</span>
              </div>
            </div>
            ...
            <h3 style={{
              ...
              Características Técnicas de los Hijabs Turcos
            </h3>
            ...
            <div style={{
              ...
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                ...
                <p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>Modal 95% elastano 5%, Seda líquida 100% poliéster, Jersey 95% viscosa 5% elastano, Gasa 100% poliéster</p>
              </div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <span style={{ fontWeight: 700, color: '#ff5a00' }}>Tamaños disponibles:</span>
                <p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>180x70 cm, 180x90 cm, 200x100 cm (según modelo)</p>
              </div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <span style={{ fontWeight: 700, color: '#ff5a00' }}>Colores:</span>
                <p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>Más de 50 colores: negro, blanco, beige, nude, rosa pastel, azul marino, burdeos, verde menta, gris, lavanda, etc.</p>
              </div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <span style={{ fontWeight: 700, color: '#ff5a00' }}>Peso de la tela:</span>
                <p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>Modal: 220-250 gsm, Jersey: 200-230 gsm, Gasa: 40-60 gsm</p>
              </div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <span style={{ fontWeight: 700, color: '#ff5a00' }}>Cuidado:</span>
                <p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>Lavar a máquina 30°C en ciclo delicado, no usar blanqueador, secar a la sombra, planchar a baja temperatura</p>
              </div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <span style={{ fontWeight: 700, color: '#ff5a00' }}>Empaquetado:</span>
                <p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>Pieza individual (RSS) o paquete de 6/12/24 piezas según modelos</p>
              </div>
            </div>
            ...
            <h3 style={{
              ...
              Ventajas de los Hijabs Turcos para Profesionales
            </h3>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                ...
                <span style={{ color: '#4a3a2a' }}>Tejidos de primera calidad (certificados OEKO-TEX)</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
                </svg>
                <span style={{ color: '#4a3a2a' }}>Amplia variedad de colores y diseños actuales</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                ...
                <span style={{ color: '#4a3a2a' }}>Alta rotación de inventario - productos muy demandados</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
                </svg>
                <span style={{ color: '#4a3a2a' }}>Posibilidad de personalización (marca privada, empaque)</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
                </svg>
                <span style={{ color: '#4a3a2a' }}>Envío rápido y seguro a más de 50 países</span>
              </div>
            </div>
            ...
            <p style={{
              ...
              Los <strong>hijabs turcos</strong> se han convertido en un referente mundial por su calidad excepcional, la suavidad de sus tejidos 
              y la variedad de colores disponibles. Tanto si buscas hijabs para uso diario (modal, jersey, algodón) como para ocasiones 
              especiales (seda líquida, gasa con pedrería), nuestra colección al por mayor tiene lo que necesitas. 
              Los hijabs de modal son especialmente populares por su textura sedosa, su facilidad de uso y su resistencia 
              a las arrugas. Los hijabs de jersey son ideales para clientas activas que buscan comodidad y sujeción. 
              Nuestra gama de <strong>más de 50 colores</strong> te permitirá ofrecer una amplia selección a tus clientes, desde tonos neutros 
              (beige, nude, gris) hasta colores vibrantes (rojo, azul real, verde esmeralda) y pasteles suaves (rosa, lavanda, menta). 
              Para revendedores y tiendas online, los hijabs representan una categoría de producto con alta demanda y rotación, 
              especialmente durante el Ramadán, la temporada de bodas y las festividades del Eid. 
              Explora nuestra selección y enriquece tu oferta de moda modesta con hijabs turcos de primera calidad. 
              Para pedidos al por mayor o consultas personalizadas, contáctanos vía WhatsApp o Telegram. 
              Envío mundial garantizado con seguimiento de paquete.
            </p>
          </div>
        </div>
      </section>

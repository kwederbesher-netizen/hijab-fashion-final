// app/es/category/modest-skirt-sets/page.tsx
'use client'
...
export default function ModestSkirtSetsCategoryPageEs() {
  ...
  return (
    <>
      <Head>
        <title>Conjuntos de Falda Modestos Turcos al por Mayor | Moda Recatada | Hijab Fashion Mall</title>
        <meta name="description" content={`Descubre ${totalProducts}+ conjuntos de falda modestos turcos al por mayor. Faldas largas + túnicas o blusas. Telas fluidas, tallas hasta 4XL.`} />
        <meta name="keywords" content="conjuntos de falda modestos turcos, faldas largas musulmanas, conjuntos de dos piezas recatados, falda y túnica, moda modesta profesional, conjuntos de falda para trabajo, faldas midi modestas, conjuntos turcos de calidad" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://hijabfashionmall.com/es/category/modest-skirt-sets" />
        ...
        <link rel="alternate" href="https://hijabfashionmall.com/es/category/modest-skirt-sets" hrefLang="es" />
        <meta property="og:title" content="Conjuntos de Falda Modestos Turcos al por Mayor" />
        <meta property="og:description" content={`${totalProducts}+ conjuntos de falda y túnica.`} />
      ...
      {showSizeChart && (
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(0,0,0,0.7)', zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }} onClick={() => setShowSizeChart(false)}>
          <div style={{ background: 'white', borderRadius: '24px', maxWidth: '700px', width: '100%', padding: '30px' }} onClick={(e) => e.stopPropagation()}>
            <h3 style={{ fontSize: '24px', color: '#2c2418', marginBottom: '20px', textAlign: 'center' }}>Guía de Tallas - Faldas Turcas</h3>
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              ...
              <tbody>
                <tr><td style={{ padding: '8px', textAlign: 'center', fontWeight: 600, color: '#ff5a00' }}>S</td><td style={{ padding: '8px', textAlign: 'center' }}>66-70</td><td style={{ padding: '8px', textAlign: 'center' }}>90-94</td><td style={{ padding: '8px', textAlign: 'center' }}>85-90</td><td style={{ padding: '8px', textAlign: 'center' }}>75-80</td></tr>
                <tr style={{ background: '#fef9f2' }}><td style={{ padding: '8px', textAlign: 'center', fontWeight: 600, color: '#ff5a00' }}>M</td><td style={{ padding: '8px', textAlign: 'center' }}>70-74</td><td style={{ padding: '8px', textAlign: 'center' }}>94-98</td><td style={{ padding: '8px', textAlign: 'center' }}>87-92</td><td style={{ padding: '8px', textAlign: 'center' }}>77-82</td></tr>
                <tr><td style={{ padding: '8px', textAlign: 'center', fontWeight: 600, color: '#ff5a00' }}>L</td><td style={{ padding: '8px', textAlign: 'center' }}>74-78</td><td style={{ padding: '8px', textAlign: 'center' }}>98-102</td><td style={{ padding: '8px', textAlign: 'center' }}>89-94</td><td style={{ padding: '8px', textAlign: 'center' }}>79-84</td></tr>
                <tr style={{ background: '#fef9f2' }}><td style={{ padding: '8px', textAlign: 'center', fontWeight: 600, color: '#ff5a00' }}>XL</td><td style={{ padding: '8px', textAlign: 'center' }}>78-82</td><td style={{ padding: '8px', textAlign: 'center' }}>102-106</td><td style={{ padding: '8px', textAlign: 'center' }}>91-96</td><td style={{ padding: '8px', textAlign: 'center' }}>81-86</td></tr>
                <tr><td style={{ padding: '8px', textAlign: 'center', fontWeight: 600, color: '#ff5a00' }}>2XL</td><td style={{ padding: '8px', textAlign: 'center' }}>82-86</td><td style={{ padding: '8px', textAlign: 'center' }}>106-110</td><td style={{ padding: '8px', textAlign: 'center' }}>93-98</td><td style={{ padding: '8px', textAlign: 'center' }}>83-88</td></tr>
                <tr style={{ background: '#fef9f2' }}><td style={{ padding: '8px', textAlign: 'center', fontWeight: 600, color: '#ff5a00' }}>3XL</td><td style={{ padding: '8px', textAlign: 'center' }}>86-90</td><td style={{ padding: '8px', textAlign: 'center' }}>110-114</td><td style={{ padding: '8px', textAlign: 'center' }}>95-100</td><td style={{ padding: '8px', textAlign: 'center' }}>85-90</td></tr>
                <tr><td style={{ padding: '8px', textAlign: 'center', fontWeight: 600, color: '#ff5a00' }}>4XL</td><td style={{ padding: '8px', textAlign: 'center' }}>90-94</td><td style={{ padding: '8px', textAlign: 'center' }}>114-118</td><td style={{ padding: '8px', textAlign: 'center' }}>97-102</td><td style={{ padding: '8px', textAlign: 'center' }}>87-92</td></tr>
              </tbody>
            </table>
          </div>
        </div>

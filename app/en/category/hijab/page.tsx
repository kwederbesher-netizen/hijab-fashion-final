...
export default function HijabsCategoryPage() {
  const params = useParams()
  
  // Page configuration for Hijabs category
  const PAGE_CONFIG = {
    category: "Hijabs",
    categoryName: "Hijabs",
    pageTitle: "Wholesale Turkish Hijabs | Premium Chiffon & Silk Hijabs From Turkey",
    pageDescription: "Premium Turkish hijabs wholesale. Wide collection of chiffon hijabs, silk hijabs, cotton hijabs, and jersey hijabs. No minimum order, worldwide shipping. Join 5000+ retailers.",
    pageKeywords: "turkish hijab wholesale, hijab turkey, chiffon hijab, silk hijab, cotton hijab, jersey hijab, islamic scarf wholesale, headscarves turkey",
    h1: "Turkish Hijabs Wholesale",
    subtitle: "Discover our premium collection of Turkish hijabs. From luxurious chiffon and silk to comfortable cotton and jersey, find the perfect hijabs for your boutique at wholesale prices.",
    seoContent: {
      h2: "Wholesale Turkish Hijabs – Premium Quality at Factory Prices",
      p1: "Welcome to Hijab Fashion Mall, your trusted source for authentic Turkish hijabs. Our hijab collection features the finest craftsmanship with fabrics like chiffon, known for its elegant drape and luxurious feel. Whether you're looking for classic solid colors, modern prints, or special occasion pieces, we have something for every boutique.",
      features: [
        "100% Original Turkish Manufacturing",
        "Premium Fabrics: Chiffon, Silk, Satin, Cotton, Jersey, Viscose",
        "Standard Size: 180cm x 70cm (and other sizes available)",
        "Wide Range of Colors and Patterns",
        "No Minimum Order Quantity",
        "Fast Worldwide Shipping (3-7 Days)",
        "Secure Payment Methods"
      ],
      popularStyles: "Chiffon Hijabs, Silk Hijabs, Cotton Hijabs, Jersey Hijabs, Satin Hijabs, Printed Hijabs, Embroidered Hijabs, and Crinkle Hijabs."
    }
  }
  ...
  const fetchProducts = useCallback(async () => {
    try {
      ...
      params.append('category', 'Hijabs') // Using 'Hijabs' as in the working Arabic page
    ...
    <>
          ...
          <div className="stats-container">
            <div className="stats-info">
              <div className="stat-item">
                ...
                <span><strong>{totalProducts}</strong> Hijab Products</span>
              </div>
              <div className="stat-item">
      ...
      <section className="products-section">
        <div className="container">
          <div className="products-header">
            <h2>Our <span>Hijab</span> Collection</h2>
          ...
          {loading ? (
            <div className="no-products">
              ...
              <p>Please wait while we load our hijab collection.</p>
            </div>
          ) : products.length === 0 ? (
            <div className="no-products">
              <i className="fas fa-box-open"></i>
              <h3>No Products Found</h3>
              <p>We couldn't find any hijab products in this category. Please check back later.</p>
            ...
            <>
              <div className="products-grid">
                {products.map((product: any) => {
                  const name = product.name_en || product.name_ar || 'Hijab'
      ...
      <section className="seo-content">
        <div className="container">
          ...
          <h3>Why Choose Our Turkish Hijabs?</h3>
          <ul>
          ...
          <p>Join over 5000+ satisfied retailers worldwide who trust us for their hijab collections. From small boutiques to large retailers, we provide consistent quality and reliable service. Browse our collection and place your inquiry today!</p>
          
          <p><strong>Popular Hijab Types:</strong> {PAGE_CONFIG.seoContent.popularStyles}</p>
        </div>
      </section>
    </>
  )

// app/en/category/burkini/page.tsx
'use client'
...
export default function BurkiniCategoryPageEn() {
  ...
  if (loading && products.length === 0) return (
    <div style={{ padding: '100px 20px', textAlign: 'center', minHeight: '60vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
      ...
      `}</style>
      <p style={{ marginTop: '20px', color: '#555', fontSize: '16px' }}>Loading burkini...</p>
    </div>
  )
  ...
  return (
    <>
      <Head>
        <title>Burkini Wholesale | Turkish Modest Swimwear, Full Coverage Swimsuits | Hijab Fashion Mall</title>
        <meta name="description" content={`Discover ${totalProducts}+ burkini wholesale. Turkish modest swimwear, full coverage swimsuits, quick-dry fabrics, UV protection. Worldwide B2B shipping for retailers.`} />
        <meta name="keywords" content="burkini wholesale, turkish burkini, modest swimwear wholesale, full coverage swimsuit, islamic swimwear, burkini set, swim hijab, uv protection swimwear, quick dry burkini, modest beachwear, turkish swimwear, wholesale burkini supplier, plus size burkini" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://hijabfashionmall.com/en/category/burkini" />
        ...
        <meta property="og:title" content="Turkish Burkini Wholesale Collection" />
        <meta property="og:description" content={`${totalProducts}+ modest swimwear pieces. Chlorine-resistant, quick-dry fabrics with full coverage for beach and pool.`} />
        <meta property="og:url" content="https://hijabfashionmall.com/en/category/burkini" />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://hijabfashionmall.com/images/og-burkini-en.jpg" />
      ...
      <section style={{ background: 'linear-gradient(135deg, #fdf8f2 0%, #ffffff 100%)', padding: '60px 0 40px', textAlign: 'center', borderBottom: '1px solid #f0e6dc', position: 'relative', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', fontSize: '160px', fontWeight: 800, color: 'rgba(255,90,0,0.03)', whiteSpace: 'nowrap', zIndex: 0, pointerEvents: 'none', fontFamily: 'Playfair Display, serif' }}>BURKINI</div>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px', position: 'relative', zIndex: 1 }}>
          ...
          <h1 style={{ fontSize: '48px', color: '#2c2418', marginBottom: '15px', fontWeight: 800, lineHeight: '1.2', fontFamily: 'Playfair Display, serif' }}>
            Modest <span style={{ color: '#ff5a00' }}>Burkini</span>
          </h1>
          <p style={{ fontSize: '18px', color: '#5a4a3a', maxWidth: '800px', margin: '0 auto', lineHeight: '1.6' }}>
            Discover our wholesale collection of Turkish burkini. Full-coverage swimwear designed for 
            comfort, quick-drying, and freedom of movement in water.
          </p>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '40px', marginTop: '40px', flexWrap: 'wrap' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>Quick-Dry</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>UV Protection</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>Swim Hijab</span>
            </div>
          </div>
        </div>
      </section>
          ...
          <main>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '30px', flexWrap: 'wrap', gap: '15px', background: 'white', padding: '15px 25px', borderRadius: '20px', boxShadow: '0 5px 15px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
              <div style={{ color: '#5a4a3a', fontSize: '15px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                ...
                <span><span style={{ fontWeight: 600, color: '#ff5a00' }}>{totalProducts}</span> burkini sets</span>
            ...
            {products.length === 0 ? (
              <div style={{ textAlign: 'center', padding: '80px 20px', background: 'white', borderRadius: '20px', boxShadow: '0 10px 30px rgba(0,0,0,0.05)', border: '1px solid #f0e6dc' }}>
                ...
                <h3 style={{ fontSize: '24px', color: '#2c2418', marginBottom: '10px', fontWeight: 600 }}>No burkini found</h3>
                      ...
                      return (
                        <Link href={getProductUrl(p)} key={p._id} style={{ background: 'white', borderRadius: '20px', overflow: 'hidden', boxShadow: '0 5px 20px rgba(0,0,0,0.05)', transition: 'all 0.3s', textDecoration: 'none', color: 'inherit', border: '1px solid #f0e6dc', display: 'block' }} onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-8px)'; e.currentTarget.style.boxShadow = '0 15px 30px rgba(255,90,0,0.12)'; e.currentTarget.style.borderColor = '#ff5a00' }} onMouseLeave={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 5px 20px rgba(0,0,0,0.05)'; e.currentTarget.style.borderColor = '#f0e6dc' }}>
                          <div style={{ position: 'relative', height: '280px', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, #fef9f2 0%, #faf5ed 100%)' }}>
                            <img src={p.imageUrl || '/images/default.webp'} alt={p.name_en || p.name_fr || p.name_ar || 'Burkini'} style={{ maxWidth: '90%', maxHeight: '90%', objectFit: 'contain', transition: 'transform 0.5s' }} loading="lazy" onError={(e) => { (e.target as HTMLImageElement).src = '/images/default.webp' }} />
                            {badges.length > 0 && <div style={{ position: 'absolute', top: '15px', right: '15px', display: 'flex', gap: '6px', flexDirection: 'column' }}>{badges}</div>}
                          </div>
                          <div style={{ padding: '20px', textAlign: 'center' }}>
                            <div style={{ fontSize: '11px', color: '#ff5a00', marginBottom: '8px', fontWeight: 500, textTransform: 'uppercase', letterSpacing: '1px' }}>Burkini</div>
      ...
      <section style={{ background: '#fef9f2', padding: '60px 0', borderTop: '1px solid #f0e6dc', marginTop: '40px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
          <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            <h2 style={{ fontSize: '32px', color: '#2c2418', marginBottom: '20px', fontWeight: 700, textAlign: 'center', fontFamily: 'Playfair Display, serif' }}>Turkish Burkini Collection</h2>
            <p style={{ fontSize: '16px', color: '#5a4a3a', lineHeight: '1.8', marginBottom: '25px', textAlign: 'justify' }}>
              Discover our collection of <strong>Turkish burkini</strong>, modest swimwear designed for comfort and functionality 
              in water. Our wholesale range features over <strong>{totalProducts} burkini sets</strong> including two-piece and one-piece 
              options. These garments are made from <strong>quick-dry, chlorine-resistant fabrics</strong> that provide UV protection 
              and maintain their shape after repeated use in pools or seawater.
            </p>
            
            <h3 style={{ fontSize: '24px', color: '#2c2418', margin: '35px 0 20px', fontWeight: 600 }}>Burkini Styles Available Wholesale</h3>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '15px', marginBottom: '35px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/></svg><span style={{ color: '#4a3a2a' }}><strong>Two-Piece Burkini</strong> – Top and pants combination, easy to wear</span></div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/></svg><span style={{ color: '#4a3a2a' }}><strong>One-Piece Burkini</strong> – All-in-one swimsuit with full coverage</span></div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/></svg><span style={{ color: '#4a3a2a' }}><strong>Swim Hijab</strong> – Matching head covering for complete set</span></div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/></svg><span style={{ color: '#4a3a2a' }}><strong>Plus Size Burkini</strong> – Extended sizing up to 4XL</span></div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/></svg><span style={{ color: '#4a3a2a' }}><strong>Kids Burkini</strong> – Modest swimwear for children</span></div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/></svg><span style={{ color: '#4a3a2a' }}><strong>Printed Burkini</strong> – Colorful patterns and designs</span></div>
            </div>

            <h3 style={{ fontSize: '24px', color: '#2c2418', margin: '35px 0 20px', fontWeight: 600 }}>Size Chart for Turkish Burkini</h3>
            <div style={{ background: 'white', borderRadius: '20px', padding: '30px', marginBottom: '35px', border: '1px solid #f0e6dc', boxShadow: '0 5px 20px rgba(0,0,0,0.03)' }}>
              <p style={{ textAlign: 'center', color: '#7a6a5a', marginBottom: '25px', fontSize: '14px' }}>Measurements in centimeters (cm) - Body measurements for swimwear fit</p>
              <div style={{ overflowX: 'auto' }}>
                <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'center' }}>
                  <thead><tr style={{ background: '#fef9f2', borderBottom: '2px solid #ff5a00' }}><th style={{ padding: '15px 10px', fontWeight: 700, color: '#2c2418' }}>Size</th><th style={{ padding: '15px 10px', fontWeight: 700, color: '#2c2418' }}>Bust (cm)</th><th style={{ padding: '15px 10px', fontWeight: 700, color: '#2c2418' }}>Waist (cm)</th><th style={{ padding: '15px 10px', fontWeight: 700, color: '#2c2418' }}>Hip (cm)</th><th style={{ padding: '15px 10px', fontWeight: 700, color: '#2c2418' }}>Tunic Length (cm)</th><th style={{ padding: '15px 10px', fontWeight: 700, color: '#2c2418' }}>US Size</th></tr></thead>
                  <tbody>
                    <tr style={{ borderBottom: '1px solid #f0e6dc' }}><td style={{ padding: '12px 10px', fontWeight: 600, color: '#ff5a00' }}>S/M</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>84-94</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>64-74</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>90-100</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>70-75</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>4-10</td></tr>
                    <tr style={{ borderBottom: '1px solid #f0e6dc', background: '#fef9f2' }}><td style={{ padding: '12px 10px', fontWeight: 600, color: '#ff5a00' }}>L/XL</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>94-104</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>74-84</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>100-110</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>70-75</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>12-18</td></tr>
                    <tr style={{ borderBottom: '1px solid #f0e6dc' }}><td style={{ padding: '12px 10px', fontWeight: 600, color: '#ff5a00' }}>2XL/3XL</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>104-116</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>84-96</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>110-120</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>70-75</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>20-26</td></tr>
                    <tr style={{ borderBottom: '1px solid #f0e6dc', background: '#fef9f2' }}><td style={{ padding: '12px 10px', fontWeight: 600, color: '#ff5a00' }}>4XL</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>116-124</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>96-104</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>120-128</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>70-75</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>28-32</td></tr>
                  </tbody>
                </table>
              </div>
              <p style={{ fontSize: '12px', color: '#a08c7a', textAlign: 'center', marginTop: '20px', fontStyle: 'italic' }}>*Burkini fabrics have stretch. For best fit, refer to product-specific size guides.</p>
            </div>

            <h3 style={{ fontSize: '24px', color: '#2c2418', margin: '35px 0 20px', fontWeight: 600 }}>Key Features of Turkish Burkini</h3>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '15px', marginBottom: '35px' }}>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>Quick-Dry:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>Dries rapidly after swimming</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>Chlorine Resistant:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>Maintains color and shape in pools</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>UV Protection:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>UPF 50+ rating on select styles</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>Full Coverage:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>Long sleeves, ankle-length pants</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>Lightweight:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>Does not weigh down in water</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>Flexible Fit:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>Stretch fabrics for comfort during movement</p></div>
            </div>

            <p style={{ fontSize: '16px', color: '#5a4a3a', lineHeight: '1.8', textAlign: 'justify', marginTop: '20px' }}>
              Turkish burkini offers practical solutions for women seeking modest swimwear options. These garments are 
              designed with <strong>quick-dry, chlorine-resistant fabrics</strong> that perform well in both pool and sea water. 
              The full-coverage design provides comfort and confidence during swimming and beach activities. Our wholesale 
              collection includes various sizes and styles to suit different preferences. Browse our burkini selection 
              and offer your customers functional, comfortable modest swimwear.
            </p>
          </div>
        </div>
      </section>

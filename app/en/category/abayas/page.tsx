...
export default function AbayasCategoryPage() {
  const params = useParams()
  
  // Page configuration for Abayas category
  const PAGE_CONFIG = {
    category: "Abayas",
    categoryName: "Abayas",
    pageTitle: "Wholesale Turkish Abayas | Modest Abaya Collection From Turkey",
    pageDescription: "Premium Turkish abayas wholesale. Wide collection of Medine silk, krep, and modern abayas. No minimum order, worldwide shipping. Join 5000+ retailers.",
    pageKeywords: "turkish abaya wholesale, abaya turkey, medine silk abaya, modest abaya wholesale, islamic abaya suppliers",
    h1: "Turkish Abayas Wholesale",
    subtitle: "Discover our premium collection of Turkish abayas. From classic Medine silk to modern designs, find the perfect abayas for your boutique at wholesale prices.",
    seoContent: {
      h2: "Wholesale Turkish Abayas – Premium Quality at Factory Prices",
      p1: "Welcome to Hijab Fashion Mall, your trusted source for authentic Turkish abayas. Our abaya collection features the finest craftsmanship with fabrics like Medine silk, known for its luxurious feel and elegant drape. Whether you're looking for classic black abayas, modern colored designs, or special occasion pieces, we have something for every boutique.",
      features: [
        "100% Original Turkish Manufacturing",
        "Premium Fabrics: Medine Silk, Krep, Nida",
        "Sizes from 42 to 58 (Plus Sizes Available)",
        "No Minimum Order Quantity",
        "Fast Worldwide Shipping (3-7 Days)",
        "Secure Payment Methods"
      ],
      popularStyles: "Medine Silk Abayas, Krep Abayas, Nida Abayas, Embroidered Abayas, Open Abayas, Kimono Style Abayas, and Prayer Abayas."
    }
  }
    ...
    <>
          ...
          <div className="stats-container">
            <div className="stats-info">
              <div className="stat-item">
                ...
                <span><strong>{totalProducts}</strong> Abaya Products</span>
              </div>
              <div className="stat-item">
      ...
      <section className="products-section">
        <div className="container">
          <div className="products-header">
            <h2>Our <span>Abaya</span> Collection</h2>
          ...
          {loading ? (
            <div className="no-products">
              ...
              <p>Please wait while we load our abaya collection.</p>
            </div>
          ) : products.length === 0 ? (
            <div className="no-products">
              <i className="fas fa-box-open"></i>
              <h3>No Products Found</h3>
              <p>We couldn't find any abaya products in this category. Please check back later.</p>
            ...
            <>
              <div className="products-grid">
                {products.map((product: any) => {
                  const name = product.name_en || product.name_ar || 'Abaya'
      ...
      <section className="seo-content">
        <div className="container">
          ...
          <h3>Why Choose Our Turkish Abayas?</h3>
          <ul>
          ...
          <p>Join over 5000+ satisfied retailers worldwide who trust us for their abaya collections. From small boutiques to large retailers, we provide consistent quality and reliable service. Browse our collection and place your inquiry today!</p>
          
          <p><strong>Popular Abaya Styles:</strong> {PAGE_CONFIG.seoContent.popularStyles}</p>
        </div>
      </section>
    </>
  )

...
export default function ModestSkirtSetsCategoryPage() {
  ...
  // Page configuration for Modest Skirt Sets category
  const PAGE_CONFIG = {
    category: "Modest Skirt Sets",
    categoryName: "Modest Skirt Sets",
    pageTitle: "Wholesale Modest Skirt Sets | Two Piece Skirt Sets | Long Skirt Outfits | Modest Skirt and Top Sets From Turkey",
    pageDescription: "Premium Turkish modest skirt sets wholesale. Wide collection of two-piece skirt and top sets, perfect for work, daily wear, and formal occasions. No minimum order, worldwide shipping. Join 5000+ retailers worldwide.",
    pageKeywords: "modest skirt sets wholesale, two piece skirt set, skirt and top set, long skirt outfits, turkish skirt sets wholesale, modest wear turkey, maxi skirt sets",
    h1: "Modest Skirt Sets – Elegant Two Piece Outfits",
    subtitle: "Discover our premium collection of Turkish modest skirt sets. From casual coordinates to formal two-piece outfits, find the perfect skirt sets for your boutique at wholesale prices.",
    seoContent: {
      h2: "Wholesale Modest Skirt Sets – Complete Two Piece Outfits",
      p1: "Welcome to Hijab Fashion Mall, your premier source for authentic Turkish modest skirt sets. Our collection features stylish two-piece coordinates that combine comfort and elegance. Each skirt and top set is designed to create a cohesive, sophisticated look perfect for work, daily outings, or special occasions.",
      features: [
        "100% Original Turkish Manufacturing",
        "Premium Fabrics: Crepe, Viscose, Cotton, Polyester, Linen Blends, Chiffon",
      ...
      popularStyles: "Maxi Skirt Sets, Midi Skirt Sets, A-Line Skirt Sets, Pleated Skirt Sets, Wrap Skirt Sets, Workwear Skirt Sets, Casual Skirt Sets, Formal Two Piece Skirt Outfits."
    }
  }
    ...
    <>
          ...
          <div className="stats-container">
            <div className="stats-info">
              <div className="stat-item">
                ...
                <span><strong>{totalProducts}</strong> Skirt Sets</span>
              </div>
              <div className="stat-item">
      ...
      <section className="products-section">
        <div className="container">
          <div className="products-header">
            <h2>Our <span>Modest Skirt Sets</span> Collection</h2>
          ...
          {loading ? (
            <div className="no-products">
              ...
              <p>Please wait while we load our modest skirt sets collection.</p>
            </div>
          ) : products.length === 0 ? (
            <div className="no-products">
              <i className="fas fa-box-open"></i>
              <h3>No Products Found</h3>
              <p>We couldn't find any modest skirt sets in this category. Please check back later.</p>
            ...
            <>
              <div className="products-grid">
                {products.map((product: any) => {
                  const name = product.name_en || product.name_ar || 'Modest Skirt Set'
      ...
      <section className="seo-content">
        <div className="container">
          ...
          <h3>Why Choose Our Turkish Modest Skirt Sets?</h3>
          <ul>
          ...
          <p>Join over 5000+ satisfied retailers worldwide who trust us for their modest skirt sets collections. From small boutiques to large retailers, we provide consistent quality and reliable service. Browse our collection and place your inquiry today!</p>
          
          <p><strong>Popular Skirt Set Styles:</strong> {PAGE_CONFIG.seoContent.popularStyles}</p>
        </div>
      </section>
    </>
  )

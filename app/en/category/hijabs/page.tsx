// app/en/category/hijab/page.tsx
'use client'
...
export default function HijabCategoryPage() {
  // Page configuration - Hijab
  const PAGE_CONFIG = {
    category: "Hijab",
    categoryName: "Hijabs",
    pageTitle: "Turkish Hijab Wholesale | Premium Hijabs & Scarves Collection | Hijab Fashion Mall",
    pageDescription: "Shop the best Turkish hijabs wholesale. Wide collection of chiffon, silk, cotton, and jersey hijabs. No minimum order, fast worldwide shipping.",
    pageKeywords: "turkish hijab wholesale, hijab wholesale, chiffon hijab, silk hijab, cotton hijab, jersey hijab, turkish scarf, shawl wholesale, modest fashion",
    h1: "Turkish Hijab Wholesale – Premium Quality Scarves & Hijabs",
    subtitle: "Discover our stunning collection of authentic Turkish hijabs. From luxurious chiffon to comfortable cotton, find the perfect hijabs for your store at wholesale prices.",
    seoContent: {
      h2: "Turkish Hijab Wholesale – Quality & Variety for Every Taste",
      p1: "Welcome to Hijab Fashion Mall, your premier source for authentic Turkish hijabs. Our collection features hijabs in various fabrics, colors, and designs. From premium chiffon hijabs to comfortable jersey styles, we offer hijabs suitable for all tastes and occasions.",
      features: [
      ...
      popularStyles: "Chiffon Hijab, Silk Hijab, Cotton Hijab, Jersey Hijab, Satin Hijab, Printed Hijab, Embroidered Hijab, Turkish Shawl, Crepe Hijab."
    }
  }
  ...
  // Add to cart with RSS and Carton support
    ...
    <>
          ...
          <div className="stats-container">
            <div className="stats-info">
              <div className="stat-item">
                ...
                <span><strong>{totalProducts}</strong> Hijabs</span>
              </div>
              <div className="stat-item">
      ...
      <section className="products-section">
        <div className="container">
          <div className="products-header">
            <h2>Premium <span>Turkish Hijabs</span></h2>
      ...
      <section className="seo-content">
        <div className="container">
          ...
          <p>Join over 5,000+ retailers worldwide who trust us for their hijab collections. From small boutiques to large retailers, we provide consistent quality and reliable service. Browse our collection and submit your inquiry today!</p>
          
          <p><strong>Popular Hijab Styles:</strong> {PAGE_CONFIG.seoContent.popularStyles}</p>
        </div>
      </section>
    </>
  )

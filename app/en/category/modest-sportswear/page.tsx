...
export default function ModestSportswearCategoryPageEn() {
  ...
  const getColorCode = useCallback((color: string) => {
    const colors: any = {
      ...
      'Taupe': '#8b7355', 'Charcoal': '#36454F', 'Dusty Rose': '#c9a0a8', 'Sky Blue': '#7bc5e8',
      'Teal': '#008080', 'Coral': '#ff7f50', 'Lavender': '#e6e6fa', 'Champagne': '#f7e7ce'
    }
    return colors[color] || '#CCCCCC'
  }, [])

  const getProductUrl = useCallback((product: any) => {
    if (product.slug_en) return `/en/product/${product.slug_en}`
    if (product.slug_fr) return `/en/product/${product.slug_fr}`
  ...
  if (loading && products.length === 0) return (
    <div style={{ padding: '100px 20px', textAlign: 'center', minHeight: '60vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
      ...
      `}</style>
      <p style={{ marginTop: '20px', color: '#555', fontSize: '16px' }}>Loading modest sportswear...</p>
    </div>
  )
  ...
  return (
    <>
      <Head>
        <title>Modest Sportswear Wholesale | Turkish Activewear, Gym Wear, Running Sets | Hijab Fashion Mall</title>
        <meta name="description" content={`Discover ${totalProducts}+ modest sportswear wholesale. Turkish activewear, gym sets, running outfits, yoga wear. Breathable fabrics, full coverage, moisture-wicking technology. Worldwide B2B shipping.`} />
        <meta name="keywords" content="modest sportswear wholesale, turkish activewear, modest gym wear, sports hijab, long sleeve workout tops, modest running sets, yoga wear modest, breathable sportswear, moisture wicking activewear, turkish sports clothing, fitness modest wear, exercise modest clothing" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://hijabfashionmall.com/en/category/modest-sportswear" />
        <link rel="alternate" href="https://hijabfashionmall.com/ar/category/modest-sportswear" hrefLang="ar" />
        <link rel="alternate" href="https://hijabfashionmall.com/en/category/modest-sportswear" hrefLang="en" />
        <link rel="alternate" href="https://hijabfashionmall.com/fr/category/modest-sportswear" hrefLang="fr" />
        <meta property="og:title" content="Turkish Modest Sportswear Wholesale Collection" />
        <meta property="og:description" content={`${totalProducts}+ activewear pieces. Breathable, moisture-wicking fabrics designed for comfort during physical activities.`} />
        <meta property="og:url" content="https://hijabfashionmall.com/en/category/modest-sportswear" />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://hijabfashionmall.com/images/og-modest-sportswear-en.jpg" />
      ...
      <section style={{ background: 'linear-gradient(135deg, #fdf8f2 0%, #ffffff 100%)', padding: '60px 0 40px', textAlign: 'center', borderBottom: '1px solid #f0e6dc', position: 'relative', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', fontSize: '160px', fontWeight: 800, color: 'rgba(255,90,0,0.03)', whiteSpace: 'nowrap', zIndex: 0, pointerEvents: 'none', fontFamily: 'Playfair Display, serif' }}>SPORTSWEAR</div>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px', position: 'relative', zIndex: 1 }}>
          <div style={{ fontSize: '14px', color: '#7a6a5a', marginBottom: '20px' }}>
            ...
            <Link href="/en/catalog" style={{ color: '#ff5a00', textDecoration: 'none' }}>Catalog</Link>
            <span style={{ color: '#7a6a5a', margin: '0 8px' }}>/</span>
            <span style={{ color: '#7a6a5a' }}>Modest Sportswear</span>
          </div>
          <h1 style={{ fontSize: '48px', color: '#2c2418', marginBottom: '15px', fontWeight: 800, lineHeight: '1.2', fontFamily: 'Playfair Display, serif' }}>
            Modest <span style={{ color: '#ff5a00' }}>Sportswear</span>
          </h1>
          <p style={{ fontSize: '18px', color: '#5a4a3a', maxWidth: '800px', margin: '0 auto', lineHeight: '1.6' }}>
            Discover our wholesale collection of Turkish modest sportswear. Breathable activewear 
            designed for comfort, movement, and coverage during all physical activities.
          </p>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '40px', marginTop: '40px', flexWrap: 'wrap' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>Gym & Training</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>Running & Yoga</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>Sports Hijab</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>Breathable Fabrics</span>
            </div>
          </div>
        </div>
      </section>
          ...
          <main>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '30px', flexWrap: 'wrap', gap: '15px', background: 'white', padding: '15px 25px', borderRadius: '20px', boxShadow: '0 5px 15px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
              <div style={{ color: '#5a4a3a', fontSize: '15px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                ...
                <span><span style={{ fontWeight: 600, color: '#ff5a00' }}>{totalProducts}</span> sportswear items</span>
                {totalProducts > 0 && <span style={{ marginLeft: '10px', color: '#a08c7a', fontSize: '13px' }}>({startIndex}-{endIndex})</span>}
              </div>
              <div style={{ display: 'flex', gap: '15px', alignItems: 'center', flexWrap: 'wrap' }}>
                <div style={{ position: 'relative' }}>
                  <input ref={searchInputRef} type="text" placeholder="Search by name, code, activity..." defaultValue={initialSearch} onChange={handleSearchChange} style={{ padding: '12px 18px 12px 42px', border: '2px solid #f0e6dc', borderRadius: '40px', fontSize: '14px', outline: 'none', width: '260px', background: 'white' }} onFocus={(e) => e.currentTarget.style.borderColor = '#ff5a00'} onBlur={(e) => e.currentTarget.style.borderColor = '#f0e6dc'} />
                ...
                {loading && products.length > 0 ? <LoadingSkeleton /> : (
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '25px', marginBottom: '50px' }}>
                    {products.map((p: any) => {
                      ...
                      const badges = []
                      if (p.is_new === 'Yes') badges.push(<span key="new" style={{ background: '#2d6a4f', color: 'white', padding: '4px 12px', borderRadius: '20px', fontSize: '11px', fontWeight: 600 }}>NEW</span>)
                      if (p.is_bestseller === 'Yes') badges.push(<span key="bestseller" style={{ background: '#ff5a00', color: 'white', padding: '4px 12px', borderRadius: '20px', fontSize: '11px', fontWeight: 600 }}>BESTSELLER</span>)
                      if (hasPlus) badges.push(<span key="plus" style={{ background: '#e86a2c', color: 'white', padding: '4px 12px', borderRadius: '20px', fontSize: '11px', fontWeight: 600 }}>PLUS SIZES</span>)

                      const activity = (p.name_en || '').toLowerCase()
                      let activityBadge = null
                      if (activity.includes('yoga')) activityBadge = <span style={{ background: '#2d6a4f', color: 'white', padding: '4px 12px', borderRadius: '20px', fontSize: '11px', fontWeight: 600 }}>YOGA</span>
                      else if (activity.includes('run') || activity.includes('running')) activityBadge = <span style={{ background: '#e86a2c', color: 'white', padding: '4px 12px', borderRadius: '20px', fontSize: '11px', fontWeight: 600 }}>RUNNING</span>
                      else if (activity.includes('gym') || activity.includes('training')) activityBadge = <span style={{ background: '#ff5a00', color: 'white', padding: '4px 12px', borderRadius: '20px', fontSize: '11px', fontWeight: 600 }}>GYM</span>
                      ...
                      return (
                        <Link href={getProductUrl(p)} key={p._id} style={{ background: 'white', borderRadius: '20px', overflow: 'hidden', boxShadow: '0 5px 20px rgba(0,0,0,0.05)', transition: 'all 0.3s', textDecoration: 'none', color: 'inherit', border: '1px solid #f0e6dc', display: 'block' }} onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-8px)'; e.currentTarget.style.boxShadow = '0 15px 30px rgba(255,90,0,0.12)'; e.currentTarget.style.borderColor = '#ff5a00' }} onMouseLeave={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 5px 20px rgba(0,0,0,0.05)'; e.currentTarget.style.borderColor = '#f0e6dc' }}>
                          <div style={{ position: 'relative', height: '280px', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, #fef9f2 0%, #faf5ed 100%)' }}>
                            <img src={p.imageUrl || '/images/default.webp'} alt={p.name_en || p.name_fr || p.name_ar || 'Sportswear'} style={{ maxWidth: '90%', maxHeight: '90%', objectFit: 'contain', transition: 'transform 0.5s' }} loading="lazy" onError={(e) => { (e.target as HTMLImageElement).src = '/images/default.webp' }} />
                            {badges.length > 0 && <div style={{ position: 'absolute', top: '15px', right: '15px', display: 'flex', gap: '6px', flexDirection: 'column' }}>{badges}</div>}
                            {activityBadge && <div style={{ position: 'absolute', bottom: '15px', left: '15px' }}>{activityBadge}</div>}
                          </div>
                          <div style={{ padding: '20px', textAlign: 'center' }}>
                            ...
                            <h3 style={{ fontSize: '15px', fontWeight: 600, color: '#2c2418', marginBottom: '8px', lineHeight: '1.4' }}>{p.name_en || p.name_fr || p.name_ar || ''}</h3>
                            <div style={{ fontSize: '11px', color: '#a08c7a', marginBottom: '12px', fontFamily: 'monospace' }}>{p.product_code || ''}</div>
                            {p.color_en || p.color_fr ? (
                              <div style={{ marginBottom: '12px' }}>
                                <div style={{ width: '24px', height: '24px', borderRadius: '50%', background: getColorCode(p.color_en || p.color_fr || ''), margin: '0 auto', border: '2px solid #fff', boxShadow: '0 2px 5px rgba(0,0,0,0.1)' }} title={p.color_en || p.color_fr} />
                              </div>
                            ) : null}
                            <div style={{ fontSize: '12px', color: isRSS ? '#2d6a4f' : '#e86a2c', marginBottom: '15px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '5px', padding: '5px 12px', background: isRSS ? 'rgba(45,106,79,0.1)' : 'rgba(232,106,44,0.1)', borderRadius: '30px', width: 'fit-content', margin: '0 auto 15px' }}>
                              ...
                              <span>{isRSS ? 'Single piece' : 'Packet'}</span>
                            </div>
      ...
      <section style={{ background: '#fef9f2', padding: '60px 0', borderTop: '1px solid #f0e6dc', marginTop: '40px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
          <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            <h2 style={{ fontSize: '32px', color: '#2c2418', marginBottom: '20px', fontWeight: 700, textAlign: 'center', fontFamily: 'Playfair Display, serif' }}>Turkish Modest Sportswear Collection</h2>
            <p style={{ fontSize: '16px', color: '#5a4a3a', lineHeight: '1.8', marginBottom: '25px', textAlign: 'justify' }}>
              Discover our collection of <strong>Turkish modest sportswear</strong>, designed for active women who require 
              coverage during physical activities. Our wholesale range features over <strong>{totalProducts} activewear pieces</strong> 
              including long-sleeve tops, full-length leggings, sports hijabs, and complete gym sets. These garments use 
              <strong>breathable, moisture-wicking fabrics</strong> that keep the body cool and dry during exercise while providing 
              the coverage needed for comfort and confidence.
            </p>
            
            <h3 style={{ fontSize: '24px', color: '#2c2418', margin: '35px 0 20px', fontWeight: 600 }}>Sportswear Categories Available Wholesale</h3>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '15px', marginBottom: '35px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/></svg><span style={{ color: '#4a3a2a' }}><strong>Gym Training Sets</strong> – Tops and leggings for strength training</span></div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/></svg><span style={{ color: '#4a3a2a' }}><strong>Running Outfits</strong> – Lightweight, breathable for cardio activities</span></div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/></svg><span style={{ color: '#4a3a2a' }}><strong>Yoga Wear</strong> – Stretchy, comfortable for flexibility</span></div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/></svg><span style={{ color: '#4a3a2a' }}><strong>Sports Hijabs</strong> – Secure fit, breathable fabric, quick-dry</span></div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/></svg><span style={{ color: '#4a3a2a' }}><strong>Long Sleeve Active Tops</strong> – Coverage with performance fabrics</span></div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/></svg><span style={{ color: '#4a3a2a' }}><strong>Full Length Leggings</strong> – Ankle-length, high-waisted options</span></div>
            </div>

            <h3 style={{ fontSize: '24px', color: '#2c2418', margin: '35px 0 20px', fontWeight: 600 }}>Size Chart for Turkish Sportswear</h3>
            <div style={{ background: 'white', borderRadius: '20px', padding: '30px', marginBottom: '35px', border: '1px solid #f0e6dc', boxShadow: '0 5px 20px rgba(0,0,0,0.03)' }}>
              <p style={{ textAlign: 'center', color: '#7a6a5a', marginBottom: '25px', fontSize: '14px' }}>Measurements in centimeters (cm) - Body measurements for athletic fit</p>
              <div style={{ overflowX: 'auto' }}>
                <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'center' }}>
                  <thead>
                    <tr style={{ background: '#fef9f2', borderBottom: '2px solid #ff5a00' }}>
                        <th style={{ padding: '15px 10px', fontWeight: 700, color: '#2c2418' }}>Size</th>
                        <th style={{ padding: '15px 10px', fontWeight: 700, color: '#2c2418' }}>Bust (cm)</th>
                        <th style={{ padding: '15px 10px', fontWeight: 700, color: '#2c2418' }}>Waist (cm)</th>
                        <th style={{ padding: '15px 10px', fontWeight: 700, color: '#2c2418' }}>Hip (cm)</th>
                        <th style={{ padding: '15px 10px', fontWeight: 700, color: '#2c2418' }}>Inseam (cm)</th>
                        <th style={{ padding: '15px 10px', fontWeight: 700, color: '#2c2418' }}>US Size</th>
                    </tr>
                    </thead>
                  <tbody>
                    <tr style={{ borderBottom: '1px solid #f0e6dc' }}><td style={{ padding: '12px 10px', fontWeight: 600, color: '#ff5a00' }}>XS/S</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>82-88</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>64-68</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>88-92</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>68-70</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>2-6</td></tr>
                    <tr style={{ borderBottom: '1px solid #f0e6dc', background: '#fef9f2' }}><td style={{ padding: '12px 10px', fontWeight: 600, color: '#ff5a00' }}>M</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>88-94</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>68-74</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>92-98</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>70-72</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>8-10</td></tr>
                    <tr style={{ borderBottom: '1px solid #f0e6dc' }}><td style={{ padding: '12px 10px', fontWeight: 600, color: '#ff5a00' }}>L</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>94-100</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>74-80</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>98-104</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>70-72</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>12-14</td></tr>
                    <tr style={{ borderBottom: '1px solid #f0e6dc', background: '#fef9f2' }}><td style={{ padding: '12px 10px', fontWeight: 600, color: '#ff5a00' }}>XL</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>100-106</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>80-86</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>104-110</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>70-72</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>16-18</td></tr>
                    <tr style={{ borderBottom: '1px solid #f0e6dc' }}><td style={{ padding: '12px 10px', fontWeight: 600, color: '#ff5a00' }}>2XL</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>106-112</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>86-92</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>110-116</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>70-72</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>20-22</td></tr>
                    <tr style={{ borderBottom: '1px solid #f0e6dc', background: '#fef9f2' }}><td style={{ padding: '12px 10px', fontWeight: 600, color: '#ff5a00' }}>3XL</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>112-118</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>92-98</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>116-122</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>70-72</td><td style={{ padding: '12px 10px', color: '#5a4a3a' }}>24-26</td></tr>
                  </tbody>
                </table>
              </div>
              <p style={{ fontSize: '12px', color: '#a08c7a', textAlign: 'center', marginTop: '20px', fontStyle: 'italic' }}>*Sportswear is designed with stretch fabrics. For best fit, order true to size.</p>
            </div>

            <h3 style={{ fontSize: '24px', color: '#2c2418', margin: '35px 0 20px', fontWeight: 600 }}>Key Features of Turkish Sportswear</h3>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '15px', marginBottom: '35px' }}>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>Moisture Wicking:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>Fabrics designed to pull sweat away from skin</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>Breathable:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>Mesh panels and lightweight materials for airflow</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>4-Way Stretch:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>Full range of motion during exercise</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>Flatlock Seams:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>Prevents chafing during movement</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>Quick Dry:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>Rapid evaporation after washing or sweating</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>Coverage:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>Long sleeves, high necks, full-length bottoms</p></div>
            </div>

            <p style={{ fontSize: '16px', color: '#5a4a3a', lineHeight: '1.8', textAlign: 'justify', marginTop: '20px' }}>
              Turkish modest sportswear combines performance fabric technology with coverage requirements for active women. 
              These garments are designed for <strong>gym training, running, yoga, and various sports activities</strong> while maintaining 
              comfort and breathability. The Turkish textile industry produces high-quality activewear using advanced 
              moisture-wicking and quick-dry technologies. Our wholesale collection includes options for different activity 
              levels and coverage preferences. Browse our sportswear selection and offer your customers functional, 
              comfortable modest activewear.
            </p>
          </div>
        </div>
      </section>

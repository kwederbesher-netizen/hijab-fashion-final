// app/de/category/modest-pants-sets/page.tsx
'use client'
...
export default function ModestPantsSetsCategoryPageDe() {
  ...
  return (
    <>
      <Head>
        <title>Hosen-Sets im Großhandel | 2-teilige Kombinationen | Hijab Fashion Mall</title>
        <meta name="description" content={`Entdecken Sie ${totalProducts}+ Hosen-Sets im Großhandel. 2-teilige Sets bestehend aus Hose und Oberteil. Lange Hosen, Weit geschnittene Hosen, Tunika-Kombinationen. Komfortable Business- und Freizeitmode. Weltweiter Versand.`} />
        <meta name="keywords" content="hosen sets großhandel, 2-teilige sets hose, lange hosen, weitere hosen, kombinationen hose oberteil, türkische hosenmode, business hosen sets, freizeit hosen sets, lässige kombinationen, bürokleidung hosen, palazzo hosen sets, tunika mit hose" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://hijabfashionmall.com/de/category/modest-pants-sets" />
        ...
        <link rel="alternate" href="https://hijabfashionmall.com/de/category/modest-pants-sets" hrefLang="de" />
        <meta property="og:title" content="Hosen-Sets Kollektion im Großhandel" />
        <meta property="og:description" content={`${totalProducts}+ Hosen-Set-Modelle. Perfekt abgestimmte Kombinationen.`} />
        <meta property="og:url" content="https://hijabfashionmall.com/de/category/modest-pants-sets" />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://hijabfashionmall.com/images/og-pantsets-de.jpg" />
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
          <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            ...
            <p style={{ fontSize: '16px', color: '#5a4a3a', lineHeight: '1.8', marginBottom: '25px', textAlign: 'justify' }}>
              Unsere Kollektion an Hosen-Sets umfasst <strong>{totalProducts} verschiedene Kombinationen</strong> bestehend aus Hose und passendem Oberteil. Diese Sets sind ideal für alle, die Wert auf einen stimmigen Look legen, ohne viel Zeit in die Zusammenstellung investieren zu müssen. Perfekt für den Beruf, die Freizeit oder Reisen.
            </p>
            <h3 style={{ fontSize: '24px', color: '#2c2418', margin: '35px 0 20px', fontWeight: 600 }}>Beliebte Hosen-Set-Varianten</h3>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '15px', marginBottom: '35px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5"/></svg><span style={{ color: '#4a3a2a' }}><strong>Business-Sets</strong> – Hose mit Bluse oder Hemd für das Büro</span></div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5"/></svg><span style={{ color: '#4a3a2a' }}><strong>Palazzo-Sets</strong> – Weite, fließende Hosen mit Tunika</span></div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5"/></svg><span style={{ color: '#4a3a2a' }}><strong>Reise-Sets</strong> – Knitterarme Stoffe für unterwegs</span></div>
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '15px', marginBottom: '35px' }}>
              ...
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>Leinen:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>Leicht, kühlend, ideal für warme Tage</p></div>
            </div>
            <p style={{ fontSize: '16px', color: '#5a4a3a', lineHeight: '1.8', textAlign: 'justify' }}>
              Unsere Hosen-Sets sind durchdacht zusammengestellt und bieten eine ideale Grundlage für vielseitige Outfits. Die Sets sind in den Größen S bis 4XL erhältlich. Bei Fragen zu unseren Produkten oder Großhandelskonditionen kontaktieren Sie uns gerne.
            </p>
          </div>
        </div>
      </section>

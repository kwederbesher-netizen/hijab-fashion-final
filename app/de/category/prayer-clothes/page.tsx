// app/de/category/prayer-clothes/page.tsx
'use client'
...
export default function PrayerClothesCategoryPageDe() {
  ...
  if (loading && products.length === 0) return (
    <div style={{ padding: '100px 20px', textAlign: 'center', minHeight: '60vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
      ...
      `}</style>
      <p style={{ marginTop: '20px', color: '#555', fontSize: '16px' }}>Gebetskleidung wird geladen...</p>
    </div>
  )
  ...
  return (
    <>
      <Head>
        <title>Gebetskleidung im Großhandel | Bequeme Gebetskleider Sets | Hijab Fashion Mall</title>
        <meta name="description" content={`Entdecken Sie ${totalProducts}+ Gebetskleidung im Großhandel. Bequeme Gebetskleider, 2-teilige Sets, weiche Stoffe. Ideal für den täglichen Gebrauch. Verschiedene Farben und Größen. Weltweiter Versand.`} />
        <meta name="keywords" content="gebetskleidung großhandel, gebetskleider, gebetskleid set, 2-teilige gebetskleidung, bequeme gebetskleidung, baumwolle gebetskleid, jersey gebetskleid, viskose gebetskleidung, gebetsoutfit, namaz kleidung, türkische gebetskleidung" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://hijabfashionmall.com/de/category/prayer-clothes" />
        ...
        <link rel="alternate" href="https://hijabfashionmall.com/de/category/prayer-clothes" hrefLang="de" />
        <meta property="og:title" content="Gebetskleidung Kollektion im Großhandel" />
        <meta property="og:description" content={`${totalProducts}+ Gebetskleid-Modelle für den täglichen Gebrauch.`} />
        <meta property="og:url" content="https://hijabfashionmall.com/de/category/prayer-clothes" />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://hijabfashionmall.com/images/og-prayer-de.jpg" />
      ...
      <section style={{ background: 'linear-gradient(135deg, #fdf8f2 0%, #ffffff 100%)', padding: '60px 0 40px', textAlign: 'center', borderBottom: '1px solid #f0e6dc', position: 'relative', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', fontSize: '200px', fontWeight: 800, color: 'rgba(255,90,0,0.03)', whiteSpace: 'nowrap', zIndex: 0, pointerEvents: 'none', fontFamily: 'Playfair Display, serif' }}>PRAYER</div>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px', position: 'relative', zIndex: 1 }}>
          <div style={{ fontSize: '14px', color: '#7a6a5a', marginBottom: '20px' }}>
            ...
            <span style={{ color: '#7a6a5a', margin: '0 8px' }}>/</span>
            <span style={{ color: '#7a6a5a' }}>Gebetskleidung</span>
          </div>
          <h1 style={{ fontSize: '48px', color: '#2c2418', marginBottom: '15px', fontWeight: 800, lineHeight: '1.2', fontFamily: 'Playfair Display, serif' }}>
            <span style={{ color: '#ff5a00' }}>Gebetskleidung</span> für den Alltag
          </h1>
          <p style={{ fontSize: '18px', color: '#5a4a3a', maxWidth: '800px', margin: '0 auto', lineHeight: '1.6' }}>
            Entdecken Sie unsere Kollektion bequemer Gebetskleidung im Großhandel. Weiche Stoffe, durchdachte Schnitte
            und angenehmer Tragekomfort für den täglichen Gebrauch.
          </p>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '40px', marginTop: '40px', flexWrap: 'wrap' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="1.8"><rect x="3" y="5" width="18" height="14" rx="2" stroke="currentColor" fill="none"/><path d="M7 5V3h10v2" stroke="currentColor"/></svg>
              </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>Baumwolle & Jersey</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <section style={{ maxWidth: '1200px', margin: '0 auto', padding: '20px 20px 0' }}>
        <div style={{ background: '#fef9f2', borderRadius: '24px', padding: '20px 25px', border: '1px solid #f0e6dc' }}>
          <h3 style={{ fontSize: '18px', color: '#2c2418', marginBottom: '15px', fontWeight: 600, display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            Größentabelle - Gebetskleidung (Türkische Passform)
          </h3>
          ...
          <p style={{ fontSize: '12px', color: '#a08c7a', marginTop: '12px', textAlign: 'center' }}>Gebetskleidung fällt oft großzügig aus für bequemen Sitz. Bei Unsicherheit normale Größe wählen.</p>
        </div>
      </section>
          ...
          <main>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '30px', flexWrap: 'wrap', gap: '15px', background: 'white', padding: '15px 25px', borderRadius: '20px', boxShadow: '0 5px 15px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
              <div style={{ color: '#5a4a3a', fontSize: '15px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                ...
                <span><span style={{ fontWeight: 600, color: '#ff5a00' }}>{totalProducts}</span> Gebetskleidung gelistet</span>
            ...
            {products.length === 0 ? (
              <div style={{ textAlign: 'center', padding: '80px 20px', background: 'white', borderRadius: '20px', boxShadow: '0 10px 30px rgba(0,0,0,0.05)', border: '1px solid #f0e6dc' }}>
                ...
                <h3 style={{ fontSize: '24px', color: '#2c2418', marginBottom: '10px', fontWeight: 600 }}>Keine Gebetskleidung gefunden</h3>
                ...
                {loading && products.length > 0 ? <LoadingSkeleton /> : (
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '25px', marginBottom: '50px' }}>
                    {products.map((p: any) => {
                      ...
                      if (fabric.includes('cotton') || fabric.includes('baumwolle')) fabricBadge = <span style={{ background: '#b87c4f', color: 'white', padding: '4px 12px', borderRadius: '20px', fontSize: '11px', fontWeight: 600 }}>BAUMWOLLE</span>
                      ...
                      else if (fabric.includes('viscose')) fabricBadge = <span style={{ background: '#d48c54', color: 'white', padding: '4px 12px', borderRadius: '20px', fontSize: '11px', fontWeight: 600 }}>VISKOSE</span>
                      else if (fabric.includes('modal')) fabricBadge = <span style={{ background: '#c98a60', color: 'white', padding: '4px 12px', borderRadius: '20px', fontSize: '11px', fontWeight: 600 }}>MODAL</span>
                      ...
                      return (
                        <Link href={getProductUrl(p)} key={p._id} style={{ background: 'white', borderRadius: '16px', overflow: 'hidden', boxShadow: '0 5px 20px rgba(0,0,0,0.05)', transition: 'all 0.3s', textDecoration: 'none', color: 'inherit', border: '1px solid #f0e6dc', display: 'block' }} onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-8px)'; e.currentTarget.style.boxShadow = '0 15px 30px rgba(255,90,0,0.12)'; e.currentTarget.style.borderColor = '#ff5a00'; }} onMouseLeave={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 5px 20px rgba(0,0,0,0.05)'; e.currentTarget.style.borderColor = '#f0e6dc'; }}>
                          <div style={{ position: 'relative', height: '280px', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, #fef9f2 0%, #faf5ed 100%)' }}>
                            <img src={p.imageUrl || '/images/default.webp'} alt={p.name_de || p.name_en || p.name_ar || 'Gebetskleidung'} style={{ maxWidth: '90%', maxHeight: '90%', objectFit: 'contain', transition: 'transform 0.5s' }} loading="lazy" onError={(e) => { (e.target as HTMLImageElement).src = '/images/default.webp' }} />
                          ...
                          <div style={{ padding: '20px', textAlign: 'center' }}>
                            <div style={{ fontSize: '11px', color: '#ff5a00', marginBottom: '8px', fontWeight: 500, textTransform: 'uppercase', letterSpacing: '1px' }}>Gebetskleidung</div>
      ...
      <section style={{ background: '#fef9f2', padding: '60px 0', borderTop: '1px solid #f0e6dc', marginTop: '40px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
          <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            <h2 style={{ fontSize: '32px', color: '#2c2418', marginBottom: '20px', fontWeight: 700, textAlign: 'center', fontFamily: 'Playfair Display, serif' }}>Bequeme Gebetskleidung für den täglichen Gebrauch</h2>
            <p style={{ fontSize: '16px', color: '#5a4a3a', lineHeight: '1.8', marginBottom: '25px', textAlign: 'justify' }}>
              Unsere Kollektion an Gebetskleidung umfasst <strong>{totalProducts} verschiedene Modelle</strong>, die speziell für angenehmen Tragekomfort entwickelt wurden. Die Kleidungsstücke bestehen aus weichen, hautfreundlichen Materialien und bieten ausreichend Bewegungsfreiheit. Ob als 2-teiliges Set oder als durchgehendes Kleid – jedes Stück ist durchdacht gestaltet.
            </p>
            <h3 style={{ fontSize: '24px', color: '#2c2418', margin: '35px 0 20px', fontWeight: 600 }}>Beliebte Gebetskleidung-Varianten</h3>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '15px', marginBottom: '35px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5"/></svg><span style={{ color: '#4a3a2a' }}><strong>2-teilige Sets</strong> – Kleid + Kopfbedeckung als Set</span></div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5"/></svg><span style={{ color: '#4a3a2a' }}><strong>Gebetskleider</strong> – Einteilige, lange Kleider</span></div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5"/></svg><span style={{ color: '#4a3a2a' }}><strong>Gebetsröcke</strong> – Kombinierbar mit eigener Bluse</span></div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5"/></svg><span style={{ color: '#4a3a2a' }}><strong>Kopfbedeckungen</strong> – Passende Khimare und Kopftücher</span></div>
            </div>
            <h3 style={{ fontSize: '24px', color: '#2c2418', margin: '35px 0 20px', fontWeight: 600 }}>Materialien und Pflege</h3>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '15px', marginBottom: '35px' }}>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>Baumwolle:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>Atmungsaktiv, hautfreundlich, pflegeleicht</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>Jersey:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>Dehnbar, knitterarm, angenehm weich</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>Viskose:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>Leicht, fließend, kühlend</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>Modal:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>Besonders weich, umweltfreundlich, formstabil</p></div>
            </div>
            <p style={{ fontSize: '16px', color: '#5a4a3a', lineHeight: '1.8', textAlign: 'justify' }}>
              Unsere Gebetskleidung wird mit Fokus auf Komfort und Langlebigkeit gefertigt. Die Größen reichen von S bis 4XL. Bei Fragen zu unseren Produkten oder Großhandelskonditionen kontaktieren Sie uns gerne.
            </p>
          </div>
        </div>
      </section>

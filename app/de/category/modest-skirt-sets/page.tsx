// app/de/category/modest-skirt-sets/page.tsx
'use client'
...
export default function ModestSkirtSetsCategoryPageDe() {
  ...
  if (loading && products.length === 0) return (
    <div style={{ padding: '100px 20px', textAlign: 'center', minHeight: '60vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
      ...
      `}</style>
      <p style={{ marginTop: '20px', color: '#555', fontSize: '16px' }}>Rock-Sets werden geladen...</p>
    </div>
  )
  ...
  return (
    <>
      <Head>
        <title>Rock-Sets im Großhandel | Modische 2-teilige Sets | Hijab Fashion Mall</title>
        <meta name="description" content={`Entdecken Sie ${totalProducts}+ Rock-Sets im Großhandel. 2-teilige Sets bestehend aus Rock und Oberteil. Lange Röcke, Kombinationen mit Bluse oder Tunika. Weltweiter Versand.`} />
        <meta name="keywords" content="rock sets großhandel, 2-teilige sets, lange röcke, rock und oberteil set, kombinierte sets, maxi rock sets, türkische mode sets, business sets mit rock, alltagsmode sets, bürokleidung sets, lässige rock sets, elegante kombinationen" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://hijabfashionmall.com/de/category/modest-skirt-sets" />
        ...
        <link rel="alternate" href="https://hijabfashionmall.com/de/category/modest-skirt-sets" hrefLang="de" />
        <meta property="og:title" content="Rock-Sets Kollektion im Großhandel" />
        <meta property="og:description" content={`${totalProducts}+ Rock-Set-Modelle. Perfekt abgestimmte Kombinationen.`} />
        <meta property="og:url" content="https://hijabfashionmall.com/de/category/modest-skirt-sets" />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://hijabfashionmall.com/images/og-skirtsets-de.jpg" />
      ...
      <section style={{ background: 'linear-gradient(135deg, #fdf8f2 0%, #ffffff 100%)', padding: '60px 0 40px', textAlign: 'center', borderBottom: '1px solid #f0e6dc', position: 'relative', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', fontSize: '200px', fontWeight: 800, color: 'rgba(255,90,0,0.03)', whiteSpace: 'nowrap', zIndex: 0, pointerEvents: 'none', fontFamily: 'Playfair Display, serif' }}>SKIRT SETS</div>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px', position: 'relative', zIndex: 1 }}>
          <div style={{ fontSize: '14px', color: '#7a6a5a', marginBottom: '20px' }}>
            ...
            <span style={{ color: '#7a6a5a', margin: '0 8px' }}>/</span>
            <span style={{ color: '#7a6a5a' }}>Rock-Sets</span>
          </div>
          <h1 style={{ fontSize: '48px', color: '#2c2418', marginBottom: '15px', fontWeight: 800, lineHeight: '1.2', fontFamily: 'Playfair Display, serif' }}>
            Rock-<span style={{ color: '#ff5a00' }}>Sets</span>
          </h1>
          <p style={{ fontSize: '18px', color: '#5a4a3a', maxWidth: '800px', margin: '0 auto', lineHeight: '1.6' }}>
            Entdecken Sie unsere Kollektion praktischer Rock-Sets im Großhandel. Perfekt abgestimmte Kombinationen aus Rock und Oberteil
            für einen stimmigen Look – ideal für Büro, Freizeit und besondere Anlässe.
          </p>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '40px', marginTop: '40px', flexWrap: 'wrap' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="1.8"><rect x="3" y="5" width="18" height="14" rx="2" stroke="currentColor" fill="none"/><path d="M8 5V3h8v2" stroke="currentColor"/></svg>
              </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>Lange Röcke</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>Tunika & Bluse</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <section style={{ maxWidth: '1200px', margin: '0 auto', padding: '20px 20px 0' }}>
        <div style={{ background: '#fef9f2', borderRadius: '24px', padding: '20px 25px', border: '1px solid #f0e6dc' }}>
          <h3 style={{ fontSize: '18px', color: '#2c2418', marginBottom: '15px', fontWeight: 600, display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            Größenübersicht - Rock-Sets (Türkische Passform)
          </h3>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '14px' }}>
              <thead>
                <tr style={{ background: '#fff0e6', borderBottom: '2px solid #ff5a00' }}>
                  ...
                  <th style={{ padding: '12px', textAlign: 'center', fontWeight: 600, color: '#2c2418' }}>Rocklänge (cm)</th>
                </tr>
              </thead>
              <tbody>
                {[
                  { size: 'S', bust: '86-90', waist: '66-70', hip: '90-94', length: '85' },
                  { size: 'M', bust: '90-94', waist: '70-74', hip: '94-98', length: '87' },
                  { size: 'L', bust: '94-98', waist: '74-78', hip: '98-102', length: '89' },
                  { size: 'XL', bust: '98-102', waist: '78-82', hip: '102-106', length: '91' },
                  { size: '2XL', bust: '102-106', waist: '82-86', hip: '106-110', length: '93' },
                  { size: '3XL', bust: '106-110', waist: '86-90', hip: '110-114', length: '95' },
                  { size: '4XL', bust: '110-114', waist: '90-94', hip: '114-118', length: '97' }
                ].map((row) => (
          ...
          <p style={{ fontSize: '12px', color: '#a08c7a', marginTop: '12px', textAlign: 'center' }}>Die Rocklänge kann je nach Modell variieren. Bei Unsicherheit wählen Sie bitte eine Nummer größer.</p>
        </div>
      </section>
          ...
          <main>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '30px', flexWrap: 'wrap', gap: '15px', background: 'white', padding: '15px 25px', borderRadius: '20px', boxShadow: '0 5px 15px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
              <div style={{ color: '#5a4a3a', fontSize: '15px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                ...
                <span><span style={{ fontWeight: 600, color: '#ff5a00' }}>{totalProducts}</span> Rock-Sets gelistet</span>
            ...
            {products.length === 0 ? (
              <div style={{ textAlign: 'center', padding: '80px 20px', background: 'white', borderRadius: '20px', boxShadow: '0 10px 30px rgba(0,0,0,0.05)', border: '1px solid #f0e6dc' }}>
                ...
                <h3 style={{ fontSize: '24px', color: '#2c2418', marginBottom: '10px', fontWeight: 600 }}>Keine Rock-Sets gefunden</h3>
                      ...
                      return (
                        <Link href={getProductUrl(p)} key={p._id} style={{ background: 'white', borderRadius: '16px', overflow: 'hidden', boxShadow: '0 5px 20px rgba(0,0,0,0.05)', transition: 'all 0.3s', textDecoration: 'none', color: 'inherit', border: '1px solid #f0e6dc', display: 'block' }} onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-8px)'; e.currentTarget.style.boxShadow = '0 15px 30px rgba(255,90,0,0.12)'; e.currentTarget.style.borderColor = '#ff5a00'; }} onMouseLeave={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 5px 20px rgba(0,0,0,0.05)'; e.currentTarget.style.borderColor = '#f0e6dc'; }}>
                          <div style={{ position: 'relative', height: '280px', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, #fef9f2 0%, #faf5ed 100%)' }}>
                            <img src={p.imageUrl || '/images/default.webp'} alt={p.name_de || p.name_en || p.name_ar || 'Rock-Set'} style={{ maxWidth: '90%', maxHeight: '90%', objectFit: 'contain', transition: 'transform 0.5s' }} loading="lazy" onError={(e) => { (e.target as HTMLImageElement).src = '/images/default.webp' }} />
                          ...
                          <div style={{ padding: '20px', textAlign: 'center' }}>
                            <div style={{ fontSize: '11px', color: '#ff5a00', marginBottom: '8px', fontWeight: 500, textTransform: 'uppercase', letterSpacing: '1px' }}>Rock-Set</div>
      ...
      <section style={{ background: '#fef9f2', padding: '60px 0', borderTop: '1px solid #f0e6dc', marginTop: '40px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
          <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            <h2 style={{ fontSize: '32px', color: '#2c2418', marginBottom: '20px', fontWeight: 700, textAlign: 'center', fontFamily: 'Playfair Display, serif' }}>Praktische Rock-Sets für jeden Tag</h2>
            <p style={{ fontSize: '16px', color: '#5a4a3a', lineHeight: '1.8', marginBottom: '25px', textAlign: 'justify' }}>
              Unsere Kollektion an Rock-Sets umfasst <strong>{totalProducts} verschiedene Kombinationen</strong> bestehend aus Rock und passendem Oberteil. Diese Sets sind ideal für alle, die Wert auf einen stimmigen Look legen, ohne viel Zeit in die Zusammenstellung investieren zu müssen. Perfekt für den Beruf, die Freizeit oder besondere Anlässe.
            </p>
            <h3 style={{ fontSize: '24px', color: '#2c2418', margin: '35px 0 20px', fontWeight: 600 }}>Beliebte Rock-Set-Varianten</h3>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '15px', marginBottom: '35px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5"/></svg><span style={{ color: '#4a3a2a' }}><strong>Business-Sets</strong> – Rock mit Bluse für das Büro</span></div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5"/></svg><span style={{ color: '#4a3a2a' }}><strong>Freizeit-Sets</strong> – Lässige Kombinationen für den Alltag</span></div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5"/></svg><span style={{ color: '#4a3a2a' }}><strong>Maxi-Rock Sets</strong> – Bodenlange Röcke mit Tunika</span></div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5"/></svg><span style={{ color: '#4a3a2a' }}><strong>Midi-Rock Sets</strong> – Knöchellange Röcke</span></div>
            </div>
            <h3 style={{ fontSize: '24px', color: '#2c2418', margin: '35px 0 20px', fontWeight: 600 }}>Materialien und Pflege</h3>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '15px', marginBottom: '35px' }}>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>Viskose:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>Leicht, fließend, atmungsaktiv</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>Jersey:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>Dehnbar, knitterarm, bequem</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>Baumwolle:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>Natürlich, hautfreundlich, pflegeleicht</p></div>
            </div>
            <p style={{ fontSize: '16px', color: '#5a4a3a', lineHeight: '1.8', textAlign: 'justify' }}>
              Unsere Rock-Sets sind durchdacht zusammengestellt und bieten eine ideale Grundlage für vielseitige Outfits. Die Sets sind in den Größen S bis 4XL erhältlich. Bei Fragen zu unseren Produkten oder Großhandelskonditionen kontaktieren Sie uns gerne.
            </p>
          </div>
        </div>
      </section>

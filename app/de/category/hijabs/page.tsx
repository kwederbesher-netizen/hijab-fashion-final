// app/de/category/hijabs/page.tsx
'use client'
...
export default function HijabsCategoryPageDe() {
  ...
  if (loading && products.length === 0) return (
    <div style={{ 
      ...
      `}</style>
      <p style={{ marginTop: '20px', color: '#555', fontSize: '16px' }}>Hijabs werden geladen...</p>
    </div>
  )
  ...
  return (
    <>
      <Head>
        <title>Türkische Hijabs im Großhandel | Premium Stoffe, Bambus, Viskose, Jersey | Hijab Fashion Mall</title>
        <meta name="description" content={`Entdecken Sie ${totalProducts}+ türkische Hijabs im Großhandel. Weicher Bambus, fließende Viskose, atmungsaktiver Jersey, edle Seide. Moderne Farben, verschiedene Größen. Weltweiter Versand für Geschäftskunden.`} />
        <meta name="keywords" content="türkische hijabs großhandel, hijab großhandel, bambus hijab, viskose hijab, jersey hijab, seide hijab, chiffon hijab, baumwoll hijab, hijab mit draht, square hijab, instant hijab, einfarbige hijabs, bedruckte hijabs, hijab kollektion 2026, hijab business, hijab einzelhandel, hijab verkauf großhandel, modal hijab" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://hijabfashionmall.com/de/category/hijabs" />
        ...
        <link rel="alternate" href="https://hijabfashionmall.com/de/category/hijabs" hrefLang="de" />
        
        <meta property="og:title" content="Türkische Hijab Kollektion im Großhandel - Bambus, Viskose & Jersey" />
        <meta property="og:description" content={`${totalProducts}+ Premium-Hijab-Modelle. Hochwertige Stoffe: Bambus, Viskose, Jersey, Seide. Für Fachleute der Modewelt.`} />
        <meta property="og:url" content="https://hijabfashionmall.com/de/category/hijabs" />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://hijabfashionmall.com/images/og-hijabs-de.jpg" />
      ...
      <section style={{
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px', position: 'relative', zIndex: 1 }}>
          ...
          <h1 style={{ 
            ...
            Türkische <span style={{ color: '#ff5a00' }}>Premium-Hijabs</span>
          </h1>
          <p style={{ fontSize: '18px', color: '#5a4a3a', maxWidth: '800px', margin: '0 auto', lineHeight: '1.6' }}>
            Entdecken Sie unsere Kollektion türkischer Hijabs im Großhandel. Hochwertige Tücher aus Bambus, 
            Viskose, Jersey und Seide für Damen, die Wert auf Qualität und Stil legen.
          </p>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>Bambus & Viskose</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{
                width: '44px',
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>Jersey & Seide</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{
                width: '44px',
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>Chiffon & Modal</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{
                width: '44px',
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>Mit oder ohne Draht</span>
            </div>
          </div>
        </div>
      </section>
          ...
          <main>
            ...
            <div style={{
              ...
              <div style={{ color: '#5a4a3a', fontSize: '15px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                ...
                <span><span style={{ fontWeight: 600, color: '#ff5a00' }}>{totalProducts}</span> Hijabs gelistet</span>
                {totalProducts > 0 && (
            ...
            {products.length === 0 ? (
              <div style={{
                ...
                <h3 style={{ fontSize: '24px', color: '#2c2418', marginBottom: '10px', fontWeight: 600 }}>Keine Hijabs gefunden</h3>
                        ...
                        >
                          <div style={{
                            ...
                            <img 
                              ...
                              alt={p.name_de || p.name_en || p.name_ar || 'Türkischer Hijab'}
                              style={{ 
                                maxWidth: '90%', 
                                maxHeight: '90%', 
                                objectFit: 'contain', 
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
          <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            <h2 style={{
              ...
              Vollständige Kollektion Türkischer Hijabs im Großhandel
            </h2>
            <p style={{
              fontSize: '16px',
              color: '#5a4a3a',
              ...
              Willkommen bei Hijab Fashion Mall, Ihrem <strong>vertrauenswürdigen Großhändler für türkische Hijabs</strong> seit 2019.
              Unsere Großhandelskollektion bietet über <strong>{totalProducts} Hijab-Modelle</strong>, die auf die Bedürfnisse von
              Einzelhändlern, Online-Shops und Fachleuten der Modewelt zugeschnitten sind. Wir wählen sorgfältig hochwertige
              Stoffe aus: <strong>weicher Bambus, fließende Viskose, atmungsaktiver Jersey, edle Seide und zarter Chiffon</strong>. 
              Jedes Tuch wird in spezialisierten türkischen Werkstätten gefertigt, die für ihre Qualität bekannt sind.
            </p>
            ...
            <h3 style={{
              ...
              Verfügbare Hijab-Typen im Großhandel
            </h3>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
                ...
                <span style={{ color: '#4a3a2a' }}><strong>Bambus-Hijab</strong> – Besonders weich, hautfreundlich, ideal für empfindliche Haut</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
                </svg>
                <span style={{ color: '#4a3a2a' }}><strong>Viskose-Hijab</strong> – Fließender Fall, leicht, perfekt für den täglichen Gebrauch</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
                </svg>
                <span style={{ color: '#4a3a2a' }}><strong>Jersey-Hijab</strong> – Dehnbar, knitterfrei, perfekt für unterwegs</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
                </svg>
                <span style={{ color: '#4a3a2a' }}><strong>Seiden-Hijab</strong> – Luxuriöser Glanz, ideal für besondere Anlässe</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
                </svg>
                <span style={{ color: '#4a3a2a' }}><strong>Chiffon-Hijab</strong> – Leicht, transparent, moderner Look</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
                </svg>
                <span style={{ color: '#4a3a2a' }}><strong>Modal-Hijab</strong> – Atmungsaktiv, geschmeidig, umweltfreundlich</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
                </svg>
                <span style={{ color: '#4a3a2a' }}><strong>Baumwoll-Hijab</strong> – Natürlich, saugfähig, perfekt für warme Tage</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
                </svg>
                <span style={{ color: '#4a3a2a' }}><strong>Hijab mit Draht</strong> – Eingearbeiteter Draht für perfekte Formgebung</span>
              </div>
            </div>
            ...
            <h3 style={{
              ...
              Technische Merkmale Türkischer Hijabs
            </h3>
            ...
            <div style={{
              ...
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                ...
                <p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>Bambus-Viskose, Jersey, Seide, Chiffon, Modal, Baumwolle</p>
              </div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <span style={{ fontWeight: 700, color: '#ff5a00' }}>Verfügbare Größen:</span>
                <p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>Square (110x110 cm, 115x115 cm), Instant Hijabs (Einheitsgröße)</p>
              </div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <span style={{ fontWeight: 700, color: '#ff5a00' }}>Farben:</span>
                <p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>Schwarz, Weiß, Beige, Nude, Rosé, Grau, Marineblau, Mint, Lavendel, mehr als 50 Farben</p>
              </div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <span style={{ fontWeight: 700, color: '#ff5a00' }}>Besonderheiten:</span>
                <p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>Mit/ohne Draht, bedruckte Modelle, einfarbige Basics, Näh- und Klebevarianten</p>
              </div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <span style={{ fontWeight: 700, color: '#ff5a00' }}>Pflege:</span>
                <p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>Maschinenwäsche 30°C, nicht bleichen, im Schatten trocknen</p>
              </div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <span style={{ fontWeight: 700, color: '#ff5a00' }}>Verpackung:</span>
                <p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>Einzelstück (RSS) oder Kartons mit 12/24/48 Stück je nach Modell</p>
              </div>
            </div>
            ...
            <h3 style={{
              ...
              Vorteile Türkischer Hijabs für Geschäftskunden
            </h3>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                ...
                <span style={{ color: '#4a3a2a' }}>Hochwertige Stoffe, hautfreundlich und atmungsaktiv</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
                </svg>
                <span style={{ color: '#4a3a2a' }}>Trendige Farben und Muster für jede Saison</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
                </svg>
                <span style={{ color: '#4a3a2a' }}>Wettbewerbsfähige Großhandelspreise</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
                </svg>
                <span style={{ color: '#4a3a2a' }}>Große Auswahl an neutralen und modernen Farben</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
                </svg>
                <span style={{ color: '#4a3a2a' }}>Möglichkeit zur Markenindividualisierung (Private Label)</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2">
                  <path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/>
                </svg>
                <span style={{ color: '#4a3a2a' }}>Schneller Versand in über 50 Länder weltweit</span>
              </div>
            </div>
            ...
            <p style={{
              ...
              <strong>Türkische Hijabs</strong> sind international bekannt für ihre hohe Verarbeitungsqualität, die hervorragenden Materialien
              und das moderne Farbangebot. Ob Sie klassische schwarze Basics, pastellige Frühlingsfarben, bedruckte Modelle
              oder Hijabs mit integriertem Draht suchen – unsere Großhandelskollektion bietet für jeden Geschmack und jedes Budget
              das passende Produkt. Wir führen sowohl <strong>Square Hijabs</strong> (110x110 cm, 115x115 cm) als auch 
              <strong>Instant Hijabs</strong> in verschiedenen Ausführungen. Durchstöbern Sie unsere Auswahl und erweitern Sie Ihr 
              Angebot mit hochwertigen türkischen Hijabs. Für Großhandelsbestellungen, Musteranfragen oder weitere Informationen 
              kontaktieren Sie unser Team via WhatsApp oder Telegram. Weltweiter Versand mit Sendungsverfolgung ist selbstverständlich.
            </p>
          </div>
        </div>
      </section>

// app/de/category/burkini/page.tsx
'use client'
...
export default function BurkiniCategoryPageDe() {
  ...
  const getColorCode = useCallback((color: string) => {
    const colors: any = {
      ...
      'Rose': '#e88c9a', 'Turquoise': '#40e0d0', 'Coral': '#ff7f50'
    }
  ...
  if (loading && products.length === 0) return (
    <div style={{ padding: '100px 20px', textAlign: 'center', minHeight: '60vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
      ...
      `}</style>
      <p style={{ marginTop: '20px', color: '#555', fontSize: '16px' }}>Burkinis werden geladen...</p>
    </div>
  )
  ...
  return (
    <>
      <Head>
        <title>Burkini im Großhandel | Modische Badebekleidung | Hijab Fashion Mall</title>
        <meta name="description" content={`Entdecken Sie ${totalProducts}+ Burkini-Modelle im Großhandel. Modische, bequeme Badebekleidung. Schnelltrocknende Materialien, UV-Schutz, verschiedene Größen. Ideal für Strand, Pool und Urlaub. Weltweiter Versand.`} />
        <meta name="keywords" content="burkini großhandel, burkini modelle, badebekleidung langarm, schwimmanzug mit kopfhaube, burkini 2-teilig, burkini 3-teilig, muslimische badebekleidung, uv-schutz badebekleidung, schnelltrocknende badebekleidung, burkini für den strand, burkini fürs schwimmbad, türkischer burkini" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://hijabfashionmall.com/de/category/burkini" />
        ...
        <link rel="alternate" href="https://hijabfashionmall.com/de/category/burkini" hrefLang="de" />
        <meta property="og:title" content="Burkini Kollektion im Großhandel" />
        <meta property="og:description" content={`${totalProducts}+ Burkini-Modelle für Strand und Schwimmbad.`} />
        <meta property="og:url" content="https://hijabfashionmall.com/de/category/burkini" />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://hijabfashionmall.com/images/og-burkini-de.jpg" />
      ...
      <section style={{ background: 'linear-gradient(135deg, #fdf8f2 0%, #ffffff 100%)', padding: '60px 0 40px', textAlign: 'center', borderBottom: '1px solid #f0e6dc', position: 'relative', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', fontSize: '200px', fontWeight: 800, color: 'rgba(255,90,0,0.03)', whiteSpace: 'nowrap', zIndex: 0, pointerEvents: 'none', fontFamily: 'Playfair Display, serif' }}>BURKINI</div>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px', position: 'relative', zIndex: 1 }}>
          ...
          <h1 style={{ fontSize: '48px', color: '#2c2418', marginBottom: '15px', fontWeight: 800, lineHeight: '1.2', fontFamily: 'Playfair Display, serif' }}>
            Modische <span style={{ color: '#ff5a00' }}>Burkinis</span> für Strand & Pool
          </h1>
          <p style={{ fontSize: '18px', color: '#5a4a3a', maxWidth: '800px', margin: '0 auto', lineHeight: '1.6' }}>
            Entdecken Sie unsere Kollektion modischer Burkinis im Großhandel. Bequeme, funktionale Badebekleidung
            mit UV-Schutz und schnelltrocknenden Materialien für unbeschwerten Badespaß.
          </p>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '40px', marginTop: '40px', flexWrap: 'wrap' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="1.8"><path d="M3 10h18v8H3z" stroke="currentColor" fill="none"/><path d="M8 10V6h8v4" stroke="currentColor"/></svg>
              </div>
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>2-3 teilige Sets</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>UV-Schutz</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>Schnelltrocknend</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <section style={{ maxWidth: '1200px', margin: '0 auto', padding: '20px 20px 0' }}>
        <div style={{ background: '#fef9f2', borderRadius: '24px', padding: '20px 25px', border: '1px solid #f0e6dc' }}>
          <h3 style={{ fontSize: '18px', color: '#2c2418', marginBottom: '15px', fontWeight: 600, display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            Größentabelle - Burkini (Türkische Passform)
          </h3>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '14px' }}>
              <thead>
                <tr style={{ background: '#fff0e6', borderBottom: '2px solid #ff5a00' }}>
                  ...
                  <th style={{ padding: '12px', textAlign: 'center', fontWeight: 600, color: '#2c2418' }}>Konfektion</th>
                </tr>
              </thead>
              <tbody>
                {[
                  { size: 'S', bust: '84-88', waist: '64-68', hip: '88-92', fit: '34/36' },
                  { size: 'M', bust: '88-92', waist: '68-72', hip: '92-96', fit: '38/40' },
                  { size: 'L', bust: '92-96', waist: '72-76', hip: '96-100', fit: '42/44' },
                  { size: 'XL', bust: '96-100', waist: '76-80', hip: '100-104', fit: '46/48' },
                  { size: '2XL', bust: '100-104', waist: '80-84', hip: '104-108', fit: '50/52' },
                  { size: '3XL', bust: '104-108', waist: '84-88', hip: '108-112', fit: '54/56' }
                ].map((row) => (
                  <tr key={row.size} style={{ borderBottom: '1px solid #f0e6dc' }}>
                    ...
                    <td style={{ padding: '10px', textAlign: 'center', color: '#5a4a3a' }}>{row.fit}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          </div>
          <p style={{ fontSize: '12px', color: '#a08c7a', marginTop: '12px', textAlign: 'center' }}>Burkinis sollten bequem sitzen, aber nicht zu locker sein. Bei Unsicherheit normale Konfektionsgröße wählen.</p>
        </div>
      </section>
          ...
          <main>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '30px', flexWrap: 'wrap', gap: '15px', background: 'white', padding: '15px 25px', borderRadius: '20px', boxShadow: '0 5px 15px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
              <div style={{ color: '#5a4a3a', fontSize: '15px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                ...
                <span><span style={{ fontWeight: 600, color: '#ff5a00' }}>{totalProducts}</span> Burkinis gelistet</span>
                {totalProducts > 0 && <span style={{ marginLeft: '10px', color: '#a08c7a', fontSize: '13px' }}>({startIndex}-{endIndex})</span>}
              </div>
              <div style={{ display: 'flex', gap: '15px', alignItems: 'center', flexWrap: 'wrap' }}>
                <div style={{ position: 'relative' }}>
                  <input ref={searchInputRef} type="text" placeholder="Suche nach Name, Code, Farbe..." defaultValue={initialSearch} onChange={handleSearchChange} style={{ padding: '12px 18px 12px 42px', border: '2px solid #f0e6dc', borderRadius: '40px', fontFamily: 'Poppins, sans-serif', fontSize: '14px', outline: 'none', width: '260px', background: 'white' }} onFocus={(e) => e.currentTarget.style.borderColor = '#ff5a00'} onBlur={(e) => e.currentTarget.style.borderColor = '#f0e6dc'} />
            ...
            {products.length === 0 ? (
              <div style={{ textAlign: 'center', padding: '80px 20px', background: 'white', borderRadius: '20px', boxShadow: '0 10px 30px rgba(0,0,0,0.05)', border: '1px solid #f0e6dc' }}>
                ...
                <h3 style={{ fontSize: '24px', color: '#2c2418', marginBottom: '10px', fontWeight: 600 }}>Keine Burkinis gefunden</h3>
                ...
                {loading && products.length > 0 ? <LoadingSkeleton /> : (
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '25px', marginBottom: '50px' }}>
                    {products.map((p: any) => {
                      ...
                      const style = (p.name_en || '').toLowerCase()
                      let styleBadge = null
                      if (style.includes('2-teilig') || style.includes('2 teilig')) styleBadge = <span style={{ background: '#b87c4f', color: 'white', padding: '4px 12px', borderRadius: '20px', fontSize: '11px', fontWeight: 600 }}>2-TEILIG</span>
                      else if (style.includes('3-teilig') || style.includes('3 teilig')) styleBadge = <span style={{ background: '#d48c54', color: 'white', padding: '4px 12px', borderRadius: '20px', fontSize: '11px', fontWeight: 600 }}>3-TEILIG</span>
                      else if (style.includes('mit kopfhaube')) styleBadge = <span style={{ background: '#a06e42', color: 'white', padding: '4px 12px', borderRadius: '20px', fontSize: '11px', fontWeight: 600 }}>MIT KOPFHAUBE</span>
                      ...
                      return (
                        <Link href={getProductUrl(p)} key={p._id} style={{ background: 'white', borderRadius: '16px', overflow: 'hidden', boxShadow: '0 5px 20px rgba(0,0,0,0.05)', transition: 'all 0.3s', textDecoration: 'none', color: 'inherit', border: '1px solid #f0e6dc', display: 'block' }} onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-8px)'; e.currentTarget.style.boxShadow = '0 15px 30px rgba(255,90,0,0.12)'; e.currentTarget.style.borderColor = '#ff5a00'; }} onMouseLeave={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 5px 20px rgba(0,0,0,0.05)'; e.currentTarget.style.borderColor = '#f0e6dc'; }}>
                          <div style={{ position: 'relative', height: '280px', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, #fef9f2 0%, #faf5ed 100%)' }}>
                            <img src={p.imageUrl || '/images/default.webp'} alt={p.name_de || p.name_en || p.name_ar || 'Burkini'} style={{ maxWidth: '90%', maxHeight: '90%', objectFit: 'contain', transition: 'transform 0.5s' }} loading="lazy" onError={(e) => { (e.target as HTMLImageElement).src = '/images/default.webp' }} />
                            {badges.length > 0 && <div style={{ position: 'absolute', top: '15px', right: '15px', display: 'flex', gap: '6px', flexDirection: 'column' }}>{badges}</div>}
                            {styleBadge && <div style={{ position: 'absolute', bottom: '15px', left: '15px' }}>{styleBadge}</div>}
                          </div>
                          <div style={{ padding: '20px', textAlign: 'center' }}>
      ...
      <section style={{ background: '#fef9f2', padding: '60px 0', borderTop: '1px solid #f0e6dc', marginTop: '40px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
          <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            <h2 style={{ fontSize: '32px', color: '#2c2418', marginBottom: '20px', fontWeight: 700, textAlign: 'center', fontFamily: 'Playfair Display, serif' }}>Modische Burkinis für Strand und Schwimmbad</h2>
            <p style={{ fontSize: '16px', color: '#5a4a3a', lineHeight: '1.8', marginBottom: '25px', textAlign: 'justify' }}>
              Unsere Kollektion an Burkinis umfasst <strong>{totalProducts} verschiedene Modelle</strong> für unbeschwerten Badespaß. Die Burkinis bestehen aus hochwertigen, schnelltrocknenden Materialien mit integriertem UV-Schutz. Ob als 2-teiliges oder 3-teiliges Set – jedes Modell bietet Komfort und Bewegungsfreiheit im Wasser.
            </p>
            <h3 style={{ fontSize: '24px', color: '#2c2418', margin: '35px 0 20px', fontWeight: 600 }}>Beliebte Burkini-Varianten</h3>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '15px', marginBottom: '35px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5"/></svg><span style={{ color: '#4a3a2a' }}><strong>2-teilige Burkinis</strong> – Oberteil + Hose mit Kopfhaube</span></div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5"/></svg><span style={{ color: '#4a3a2a' }}><strong>3-teilige Burkinis</strong> – Oberteil, Hose, Kopfbedeckung</span></div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5"/></svg><span style={{ color: '#4a3a2a' }}><strong>Burkinis mit Rock</strong> – Weiterer Schnitt für mehr Bewegungsfreiheit</span></div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5"/></svg><span style={{ color: '#4a3a2a' }}><strong>Burkinis mit Reißverschluss</strong> – Praktisch für einfaches An- und Ausziehen</span></div>
            </div>
            <h3 style={{ fontSize: '24px', color: '#2c2418', margin: '35px 0 20px', fontWeight: 600 }}>Materialien und Eigenschaften</h3>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '15px', marginBottom: '35px' }}>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>Polyester / Elasthan:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>Schnelltrocknend, chlorresistent, formstabil</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>UV-Schutz:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>Integrierter UV-Schutz UPF 50+ für sicheren Sonnenschutz</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>Chlorresistent:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>Materialien, die auch nach häufigem Schwimmbadbesuch ihre Form behalten</p></div>
              <div style={{ padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}><span style={{ fontWeight: 700, color: '#ff5a00' }}>Schnelltrocknend:</span><p style={{ color: '#4a3a2a', marginTop: '5px', fontSize: '14px' }}>Spezielle Gewebe für schnelle Trocknung nach dem Baden</p></div>
            </div>
            <p style={{ fontSize: '16px', color: '#5a4a3a', lineHeight: '1.8', textAlign: 'justify' }}>
              Unsere Burkinis werden mit Fokus auf Komfort und Funktionalität gefertigt. Die Größen reichen von S bis 3XL. Bei Fragen zu unseren Produkten oder Großhandelskonditionen kontaktieren Sie uns gerne.
            </p>
          </div>
        </div>
      </section>

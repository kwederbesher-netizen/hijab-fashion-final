// app/it/category/modest-sportswear/page.tsx
'use client'
...
export default function ModestSportswearCategoryPageIt() {
  ...
  return (
    <>
      <Head>
        <title>Abbigliamento Sportivo Modesto all'Ingrosso | Tuta Sportiva Turca | Hijab Fashion Mall</title>
        <meta name="description" content={`Scopri ${totalProducts}+ capi di abbigliamento sportivo modesto all'ingrosso. Tute sportive, felpe, leggings coprenti. Tessuti tecnici traspiranti. Taglie S-3XL.`} />
        <meta name="keywords" content="abbigliamento sportivo modesto all'ingrosso, tuta sportiva turca, felpa sportiva donna, leggings lunghi, top sportivo maniche lunghe, abbigliamento fitness modesto, tuta palestra donna, sportswear turco, activewear modesto, abbigliamento yoga, running donna, wholesale sportswear, tessuto tecnico traspirante" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://hijabfashionmall.com/it/category/modest-sportswear" />
        ...
        <link rel="alternate" href="https://hijabfashionmall.com/it/category/modest-sportswear" hrefLang="it" />
        
        <meta property="og:title" content="Abbigliamento Sportivo Modesto all'Ingrosso - Tuta Sportiva Turca" />
        <meta property="og:description" content={`${totalProducts}+ modelli di sportswear modesto. Tessuti tecnici traspiranti.`} />
        <meta property="og:url" content="https://hijabfashionmall.com/it/category/modest-sportswear" />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://hijabfashionmall.com/images/og-sportswear-it.jpg" />
      ...
      <section style={{ background: 'linear-gradient(135deg, #fdf8f2 0%, #ffffff 100%)', padding: '60px 0 40px', textAlign: 'center', borderBottom: '1px solid #f0e6dc', position: 'relative', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', fontSize: '150px', fontWeight: 800, color: 'rgba(255,90,0,0.03)', whiteSpace: 'nowrap', zIndex: 0, pointerEvents: 'none', fontFamily: 'Playfair Display, serif' }}>SPORTSWEAR</div>

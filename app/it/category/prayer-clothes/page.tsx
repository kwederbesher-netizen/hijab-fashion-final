// app/it/category/prayer-clothes/page.tsx
'use client'
...
export default function PrayerClothesCategoryPageIt() {
    ...
    return (
      <div style={{
        ...
        <table style={{
          ...
          <tbody>
            {[
              { taglia: 'S', busto: '84-88', vita: '66-70', fianchi: '92-96', lunghezza: '135-140' },
              { taglia: 'M', busto: '88-92', vita: '70-74', fianchi: '96-100', lunghezza: '137-142' },
              { taglia: 'L', busto: '92-96', vita: '74-78', fianchi: '100-104', lunghezza: '139-144' },
              { taglia: 'XL', busto: '96-100', vita: '78-82', fianchi: '104-108', lunghezza: '141-146' },
              { taglia: '2XL', busto: '100-104', vita: '82-86', fianchi: '108-112', lunghezza: '143-148' },
              { taglia: '3XL', busto: '104-108', vita: '86-90', fianchi: '112-116', lunghezza: '145-150' },
            ].map((size, idx) => (
        ...
        <p style={{
          ...
          ⚠️ La vestibilità è regolare. Si consiglia di scegliere la taglia abituale.
        </p>
      </div>
    )
  }
  ...
  if (loading && products.length === 0) return (
    <div style={{ padding: '100px 20px', textAlign: 'center', minHeight: '60vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <p style={{ marginTop: '20px', color: '#555', fontSize: '16px' }}>Caricamento abbigliamento preghiera...</p>
    </div>
  )
  ...
  return (
    <>
      <Head>
        <title>Abbigliamento per la Preghiera all'Ingrosso | Jilbab Turco | Hijab Fashion Mall</title>
        <meta name="description" content={`Scopri ${totalProducts}+ capi di abbigliamento per la preghiera all'ingrosso. Jilbab, tunica lunga, gonna ampia. Tessuti: jersey, crêpe, cotone. Taglie S-3XL.`} />
        <meta name="keywords" content="abbigliamento preghiera all'ingrosso, jilbab turco, tunica lunga preghiera, gonna lunga preghiera, set preghiera donna, abito preghiera, hijab preghiera, wholesale prayer clothes, jilbab all'ingrosso, abbigliamento religioso, tunica preghiera, gonna lunga coprente, set completo preghiera" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://hijabfashionmall.com/it/category/prayer-clothes" />
        ...
        <link rel="alternate" href="https://hijabfashionmall.com/it/category/prayer-clothes" hrefLang="it" />
        
        <meta property="og:title" content="Abbigliamento per la Preghiera all'Ingrosso - Jilbab Turco" />
        <meta property="og:description" content={`${totalProducts}+ modelli di abbigliamento per la preghiera. Tessuti comodi e pratici.`} />
        <meta property="og:url" content="https://hijabfashionmall.com/it/category/prayer-clothes" />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://hijabfashionmall.com/images/og-prayer-it.jpg" />
      ...
      <section style={{ background: 'linear-gradient(135deg, #fdf8f2 0%, #ffffff 100%)', padding: '60px 0 40px', textAlign: 'center', borderBottom: '1px solid #f0e6dc', position: 'relative', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', fontSize: '150px', fontWeight: 800, color: 'rgba(255,90,0,0.03)', whiteSpace: 'nowrap', zIndex: 0, pointerEvents: 'none', fontFamily: 'Playfair Display, serif' }}>PRAYER</div>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px', position: 'relative', zIndex: 1 }}>
          <div style={{ fontSize: '14px', color: '#7a6a5a', marginBottom: '20px' }}>
            ...
            <span style={{ color: '#7a6a5a', margin: '0 8px' }}>/</span>
            <span style={{ color: '#7a6a5a' }}>Abbigliamento Preghiera</span>
          </div>
          <h1 style={{ fontSize: '48px', color: '#2c2418', marginBottom: '15px', fontWeight: 800, lineHeight: '1.2', fontFamily: 'Playfair Display, serif' }}>
            Abbigliamento per la <span style={{ color: '#ff5a00' }}>Preghiera</span> all'Ingrosso
          </h1>
          <p style={{ fontSize: '18px', color: '#5a4a3a', maxWidth: '800px', margin: '0 auto', lineHeight: '1.6' }}>
            Scopri la nostra collezione di abbigliamento per la preghiera all'ingrosso. Jilbab, tuniche lunghe e gonne 
            realizzati con tessuti comodi e pratici.
          </p>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '40px', marginTop: '40px', flexWrap: 'wrap' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>Jilbab e Tunica</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>Jersey & Crêpe</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>Colori Basic</span>
            </div>
          </div>
        </div>
      </section>
          ...
          <main>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '30px', flexWrap: 'wrap', gap: '15px', background: 'white', padding: '15px 25px', borderRadius: '20px', boxShadow: '0 5px 15px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
              <div style={{ color: '#5a4a3a', fontSize: '15px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                ...
                <span><span style={{ fontWeight: 600, color: '#ff5a00' }}>{totalProducts}</span> capi preghiera</span>
            ...
            {products.length === 0 ? (
              <div style={{ textAlign: 'center', padding: '80px 20px', background: 'white', borderRadius: '20px', boxShadow: '0 10px 30px rgba(0,0,0,0.05)', border: '1px solid #f0e6dc' }}>
                ...
                <h3 style={{ fontSize: '24px', color: '#2c2418', marginBottom: '10px', fontWeight: 600 }}>Nessun capo preghiera trovato</h3>
                ...
                {loading && products.length > 0 ? <LoadingSkeleton /> : (
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '25px', marginBottom: '50px' }}>
                    {products.map((p: any) => {
                      ...
                      if (fabric.includes('jersey')) fabricBadge = <span style={{ background: '#a06e42', color: 'white', padding: '4px 12px', borderRadius: '20px', fontSize: '11px', fontWeight: 600 }}>JERSEY</span>
                      ...
                      else if (fabric.includes('cotton')) fabricBadge = <span style={{ background: '#b87c4f', color: 'white', padding: '4px 12px', borderRadius: '20px', fontSize: '11px', fontWeight: 600 }}>COTONE</span>
                      ...
                      return (
                        <Link href={getProductUrl(p)} key={p._id} style={{ background: 'white', borderRadius: '16px', overflow: 'hidden', boxShadow: '0 5px 20px rgba(0,0,0,0.05)', transition: 'all 0.3s', textDecoration: 'none', color: 'inherit', border: '1px solid #f0e6dc', display: 'block' }} onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-8px)'; e.currentTarget.style.boxShadow = '0 15px 30px rgba(255,90,0,0.12)'; e.currentTarget.style.borderColor = '#ff5a00'; }} onMouseLeave={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 5px 20px rgba(0,0,0,0.05)'; e.currentTarget.style.borderColor = '#f0e6dc'; }}>
                          <div style={{ position: 'relative', height: '280px', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, #fef9f2 0%, #faf5ed 100%)' }}>
                            <img src={p.imageUrl || '/images/default.webp'} alt={p.name_it || p.name_en || p.name_ar || 'Abbigliamento preghiera turco'} style={{ maxWidth: '90%', maxHeight: '90%', objectFit: 'contain', transition: 'transform 0.5s' }} loading="lazy" onError={(e) => { (e.target as HTMLImageElement).src = '/images/default.webp' }} />
                          ...
                          <div style={{ padding: '20px', textAlign: 'center' }}>
                            <div style={{ fontSize: '11px', color: '#ff5a00', marginBottom: '8px', fontWeight: 500, textTransform: 'uppercase', letterSpacing: '1px' }}>Abbigliamento Preghiera</div>
      ...
      <section style={{ background: '#fef9f2', padding: '60px 0', borderTop: '1px solid #f0e6dc', marginTop: '40px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
          <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            <h2 style={{ fontSize: '32px', color: '#2c2418', marginBottom: '20px', fontWeight: 700, textAlign: 'center', fontFamily: 'Playfair Display, serif' }}>Abbigliamento per la Preghiera Turco all'Ingrosso</h2>
            <p style={{ fontSize: '16px', color: '#5a4a3a', lineHeight: '1.8', marginBottom: '25px', textAlign: 'justify' }}>
              Hijab Fashion Mall offre una selezione di <strong>abbigliamento per la preghiera all'ingrosso</strong> con oltre <strong>{totalProducts} modelli</strong> disponibili. 
              Jilbab, tuniche lunghe e gonne ampie in tessuti jersey, crêpe e cotone.
            </p>
            
            <h3 style={{ fontSize: '24px', color: '#2c2418', margin: '35px 0 20px', fontWeight: 600 }}>Tipologie di Abbigliamento Disponibili</h3>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '15px', marginBottom: '35px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                ...
                <span style={{ color: '#4a3a2a' }}><strong>Jilbab</strong> – Tunica lunga con cappuccio</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/></svg>
                <span style={{ color: '#4a3a2a' }}><strong>Tunica Lunga</strong> – Modello semplice e pratico</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/></svg>
                <span style={{ color: '#4a3a2a' }}><strong>Gonna Lunga</strong> – Gonna ampia e comoda</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/></svg>
                <span style={{ color: '#4a3a2a' }}><strong>Set Completo</strong> – Tunica + gonna coordinata</span>
              </div>
            </div>

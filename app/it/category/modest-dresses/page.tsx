// app/it/category/modest-dresses/page.tsx
'use client'
...
export default function ModestDressesCategoryPageIt() {
  ...
  const getColorCode = useCallback((color: string) => {
    const colors: any = {
      ...
      'Rose': '#e88c9a', 'Camel': '#c19a6b', 'Terracotta': '#e2725b', 'Sage Green': '#9cae8c'
    }
    ...
    return (
      <div style={{
        ...
        <h4 style={{
          ...
          Guida Taglie - Abiti Modesti Turchi
        </h4>
        <table style={{
          width: '100%',
          ...
          <tbody>
            {[
              { it: 'XS', tr: '34', busto: '80-84', vita: '62-66', fianchi: '88-92', lunghezza: '135-140' },
              { it: 'S', tr: '36', busto: '84-88', vita: '66-70', fianchi: '92-96', lunghezza: '137-142' },
              { it: 'M', tr: '38', busto: '88-92', vita: '70-74', fianchi: '96-100', lunghezza: '139-144' },
              { it: 'L', tr: '40', busto: '92-96', vita: '74-78', fianchi: '100-104', lunghezza: '141-146' },
              { it: 'XL', tr: '42', busto: '96-100', vita: '78-82', fianchi: '104-108', lunghezza: '143-148' },
              { it: '2XL', tr: '44', busto: '100-104', vita: '82-86', fianchi: '108-112', lunghezza: '145-150' },
              { it: '3XL', tr: '46', busto: '104-108', vita: '86-90', fianchi: '112-116', lunghezza: '147-152' },
              { it: '4XL', tr: '48', busto: '108-112', vita: '90-94', fianchi: '116-120', lunghezza: '149-154' },
            ].map((size, idx) => (
        ...
        <p style={{
          ...
          ⚠️ Le misure sono indicative e possono variare di 1-2 cm a seconda del modello e del tessuto.
        </p>
      </div>
    )
  }
  ...
  if (loading && products.length === 0) return (
    <div style={{ padding: '100px 20px', textAlign: 'center', minHeight: '60vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <p style={{ marginTop: '20px', color: '#555', fontSize: '16px' }}>Caricamento abiti modesti...</p>
    </div>
  )
  ...
  return (
    <>
      <Head>
        <title>Abiti Modesti all'Ingrosso | Maxi Abiti Turchi | Hijab Fashion Mall</title>
        <meta name="description" content={`Scopri ${totalProducts}+ abiti modesti all'ingrosso. Maxi abiti turchi, abiti lunghi eleganti, tuniche. Tessuti: crêpe, jersey, seta Medina. Taglie S-4XL.`} />
        <meta name="keywords" content="abiti modesti all'ingrosso, maxi abiti turchi, abiti lunghi eleganti, tunica lunga donna, abito lungo turco, vestito modesto, abbigliamento modesto all'ingrosso, abito lungo cerimonia, abito lungo lavoro, vestito turco donna" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://hijabfashionmall.com/it/category/modest-dresses" />
        ...
        <link rel="alternate" href="https://hijabfashionmall.com/it/category/modest-dresses" hrefLang="it" />
        
        <meta property="og:title" content="Abiti Modesti all'Ingrosso - Maxi Abiti Turchi" />
        <meta property="og:description" content={`${totalProducts}+ modelli di abiti modesti. Tessuti: crêpe, jersey, seta Medina.`} />
        <meta property="og:url" content="https://hijabfashionmall.com/it/category/modest-dresses" />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://hijabfashionmall.com/images/og-modest-dresses-it.jpg" />
      ...
      <section style={{ background: 'linear-gradient(135deg, #fdf8f2 0%, #ffffff 100%)', padding: '60px 0 40px', textAlign: 'center', borderBottom: '1px solid #f0e6dc', position: 'relative', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', fontSize: '180px', fontWeight: 800, color: 'rgba(255,90,0,0.03)', whiteSpace: 'nowrap', zIndex: 0, pointerEvents: 'none', fontFamily: 'Playfair Display, serif' }}>DRESSES</div>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px', position: 'relative', zIndex: 1 }}>
          <div style={{ fontSize: '14px', color: '#7a6a5a', marginBottom: '20px' }}>
            ...
            <span style={{ color: '#7a6a5a', margin: '0 8px' }}>/</span>
            <span style={{ color: '#7a6a5a' }}>Abiti Modesti</span>
          </div>
          <h1 style={{ fontSize: '48px', color: '#2c2418', marginBottom: '15px', fontWeight: 800, lineHeight: '1.2', fontFamily: 'Playfair Display, serif' }}>
            Abiti Modesti <span style={{ color: '#ff5a00' }}>all'Ingrosso</span>
          </h1>
          <p style={{ fontSize: '18px', color: '#5a4a3a', maxWidth: '800px', margin: '0 auto', lineHeight: '1.6' }}>
            Scopri la nostra collezione di abiti modesti turchi all'ingrosso. Maxi abiti lunghi, tuniche eleganti, 
            vestiti in crêpe e jersey per ogni occasione.
          </p>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '40px', marginTop: '40px', flexWrap: 'wrap' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>Maxi Abiti Lunghi</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>Taglie S-4XL</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>Seta Medina</span>
            </div>
          </div>
        </div>
      </section>
          ...
          <main>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '30px', flexWrap: 'wrap', gap: '15px', background: 'white', padding: '15px 25px', borderRadius: '20px', boxShadow: '0 5px 15px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
              <div style={{ color: '#5a4a3a', fontSize: '15px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                ...
                <span><span style={{ fontWeight: 600, color: '#ff5a00' }}>{totalProducts}</span> abiti modesti</span>
            ...
            {products.length === 0 ? (
              <div style={{ textAlign: 'center', padding: '80px 20px', background: 'white', borderRadius: '20px', boxShadow: '0 10px 30px rgba(0,0,0,0.05)', border: '1px solid #f0e6dc' }}>
                ...
                <h3 style={{ fontSize: '24px', color: '#2c2418', marginBottom: '10px', fontWeight: 600 }}>Nessun abito trovato</h3>
                      ...
                      return (
                        <Link href={getProductUrl(p)} key={p._id} style={{ background: 'white', borderRadius: '16px', overflow: 'hidden', boxShadow: '0 5px 20px rgba(0,0,0,0.05)', transition: 'all 0.3s', textDecoration: 'none', color: 'inherit', border: '1px solid #f0e6dc', display: 'block' }} onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-8px)'; e.currentTarget.style.boxShadow = '0 15px 30px rgba(255,90,0,0.12)'; e.currentTarget.style.borderColor = '#ff5a00'; }} onMouseLeave={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 5px 20px rgba(0,0,0,0.05)'; e.currentTarget.style.borderColor = '#f0e6dc'; }}>
                          <div style={{ position: 'relative', height: '280px', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, #fef9f2 0%, #faf5ed 100%)' }}>
                            <img src={p.imageUrl || '/images/default.webp'} alt={p.name_it || p.name_en || p.name_ar || 'Abito modesto turco'} style={{ maxWidth: '90%', maxHeight: '90%', objectFit: 'contain', transition: 'transform 0.5s' }} loading="lazy" onError={(e) => { (e.target as HTMLImageElement).src = '/images/default.webp' }} />
                          ...
                          <div style={{ padding: '20px', textAlign: 'center' }}>
                            <div style={{ fontSize: '11px', color: '#ff5a00', marginBottom: '8px', fontWeight: 500, textTransform: 'uppercase', letterSpacing: '1px' }}>Abito Modesto</div>
      ...
      <section style={{ background: '#fef9f2', padding: '60px 0', borderTop: '1px solid #f0e6dc', marginTop: '40px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
          <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            <h2 style={{ fontSize: '32px', color: '#2c2418', marginBottom: '20px', fontWeight: 700, textAlign: 'center', fontFamily: 'Playfair Display, serif' }}>Abiti Modesti Turchi all'Ingrosso</h2>
            <p style={{ fontSize: '16px', color: '#5a4a3a', lineHeight: '1.8', marginBottom: '25px', textAlign: 'justify' }}>
              Hijab Fashion Mall offre una selezione di <strong>abiti modesti all'ingrosso</strong> con oltre <strong>{totalProducts} modelli</strong> disponibili. 
              Tessuti selezionati come crêpe, jersey, seta Medina e georgette. Taglie dalla S alla 4XL.
            </p>
            
            <h3 style={{ fontSize: '24px', color: '#2c2418', margin: '35px 0 20px', fontWeight: 600 }}>Tipologie di Abiti Disponibili</h3>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '15px', marginBottom: '35px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                ...
                <span style={{ color: '#4a3a2a' }}><strong>Maxi Abito Lungo</strong> – Lunghezza caviglia</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/></svg>
                <span style={{ color: '#4a3a2a' }}><strong>Abito in Crêpe</strong> – Tessuto resistente, anti-piega</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/></svg>
                <span style={{ color: '#4a3a2a' }}><strong>Abito in Jersey</strong> – Morbido, elasticizzato</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/></svg>
                <span style={{ color: '#4a3a2a' }}><strong>Abito in Georgette</strong> – Leggero, traspirante</span>
              </div>
            </div>

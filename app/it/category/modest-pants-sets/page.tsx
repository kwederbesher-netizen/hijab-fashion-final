// app/it/category/modest-pants-sets/page.tsx
'use client'
...
export default function ModestPantsSetsCategoryPageIt() {
    ...
    return (
      <div style={{
        ...
        <h4 style={{
          ...
          Guida Taglie - Completi Pantalone Turchi
        </h4>
        <table style={{
          width: '100%',
          ...
          <thead>
            <tr style={{ background: '#fef9f2', borderBottom: '2px solid #f0e6dc' }}>
              ...
              <th style={{ padding: '12px', textAlign: 'center', color: '#ff5a00', fontWeight: 700 }}>Lunghezza pantalone (cm)</th>
              <th style={{ padding: '12px', textAlign: 'center', color: '#ff5a00', fontWeight: 700 }}>Lunghezza top (cm)</th>
            </tr>
          </thead>
          <tbody>
            {[
              { taglia: 'S', vita: '66-70', fianchi: '92-96', pantalone: '98-102', top: '62-65' },
              { taglia: 'M', vita: '70-74', fianchi: '96-100', pantalone: '99-103', top: '63-66' },
              { taglia: 'L', vita: '74-78', fianchi: '100-104', pantalone: '100-104', top: '64-67' },
              { taglia: 'XL', vita: '78-82', fianchi: '104-108', pantalone: '101-105', top: '65-68' },
              { taglia: '2XL', vita: '82-86', fianchi: '108-112', pantalone: '102-106', top: '66-69' },
              { taglia: '3XL', vita: '86-90', fianchi: '112-116', pantalone: '103-107', top: '67-70' },
              { taglia: '4XL', vita: '90-94', fianchi: '116-120', pantalone: '104-108', top: '68-71' },
            ].map((size, idx) => (
              <tr key={idx} style={{ borderBottom: '1px solid #f0e6dc' }}>
                ...
                <td style={{ padding: '10px', textAlign: 'center', color: '#5a4a3a' }}>{size.pantalone}</td>
                <td style={{ padding: '10px', textAlign: 'center', color: '#5a4a3a' }}>{size.top}</td>
              </tr>
            ))}
          </tbody>
        </table>
        <p style={{
          ...
          ⚠️ I pantaloni hanno vestibilità regolare. Per modelli elasticizzati, considerare la vestibilità confortevole.
        </p>
      </div>
    )
  }
  ...
  if (loading && products.length === 0) return (
    <div style={{ padding: '100px 20px', textAlign: 'center', minHeight: '60vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <p style={{ marginTop: '20px', color: '#555', fontSize: '16px' }}>Caricamento completi pantalone...</p>
    </div>
  )
  ...
  return (
    <>
      <Head>
        <title>Completi Pantalone Modesti all'Ingrosso | Tuta Turca Pantalone Lungo | Hijab Fashion Mall</title>
        <meta name="description" content={`Scopri ${totalProducts}+ completi pantalone modesti all'ingrosso. Sets coordinati con pantalone lungo e top. Tessuti: crêpe, jersey, viscosa. Taglie S-4XL.`} />
        <meta name="keywords" content="completi pantalone modesti all'ingrosso, tuta pantalone turca, completo pantalone e top, pantalone lungo donna, completo coordinato pantalone, abbigliamento modesto pantalone, set turco pantalone, pantalone elegante lungo, completo lavoro donna, tuta turca donna, pantalone largo donna" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://hijabfashionmall.com/it/category/modest-pants-sets" />
        ...
        <link rel="alternate" href="https://hijabfashionmall.com/it/category/modest-pants-sets" hrefLang="it" />
        
        <meta property="og:title" content="Completi Pantalone Modesti all'Ingrosso - Tuta Turca" />
        <meta property="og:description" content={`${totalProducts}+ modelli di completi pantalone. Tessuti di qualità.`} />
        <meta property="og:url" content="https://hijabfashionmall.com/it/category/modest-pants-sets" />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://hijabfashionmall.com/images/og-pants-sets-it.jpg" />
      ...
      <section style={{ background: 'linear-gradient(135deg, #fdf8f2 0%, #ffffff 100%)', padding: '60px 0 40px', textAlign: 'center', borderBottom: '1px solid #f0e6dc', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px', position: 'relative', zIndex: 1 }}>
          <div style={{ fontSize: '14px', color: '#7a6a5a', marginBottom: '20px' }}>
            ...
            <span style={{ color: '#7a6a5a', margin: '0 8px' }}>/</span>
            <span style={{ color: '#7a6a5a' }}>Completi Pantalone</span>
          </div>
          <h1 style={{ fontSize: '48px', color: '#2c2418', marginBottom: '15px', fontWeight: 800, lineHeight: '1.2', fontFamily: 'Playfair Display, serif' }}>
            Completi Pantalone <span style={{ color: '#ff5a00' }}>all'Ingrosso</span>
          </h1>
          <p style={{ fontSize: '18px', color: '#5a4a3a', maxWidth: '800px', margin: '0 auto', lineHeight: '1.6' }}>
            Scopri i nostri completi pantalone modesti all'ingrosso. Sets coordinati con pantalone lungo e top abbinato.
          </p>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '40px', marginTop: '40px', flexWrap: 'wrap' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>Pantalone + Top</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>Pantaloni Largo</span>
            </div>
          </div>
        </div>
      </section>
          ...
          <main>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '30px', flexWrap: 'wrap', gap: '15px', background: 'white', padding: '15px 25px', borderRadius: '20px', boxShadow: '0 5px 15px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
              <div style={{ color: '#5a4a3a', fontSize: '15px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                ...
                <span><span style={{ fontWeight: 600, color: '#ff5a00' }}>{totalProducts}</span> completi pantalone</span>
            ...
            {products.length === 0 ? (
              <div style={{ textAlign: 'center', padding: '80px 20px', background: 'white', borderRadius: '20px', boxShadow: '0 10px 30px rgba(0,0,0,0.05)', border: '1px solid #f0e6dc' }}>
                ...
                <h3 style={{ fontSize: '24px', color: '#2c2418', marginBottom: '10px', fontWeight: 600 }}>Nessun completo trovato</h3>
                ...
                {loading && products.length > 0 ? <LoadingSkeleton /> : (
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '25px', marginBottom: '50px' }}>
                    {products.map((p: any) => {
                      ...
                      if (fabric.includes('crepe')) fabricBadge = <span style={{ background: '#d48c54', color: 'white', padding: '4px 12px', borderRadius: '20px', fontSize: '11px', fontWeight: 600 }}>CRÊPE</span>
                      ...
                      else if (fabric.includes('viscose')) fabricBadge = <span style={{ background: '#c98a60', color: 'white', padding: '4px 12px', borderRadius: '20px', fontSize: '11px', fontWeight: 600 }}>VISCOSA</span>
                      ...
                      return (
                        <Link href={getProductUrl(p)} key={p._id} style={{ background: 'white', borderRadius: '16px', overflow: 'hidden', boxShadow: '0 5px 20px rgba(0,0,0,0.05)', transition: 'all 0.3s', textDecoration: 'none', color: 'inherit', border: '1px solid #f0e6dc', display: 'block' }} onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-8px)'; e.currentTarget.style.boxShadow = '0 15px 30px rgba(255,90,0,0.12)'; e.currentTarget.style.borderColor = '#ff5a00'; }} onMouseLeave={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 5px 20px rgba(0,0,0,0.05)'; e.currentTarget.style.borderColor = '#f0e6dc'; }}>
                          <div style={{ position: 'relative', height: '280px', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, #fef9f2 0%, #faf5ed 100%)' }}>
                            <img src={p.imageUrl || '/images/default.webp'} alt={p.name_it || p.name_en || p.name_ar || 'Completo pantalone turco'} style={{ maxWidth: '90%', maxHeight: '90%', objectFit: 'contain', transition: 'transform 0.5s' }} loading="lazy" onError={(e) => { (e.target as HTMLImageElement).src = '/images/default.webp' }} />
                          ...
                          <div style={{ padding: '20px', textAlign: 'center' }}>
                            <div style={{ fontSize: '11px', color: '#ff5a00', marginBottom: '8px', fontWeight: 500, textTransform: 'uppercase', letterSpacing: '1px' }}>Set Pantalone + Top</div>
      ...
      <section style={{ background: '#fef9f2', padding: '60px 0', borderTop: '1px solid #f0e6dc', marginTop: '40px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
          <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            <h2 style={{ fontSize: '32px', color: '#2c2418', marginBottom: '20px', fontWeight: 700, textAlign: 'center', fontFamily: 'Playfair Display, serif' }}>Completi Pantalone Turchi all'Ingrosso</h2>
            <p style={{ fontSize: '16px', color: '#5a4a3a', lineHeight: '1.8', marginBottom: '25px', textAlign: 'justify' }}>
              Hijab Fashion Mall offre una selezione di <strong>completi pantalone all'ingrosso</strong> con oltre <strong>{totalProducts} modelli</strong> disponibili. 
              Sets coordinati con pantalone lungo e top abbinato in tessuti crêpe, jersey e viscosa.
            </p>
            
            <h3 style={{ fontSize: '24px', color: '#2c2418', margin: '35px 0 20px', fontWeight: 600 }}>Tipologie di Completi Disponibili</h3>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '15px', marginBottom: '35px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                ...
                <span style={{ color: '#4a3a2a' }}><strong>Set Pantalone + Top</strong> – Completo coordinato</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/></svg>
                <span style={{ color: '#4a3a2a' }}><strong>Set Pantalone Largo</strong> – Pantaloni a zampa o palazzo</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/></svg>
                <span style={{ color: '#4a3a2a' }}><strong>Set in Crêpe</strong> – Tessuto elegante</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/></svg>
                <span style={{ color: '#4a3a2a' }}><strong>Set in Jersey</strong> – Morbido e confortevole</span>
              </div>
            </div>

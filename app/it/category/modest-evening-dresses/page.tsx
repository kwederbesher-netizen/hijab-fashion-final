// app/it/category/modest-evening-dresses/page.tsx
'use client'
...
export default function ModestEveningDressesCategoryPageIt() {
  ...
  const getColorCode = useCallback((color: string) => {
    const colors: any = {
      ...
      'Rose': '#e88c9a', 'Camel': '#c19a6b', 'Emerald': '#50c878', 'Ruby': '#9b111e'
    }
    ...
    return (
      <div style={{
        ...
        <h4 style={{
          ...
          Guida Taglie - Abiti da Sera Turchi
        </h4>
        <table style={{
          width: '100%',
          ...
          <thead>
            <tr style={{ background: '#fef9f2', borderBottom: '2px solid #f0e6dc' }}>
              <th style={{ padding: '12px', textAlign: 'center', color: '#ff5a00', fontWeight: 700 }}>Taglia IT</th>
              <th style={{ padding: '12px', textAlign: 'center', color: '#ff5a00', fontWeight: 700 }}>Taglia TR</th>
          ...
          <tbody>
            {[
              { it: 'XS', tr: '34', busto: '80-84', vita: '62-66', fianchi: '88-92', lunghezza: '145-150' },
              { it: 'S', tr: '36', busto: '84-88', vita: '66-70', fianchi: '92-96', lunghezza: '147-152' },
              { it: 'M', tr: '38', busto: '88-92', vita: '70-74', fianchi: '96-100', lunghezza: '149-154' },
              { it: 'L', tr: '40', busto: '92-96', vita: '74-78', fianchi: '100-104', lunghezza: '151-156' },
              { it: 'XL', tr: '42', busto: '96-100', vita: '78-82', fianchi: '104-108', lunghezza: '153-158' },
              { it: '2XL', tr: '44', busto: '100-104', vita: '82-86', fianchi: '108-112', lunghezza: '155-160' },
              { it: '3XL', tr: '46', busto: '104-108', vita: '86-90', fianchi: '112-116', lunghezza: '157-162' },
            ].map((size, idx) => (
              <tr key={idx} style={{ borderBottom: '1px solid #f0e6dc' }}>
                <td style={{ padding: '10px', textAlign: 'center', fontWeight: 600, color: '#2c2418' }}>{size.it}</td>
                <td style={{ padding: '10px', textAlign: 'center', color: '#5a4a3a' }}>{size.tr}</td>
        ...
        <p style={{
          ...
          ⚠️ Le misure sono indicative. Per tessuti elasticizzati, la vestibilità può variare.
        </p>
      </div>
    )
  }
  ...
  if (loading && products.length === 0) return (
    <div style={{ padding: '100px 20px', textAlign: 'center', minHeight: '60vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <p style={{ marginTop: '20px', color: '#555', fontSize: '16px' }}>Caricamento abiti da sera...</p>
    </div>
  )
  ...
  return (
    <>
      <Head>
        <title>Abiti da Sera Modesti all'Ingrosso | Abiti Lunghi Eleganti Turchi | Hijab Fashion Mall</title>
        <meta name="description" content={`Scopri ${totalProducts}+ abiti da sera modesti all'ingrosso. Abiti lunghi eleganti per cerimonie, matrimoni. Tessuti: seta Medina, crêpe georgette, pizzo. Taglie S-3XL.`} />
        <meta name="keywords" content="abiti da sera modesti all'ingrosso, abito lungo elegante, abito cerimonia turco, abito lungo matrimonio, abito da sera turco, vestito lungo cerimonia, abito lungo pizzo, abito lungo seta, abito lungo crêpe, abito da sera con maniche lunghe, abito lungo formale, wholesale evening dresses" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://hijabfashionmall.com/it/category/modest-evening-dresses" />
        ...
        <link rel="alternate" href="https://hijabfashionmall.com/it/category/modest-evening-dresses" hrefLang="it" />
        
        <meta property="og:title" content="Abiti da Sera Modesti all'Ingrosso - Abiti Lunghi Eleganti Turchi" />
        <meta property="og:description" content={`${totalProducts}+ modelli di abiti da sera. Tessuti pregiati: seta Medina, crêpe, pizzo.`} />
        <meta property="og:url" content="https://hijabfashionmall.com/it/category/modest-evening-dresses" />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://hijabfashionmall.com/images/og-evening-dresses-it.jpg" />
      ...
      <section style={{ background: 'linear-gradient(135deg, #fdf8f2 0%, #ffffff 100%)', padding: '60px 0 40px', textAlign: 'center', borderBottom: '1px solid #f0e6dc', position: 'relative', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', fontSize: '150px', fontWeight: 800, color: 'rgba(255,90,0,0.03)', whiteSpace: 'nowrap', zIndex: 0, pointerEvents: 'none', fontFamily: 'Playfair Display, serif' }}>EVENING</div>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px', position: 'relative', zIndex: 1 }}>
          <div style={{ fontSize: '14px', color: '#7a6a5a', marginBottom: '20px' }}>
            ...
            <span style={{ color: '#7a6a5a', margin: '0 8px' }}>/</span>
            <span style={{ color: '#7a6a5a' }}>Abiti da Sera</span>
          </div>
          <h1 style={{ fontSize: '48px', color: '#2c2418', marginBottom: '15px', fontWeight: 800, lineHeight: '1.2', fontFamily: 'Playfair Display, serif' }}>
            Abiti da Sera <span style={{ color: '#ff5a00' }}>all'Ingrosso</span>
          </h1>
          <p style={{ fontSize: '18px', color: '#5a4a3a', maxWidth: '800px', margin: '0 auto', lineHeight: '1.6' }}>
            Scopri la nostra collezione di abiti da sera modesti all'ingrosso. Abiti lunghi eleganti in seta Medina, 
            crêpe georgette e pizzo, perfetti per cerimonie e occasioni speciali.
          </p>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '40px', marginTop: '40px', flexWrap: 'wrap' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>Abiti da Cerimonia</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>Seta Medina & Crêpe</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>Pizzo e Dettagli</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', background: 'rgba(255,90,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <span style={{ color: '#4a3a2a', fontSize: '15px' }}>Maniche Lunghe</span>
            </div>
          </div>
        </div>
      </section>
          ...
          <main>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '30px', flexWrap: 'wrap', gap: '15px', background: 'white', padding: '15px 25px', borderRadius: '20px', boxShadow: '0 5px 15px rgba(0,0,0,0.03)', border: '1px solid #f0e6dc' }}>
              <div style={{ color: '#5a4a3a', fontSize: '15px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                ...
                <span><span style={{ fontWeight: 600, color: '#ff5a00' }}>{totalProducts}</span> abiti da sera</span>
            ...
            {products.length === 0 ? (
              <div style={{ textAlign: 'center', padding: '80px 20px', background: 'white', borderRadius: '20px', boxShadow: '0 10px 30px rgba(0,0,0,0.05)', border: '1px solid #f0e6dc' }}>
                ...
                <h3 style={{ fontSize: '24px', color: '#2c2418', marginBottom: '10px', fontWeight: 600 }}>Nessun abito da sera trovato</h3>
                ...
                {loading && products.length > 0 ? <LoadingSkeleton /> : (
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '25px', marginBottom: '50px' }}>
                    {products.map((p: any) => {
                      ...
                      if (fabric.includes('silk') || fabric.includes('medina')) fabricBadge = <span style={{ background: '#b87c4f', color: 'white', padding: '4px 12px', borderRadius: '20px', fontSize: '11px', fontWeight: 600 }}>SETA MEDINA</span>
                      else if (fabric.includes('crepe')) fabricBadge = <span style={{ background: '#d48c54', color: 'white', padding: '4px 12px', borderRadius: '20px', fontSize: '11px', fontWeight: 600 }}>CRÊPE</span>
                      else if (fabric.includes('lace')) fabricBadge = <span style={{ background: '#c98a60', color: 'white', padding: '4px 12px', borderRadius: '20px', fontSize: '11px', fontWeight: 600 }}>PIZZO</span>
                      else if (fabric.includes('georgette')) fabricBadge = <span style={{ background: '#a06e42', color: 'white', padding: '4px 12px', borderRadius: '20px', fontSize: '11px', fontWeight: 600 }}>GEORGETTE</span>
                      ...
                      return (
                        <Link href={getProductUrl(p)} key={p._id} style={{ background: 'white', borderRadius: '16px', overflow: 'hidden', boxShadow: '0 5px 20px rgba(0,0,0,0.05)', transition: 'all 0.3s', textDecoration: 'none', color: 'inherit', border: '1px solid #f0e6dc', display: 'block' }} onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-8px)'; e.currentTarget.style.boxShadow = '0 15px 30px rgba(255,90,0,0.12)'; e.currentTarget.style.borderColor = '#ff5a00'; }} onMouseLeave={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 5px 20px rgba(0,0,0,0.05)'; e.currentTarget.style.borderColor = '#f0e6dc'; }}>
                          <div style={{ position: 'relative', height: '280px', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, #fef9f2 0%, #faf5ed 100%)' }}>
                            <img src={p.imageUrl || '/images/default.webp'} alt={p.name_it || p.name_en || p.name_ar || 'Abito da sera turco'} style={{ maxWidth: '90%', maxHeight: '90%', objectFit: 'contain', transition: 'transform 0.5s' }} loading="lazy" onError={(e) => { (e.target as HTMLImageElement).src = '/images/default.webp' }} />
                          ...
                          <div style={{ padding: '20px', textAlign: 'center' }}>
                            <div style={{ fontSize: '11px', color: '#ff5a00', marginBottom: '8px', fontWeight: 500, textTransform: 'uppercase', letterSpacing: '1px' }}>Abito da Sera</div>
      ...
      <section style={{ background: '#fef9f2', padding: '60px 0', borderTop: '1px solid #f0e6dc', marginTop: '40px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
          <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            <h2 style={{ fontSize: '32px', color: '#2c2418', marginBottom: '20px', fontWeight: 700, textAlign: 'center', fontFamily: 'Playfair Display, serif' }}>Abiti da Sera Turchi all'Ingrosso</h2>
            <p style={{ fontSize: '16px', color: '#5a4a3a', lineHeight: '1.8', marginBottom: '25px', textAlign: 'justify' }}>
              Hijab Fashion Mall offre una selezione di <strong>abiti da sera modesti all'ingrosso</strong> con oltre <strong>{totalProducts} modelli</strong> disponibili. 
              Abiti lunghi eleganti in seta Medina, crêpe georgette e pizzo per cerimonie e occasioni speciali.
            </p>
            
            <h3 style={{ fontSize: '24px', color: '#2c2418', margin: '35px 0 20px', fontWeight: 600 }}>Tipologie di Abiti da Sera Disponibili</h3>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '15px', marginBottom: '35px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                ...
                <span style={{ color: '#4a3a2a' }}><strong>Abito da Cerimonia</strong> – Per matrimoni e ricevimenti</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/></svg>
                <span style={{ color: '#4a3a2a' }}><strong>Abito in Seta Medina</strong> – Lusso e raffinatezza</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/></svg>
                <span style={{ color: '#4a3a2a' }}><strong>Abito in Crêpe</strong> – Elegante e confortevole</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', background: 'white', borderRadius: '12px', border: '1px solid #f0e6dc' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff5a00" strokeWidth="2"><path d="M20 6L9 17l-5-5" stroke="currentColor" fill="none"/></svg>
                <span style={{ color: '#4a3a2a' }}><strong>Abito in Pizzo</strong> – Dettagli raffinati</span>
              </div>
            </div>
      ...
      <style>{`
        ...
        @media (max-width: 768px) { div[style*="grid-template-columns: repeat(4, 1fr)"] { grid-template-columns: repeat(2, 1fr) !important; } .toolbar { flex-direction: column; align-items: stretch !important; } input[type="text"][placeholder*="Cerca"] { width: 100% !important; } select { width: 100% !important; } }

...
export default function ClientLayout({ children }: { children: React.ReactNode }) {
  ...
  const handleSearch = (e: React.FormEvent) => {
    e.preventDefault()
    if (searchQuery.trim()) {
      window.location.href = `/en/catalog?search=${encodeURIComponent(searchQuery.trim())}`
    }
  }
  ...
  const sendToWhatsApp = () => {
    ...
    let message = "*Hijab Fashion Mall - Order Inquiry*\n\n"
    ...
    <>
      ...
      >
        ...
        <div className="mobile-nav-links" style={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
          ...
          <Link href="/en/catalog" style={{ color: '#000', textDecoration: 'none', fontSize: '16px', fontWeight: 500, padding: '12px 0', borderBottom: '1px solid #eee' }}>
            Catalog
          </Link>
          ...
          <Link href="/en/contact" style={{ color: '#000', textDecoration: 'none', fontSize: '16px', fontWeight: 500, padding: '12px 0', borderBottom: '1px solid #eee' }}>
            Contact
          </Link>
        </div>
      </div>
      ...
      <div className="top-header" style={{
        ...
        <div className="container" style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
          <p><span style={{ color: '#ff5a00', fontWeight: 600 }}>Wholesale Premium Turkish Hijab Wear</span> & Worldwide Shipping. Elegance Delivered to Your Door</p>
        </div>
      </div>
      ...
      <footer className="footer" style={{
        ...
        <div className="container" style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
          <div className="footer-top" style={{
            ...
            <div className="footer-logo">
              ...
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '14px', maxWidth: '300px' }}>
                Your Trusted Wholesale Source for Premium Turkish Hijab Wear
              </p>
            </div>
            <div className="footer-stats" style={{ display: 'flex', gap: '30px' }}>
              <div className="stat-item" style={{ textAlign: 'center' }}>
                ...
                <span className="stat-label" style={{ fontSize: '12px', color: 'rgba(255,255,255,0.6)' }}>Brands</span>
              </div>
              <div className="stat-item" style={{ textAlign: 'center' }}>
                <span className="stat-number" style={{ display: 'block', fontSize: '28px', fontWeight: 700, color: '#ff5a00' }}>50+</span>
                <span className="stat-label" style={{ fontSize: '12px', color: 'rgba(255,255,255,0.6)' }}>Countries</span>
              </div>
              <div className="stat-item" style={{ textAlign: 'center' }}>
                <span className="stat-number" style={{ display: 'block', fontSize: '28px', fontWeight: 700, color: '#ff5a00' }}>5000+</span>
                <span className="stat-label" style={{ fontSize: '12px', color: 'rgba(255,255,255,0.6)' }}>Products</span>
              </div>
            </div>
          </div>
          ...
          <div className="footer-policies" style={{
            ...
            <a href="/en/refund-policy" style={{ color: 'rgba(255,255,255,0.7)', textDecoration: 'none', margin: '0 5px' }}>Refund Policy</a>
            <span style={{ color: 'rgba(255,255,255,0.3)', margin: '0 2px' }}> | </span>
            <a href="/en/terms-conditions" style={{ color: 'rgba(255,255,255,0.7)', textDecoration: 'none', margin: '0 5px' }}>Terms & Conditions</a>
            <span style={{ color: 'rgba(255,255,255,0.3)', margin: '0 2px' }}> | </span>
            <a href="/en/privacy-policy" style={{ color: 'rgba(255,255,255,0.7)', textDecoration: 'none', margin: '0 5px' }}>Privacy Policy</a>
            <span style={{ color: 'rgba(255,255,255,0.3)', margin: '0 2px' }}> | </span>
            <a href="/en/shipping-policy" style={{ color: 'rgba(255,255,255,0.7)', textDecoration: 'none', margin: '0 5px' }}>Shipping Policy</a>
          </div>
